...
void compiler_dot_x64__Gen_generate_elf_footer(compiler_dot_x64__Gen *g) {
  ...
  ;
  chmod((char *)g->out_name.str, 0775);
...
Option_bool os__cp_r(string osource_path, string odest_path, bool overwrite) {
  ...
  for (int tmp10 = 0; tmp10 < tmp9.len; tmp10++) {
    ...
    Option_bool tmp12 = os__cp_r(sp, dp, overwrite);
    if (!tmp12.ok) {
...
Option_bool os__mv_by_cp(string source, string target) {
  Option_bool tmp14 = os__cp(source, target);
  if (!tmp14.ok) {
...
Option_array_string os__read_lines(string path) {
  ...
  while (fgets((char *)(byte *)buf + buf_index, buf_len - buf_index, fp) != 0) {
    ...
    _PUSH(&res, (/*typ = array_string   tmp_typ=string*/ tos_clone(buf)), tmp16,
          string);
    buf_index = 0;
  };
  fclose(fp);
  array_string tmp17 = OPTION_CAST(array_string)(res);
  return opt_ok(&tmp17, sizeof(array_string));
}
Option_array_ustring os__read_ulines(string path) {
  Option_array_string tmp18 = os__read_lines(path);
  array_string lines;
  if (!tmp18.ok) {
    string err = tmp18.error;
    int errcode = tmp18.ecode;
    string tmp19 = OPTION_CAST(string)(err);
    return opt_ok(&tmp19, sizeof(string));
  }
  lines = *(array_string *)tmp18.data;
  ;
  ...
  array_ustring tmp23 = OPTION_CAST(array_ustring)(ulines);
  return opt_ok(&tmp23, sizeof(array_ustring));
}
Option_os__File os__open(string path) {
...
string os__sigint_to_signal_name(int si) {
  ...
  if ((tmp28 == 30) || (tmp28 == 10) || (tmp28 == 16)) {
    return tos3("SIGUSR1");
  } else if ((tmp28 == 31) || (tmp28 == 12) || (tmp28 == 17)) {
    return tos3("SIGUSR2");
  } else if ((tmp28 == 20) || (tmp28 == 17) || (tmp28 == 18)) {
    return tos3("SIGCHLD");
  } else if ((tmp28 == 19) || (tmp28 == 18) || (tmp28 == 25)) {
    return tos3("SIGCONT");
  } else if ((tmp28 == 17) || (tmp28 == 19) || (tmp28 == 23)) {
    return tos3("SIGSTOP");
  } else if ((tmp28 == 18) || (tmp28 == 20) || (tmp28 == 24)) {
    return tos3("SIGTSTP");
  } else if ((tmp28 == 21) || (tmp28 == 21) || (tmp28 == 26)) {
    return tos3("SIGTTIN");
  } else if ((tmp28 == 22) || (tmp28 == 22) || (tmp28 == 27)) {
    return tos3("SIGTTOU");
  } else if (tmp28 == 5) {
    return tos3("SIGTRAP");
  } else if (tmp28 == 7) {
...
array_string os__get_lines() {
  ...
  while (1) {
    ...
    _PUSH(&inputstr, (/*typ = array_string   tmp_typ=string*/ line), tmp37,
          string);
  };
  return inputstr;
}
...
void os__write_file(string path, string text) {
  Option_os__File tmp38 = os__create(path);
  os__File f;
  if (!tmp38.ok) {
...
string compiler__Parser_name_expr(compiler__Parser *p) {
  ...
  if (p->tok == compiler__compiler__TokenKind_question) {
    ...
    compiler__Parser_genln(p, tos3(";"));
    compiler__Parser_genln(p, _STR("if (!%.*s.ok) v_panic(%.*s.error);",
...
void compiler__Parser_fn_decl(compiler__Parser *p) {
  ...
  array_compiler__Var tmp43 = f.args;
  for (int tmp44 = 0; tmp44 < tmp43.len; tmp44++) {
    compiler__Var arg = ((compiler__Var *)tmp43.data)[tmp44];
  ...
  if (p->is_vh || compiler__Parser_first_pass(&/* ? */ *p) || is_live ||
    ...
    if (is_live && compiler__Parser_first_pass(&/* ? */ *p) &&
      ...
      _PUSH(&p->cgen->so_fns,
            (/*typ = array_string   tmp_typ=string*/ fn_name_cgen), tmp46,
            string);
...
void compiler__Parser_check_unused_variables(compiler__Parser *p) {
  array_compiler__Var tmp50 = p->local_vars;
  for (int tmp51 = 0; tmp51 < tmp50.len; tmp51++) {
    compiler__Var var = ((compiler__Var *)tmp50.data)[tmp51];
...
void compiler__Parser_async_fn_call(compiler__Parser *p, compiler__Fn f,
  ...
  for (int i = 0; i < tmp52.len; i++) {
    compiler__Var arg = ((compiler__Var *)tmp52.data)[i];
...
void compiler__Parser_fn_call(compiler__Parser *p, compiler__Fn *f,
  ...
  if (f->is_method) {
    ...
    if (string_ends_with(receiver.typ, tos3("er"))) {
      ...
      if (t.cat == compiler__compiler__TypeCategory_interface_) {
        int idx = 0;
        array_compiler__Fn tmp57 = t.methods;
        for (int i = 0; i < tmp57.len; i++) {
          compiler__Fn method = ((compiler__Fn *)tmp57.data)[i];
...
void compiler__Parser_fn_args(compiler__Parser *p, compiler__Fn *f) {
  ...
  while (p->tok != compiler__compiler__TokenKind_rpar) {
    ...
    array_string tmp63 = names;
    for (int tmp64 = 0; tmp64 < tmp63.len; tmp64++) {
      string name = ((string *)tmp63.data)[tmp64];
...
void compiler__Parser_fn_call_args(compiler__Parser *p, compiler__Fn *f) {
  ...
  array_string saved_args = new_array_from_c_array(
      0, 0, sizeof(string), EMPTY_ARRAY_OF_ELEMS(string, 0){TCCSKIP(0)});
  array_compiler__Var tmp67 = f->args;
  for (int i = 0; i < tmp67.len; i++) {
    compiler__Var arg = ((compiler__Var *)tmp67.data)[i];
    ...
    if (type_mismatch && f->is_generic) {
      _PUSH(&saved_args, (/*typ = array_string   tmp_typ=string*/ got), tmp69,
            string);
...
compiler__TypeInst compiler__Parser_extract_type_inst(compiler__Parser *p,
  ...
  if (string_ne(f->typ, tos3("void"))) {
    _PUSH(&args, (/*typ = array_string   tmp_typ=string*/ f->typ), tmp74,
          string);
  };
  array_string tmp75 = args;
  for (int tmp76 = 0; tmp76 < tmp75.len; tmp76++) {
    string e = ((string *)tmp75.data)[tmp76];
    ...
    if (string_starts_with(ti, tos3("fn ("))) {
      array_string fn_args = string_split(
          ...
          tos3(","));
      bool found = 0;
      array_string tmp81 = fn_args;
      for (int tmp82 = 0; tmp82 < tmp81.len; tmp82++) {
        string fa_ = ((string *)tmp81.data)[tmp82];
      ...
      if (string_ne(tmp89, ti)) {
        ...
        compiler__Parser_error(
            p, _STR("type parameter `%.*s` has type %.*s, not `%.*s`", tp.len,
                    tp.str, tmp91.len, tmp91.str, ti.len, ti.str));
      };
      continue;
    };
  ...
  if (string_eq(tmp93, tos3("")) && (_IN(string, (f->typ), f->type_pars))) {
    map_set(&r.inst, f->typ, &(string[]){tos3("_ANYTYPE_")});
  };
  array_string tmp95 = f->type_pars;
...
string compiler__replace_generic_type(string gen_type, compiler__TypeInst *ti) {
  ...
  if ((_IN_MAP((typ), ti->inst))) {
    ...
    typ = string_replace(gen_type, typ, tmp101);
    return typ;
  };
  typ = gen_type;
  if (string_starts_with(typ, tos3("fn ("))) {
    ...
    array_string args_r = new_array_from_c_array(
        0, 0, sizeof(string), EMPTY_ARRAY_OF_ELEMS(string, 0){TCCSKIP(0)});
    array_string tmp105 = args;
    for (int tmp106 = 0; tmp106 < tmp105.len; tmp106++) {
      string arg = ((string *)tmp105.data)[tmp106];
...
void compiler__replace_generic_type_params(compiler__Fn *f,
  ...
  array_compiler__Var args = new_array_from_c_array(
      0, 0, sizeof(compiler__Var),
      EMPTY_ARRAY_OF_ELEMS(compiler__Var, 0){TCCSKIP(0)});
  array_compiler__Var tmp108 = f->args;
...
compiler__Parser_fn_call_vargs(compiler__Parser *p, compiler__Fn f) {
  ...
  while (p->tok != compiler__compiler__TokenKind_rpar) {
    ...
    _V_MulRet_string_V_string _V_mret_varg_type_varg_value =
        compiler__Parser_tmp_expr(p);
    string varg_type = _V_mret_varg_type_varg_value.var_0;
    string varg_value = _V_mret_varg_type_varg_value.var_1;
    ...
    if (!f.is_generic) {
      ...
      if (types.len > 0) {
        array_string tmp121 = types;
        for (int tmp122 = 0; tmp122 < tmp121.len; tmp122++) {
          string t = ((string *)tmp121.data)[tmp122];
                         ...
                         !string_ends_with(varg_type, tos3("*")))
                            ...
                            : (((!string_ends_with(last_arg.typ, tos3("*")) &&
                                 string_ends_with(varg_type, tos3("*")))
                                    ? (tos3("*"))
                                    : (tos3("")))));
    _PUSH(&types, (/*typ = array_string   tmp_typ=string*/ varg_type), tmp123,
          string);
    _PUSH(&values,
          (/*typ = array_string   tmp_typ=string*/ _STR(
  ...
  array_compiler__VargAccess tmp125 = p->table->varg_access;
  for (int tmp126 = 0; tmp126 < tmp125.len; tmp126++) {
    compiler__VargAccess va = ((compiler__VargAccess *)tmp125.data)[tmp126];
...
void compiler__Parser_save_generic_tmpl(compiler__Parser *p, compiler__Fn *f,
  ...
  int tmp133 = pos;
  ;
  for (int tmp134 = tmp133; tmp134 < p->tokens.len - 1; tmp134++) {
    int i = tmp134;
...
string compiler__Fn_generic_tmpl_to_inst(compiler__Fn *f,
                                         compiler__TypeInst *ti) {
  string fn_body = tos3("");
  array_compiler__Token tmp138 = f->generic_tmpl;
  for (int tmp139 = 0; tmp139 < tmp138.len; tmp139++) {
    compiler__Token tok = ((compiler__Token *)tmp138.data)[tmp139];
...
void compiler__Parser_var_decl(compiler__Parser *p) {
  ...
  while (p->tok == compiler__compiler__TokenKind_comma) {
    ...
    if (p->tok == compiler__compiler__TokenKind_key_mut) {
      compiler__Parser_check(p, compiler__compiler__TokenKind_key_mut);
      _PUSH(&var_mut, (/*typ = array_bool   tmp_typ=bool*/ 1), tmp67, bool);
    } else {
      _PUSH(&var_mut, (/*typ = array_bool   tmp_typ=bool*/ 0), tmp68, bool);
    };
    ...
    _PUSH(&var_names, (/*typ = array_string   tmp_typ=string*/ var_name), tmp70,
          string);
  };
  ...
  array_string tmp75 = var_names;
  for (int i = 0; i < tmp75.len; i++) {
    string var_name = ((string *)tmp75.data)[i];
...
string compiler__Parser_get_var_type(compiler__Parser *p, string name,
  ...
  if (is_ptr) {
    ...
    int tmp86 = 0;
    ;
    for (int tmp87 = tmp86; tmp87 < deref_nr; tmp87++) {
  ...
  if (deref_nr > 0) {
    ...
    int tmp88 = 0;
    ;
    for (int tmp89 = tmp88; tmp89 < deref_nr; tmp89++) {
...
string compiler__Parser_get_c_func_type(compiler__Parser *p, string name) {
  ...
  p->is_c_fn_call = 0;
  Option_compiler__Fn tmp91 = compiler__Table_find_fn(&/* ? */ *p->table, name);
  compiler__Fn cfn;
  if (!tmp91.ok) {
    string err = tmp91.error;
    int errcode = tmp91.ecode;
...
string compiler__Parser_dot(compiler__Parser *p, string str_typ_,
  ...
  if (has_field) {
    string struct_field =
        ((string_ne(typ.name, tos3("Option")))
             ? (compiler__Table_var_cgen_name(&/* ? */ *p->table, field_name))
             : (field_name));
    Option_compiler__Var tmp96 = compiler__Table_find_field(
    ...
    field = *(compiler__Var *)tmp96.data;
    ;
  ...
  method = *(compiler__Fn *)tmp97.data;
  ;
...
string compiler__Parser_assoc(compiler__Parser *p) {
  compiler__Parser_next(p);
  string name = compiler__Parser_check_name(p);
  Option_compiler__Var tmp117 = compiler__Parser_find_var(&/* ? */ *p, name);
  compiler__Var var;
  if (!tmp117.ok) {
    string err = tmp117.error;
    int errcode = tmp117.ecode;
    compiler__Parser_error(p,
                           _STR("unknown variable `%.*s`", name.len, name.str));
    v_exit(1);
  }
  var = *(compiler__Var *)tmp117.data;
  ;
  ...
  while (p->tok != compiler__compiler__TokenKind_rcbr) {
    ...
    string field = compiler__Parser_check_name(p);
    _PUSH(&fields, (/*typ = array_string   tmp_typ=string*/ field), tmp118,
          string);
    compiler__Parser_gen(p, _STR(".%.*s = ", field.len, field.str));
    compiler__Parser_check(p, compiler__compiler__TokenKind_colon);
    compiler__Parser_bool_expression(p);
  ...
  array_compiler__Var tmp119 = T.fields;
  for (int tmp120 = 0; tmp120 < tmp119.len; tmp120++) {
    compiler__Var ffield = ((compiler__Var *)tmp119.data)[tmp120];
...
void compiler__Parser_return_st(compiler__Parser *p) {
  ...
  if (fn_returns) {
    ...
    _PUSH(&types, (/*typ = array_string   tmp_typ=string*/ expr_type), tmp134,
          string);
    while (p->tok == compiler__compiler__TokenKind_comma) {
      ...
      string typ = _V_mret_typ_expr.var_0;
      string expr = _V_mret_typ_expr.var_1;
      _PUSH(&types, (/*typ = array_string   tmp_typ=string*/ typ), tmp135,
            string);
      _PUSH(&mr_values,
    ...
    if (types.len > 1) {
      ...
      array_string tmp137 = mr_values;
      for (int ret_val_idx = 0; ret_val_idx < tmp137.len; ret_val_idx++) {
        string ret_val = ((string *)tmp137.data)[ret_val_idx];
...
string compiler__Parser_get_deferred_text(compiler__Parser *p) {
  ...
  array_string tmp142 = p->cur_fn.defer_text;
  for (int tmp143 = 0; tmp143 < tmp142.len; tmp143++) {
    string text = ((string *)tmp142.data)[tmp143];
...
void compiler__Parser_go_statement(compiler__Parser *p) {
  ...
  if (compiler__Parser_peek(&/* ? */ *p) == compiler__compiler__TokenKind_dot) {
    string var_name = p->lit;
    Option_compiler__Var tmp144 =
        compiler__Parser_find_var(&/* ? */ *p, var_name);
    compiler__Var v;
    if (!tmp144.ok) {
      string err = tmp144.error;
      int errcode = tmp144.ecode;

      return;
    }
    v = *(compiler__Var *)tmp144.data;
    ;
    compiler__Parser_mark_var_used(p, v);
...
string compiler__Parser_js_decode(compiler__Parser *p) {
  ...
  if (string_eq(op, tos3("decode"))) {
    ...
    string typ = compiler__Parser_get_type(p);
    compiler__Parser_check(p, compiler__compiler__TokenKind_comma);
    _V_MulRet_string_V_string _V_mret_styp_expr = compiler__Parser_tmp_expr(p);
    string styp = _V_mret_styp_expr.var_0;
    string expr = _V_mret_styp_expr.var_1;
    ...
    compiler__Type T = compiler__Table_find_type(&/* ? */ *p->table, typ);
    array_compiler__Var tmp147 = T.fields;
    for (int tmp148 = 0; tmp148 < tmp147.len; tmp148++) {
      compiler__Var field = ((compiler__Var *)tmp147.data)[tmp148];
...
void compiler__Parser_check_unused_imports(compiler__Parser *p) {
  ...
  string output = tos3("");
  map_string tmp156 = p->import_table.imports;
  array_string keys_tmp156 = map_keys(&tmp156);
  for (int l = 0; l < keys_tmp156.len; l++) {
    string alias = ((string *)keys_tmp156.data)[l];
    string mod = tos3("");
    map_get(tmp156, alias, &mod);
...
bool compiler__Table_known_type(compiler__Table *table, string typ_) {
  ...
  bool tmp10 = map_get(/*table.v : 339*/ table->typesmap, typ, &tmp9);
...
Option_compiler__Fn compiler__Table_find_fn(compiler__Table *t, string name) {
  ...
  bool tmp12 = map_get(/*table.v : 348*/ t->fns, name, &tmp11);
...
Option_compiler__Fn compiler__Table_find_fn_is_script(compiler__Table *t,
  ...
  bool tmp15 = map_get(/*table.v : 356*/ t->fns, name, &tmp14);
...
void compiler__Table_add_field(compiler__Table *table, string type_name,
  ...
  bool tmp23 = map_get(/*table.v : 432*/ table->typesmap, type_name, &tmp22);
...
bool compiler__Type_has_field(compiler__Type *t, string name) {
  Option_compiler__Var tmp25 = compiler__Type_find_field(&/* ? */ *t, name);
  if (!tmp25.ok) {
...
Option_compiler__Var compiler__Type_find_field(compiler__Type *t, string name) {
  ...
  for (int tmp27 = 0; tmp27 < tmp26.len; tmp27++) {
    ...
    if (string_eq(field.name, name)) {
      compiler__Var tmp28 = OPTION_CAST(compiler__Var)(field);
      return opt_ok(&tmp28, sizeof(compiler__Var));
    };
  };
  return opt_none();
}
...
Option_compiler__Var compiler__Table_find_field(compiler__Table *table,
                                                compiler__Type *typ,
                                                string name) {
  array_compiler__Var tmp30 = typ->fields;
  for (int tmp31 = 0; tmp31 < tmp30.len; tmp31++) {
  ...
  if (string_ne(typ->parent, tos3(""))) {
    ...
    array_compiler__Var tmp33 = parent.fields;
    for (int tmp34 = 0; tmp34 < tmp33.len; tmp34++) {
      compiler__Var field = ((compiler__Var *)tmp33.data)[tmp34];

      if (string_eq(field.name, name)) {
        compiler__Var tmp35 = OPTION_CAST(compiler__Var)(field);
        return opt_ok(&tmp35, sizeof(compiler__Var));
      };
    };
  };
  return opt_none();
...
void compiler__Parser_add_method(compiler__Parser *p, string type_name,
  ...
  compiler__Type tmp36 = {0};
  bool tmp37 = map_get(/*table.v : 493*/ p->table->typesmap, type_name, &tmp36);

  compiler__Type t = tmp36;
...
bool compiler__Type_has_method(compiler__Type *t, string name) {
  Option_compiler__Fn tmp39 = compiler__Type_find_method(&/* ? */ *t, name);
  if (!tmp39.ok) {
...
Option_compiler__Fn compiler__Table_find_method(compiler__Table *table,
  ...
  bool tmp42 = map_get(/*table.v : 512*/ table->typesmap, typ->name, &tmp41);

  compiler__Type t = tmp41;
  array_compiler__Fn tmp43 = t.methods;
  for (int tmp44 = 0; tmp44 < tmp43.len; tmp44++) {
    compiler__Fn method = ((compiler__Fn *)tmp43.data)[tmp44];

    if (string_eq(method.name, name)) {
      compiler__Fn tmp45 = OPTION_CAST(compiler__Fn)(method);
      return opt_ok(&tmp45, sizeof(compiler__Fn));
    };
  };
  if (string_ne(typ->parent, tos3(""))) {
    compiler__Type parent =
        compiler__Table_find_type(&/* ? */ *table, typ->parent);
    array_compiler__Fn tmp46 = parent.methods;
    for (int tmp47 = 0; tmp47 < tmp46.len; tmp47++) {
      compiler__Fn method = ((compiler__Fn *)tmp46.data)[tmp47];

      if (string_eq(method.name, name)) {
        compiler__Fn tmp48 = OPTION_CAST(compiler__Fn)(method);
        return opt_ok(&tmp48, sizeof(compiler__Fn));
      };
    };
    return opt_none();
  };
...
Option_compiler__Fn compiler__Type_find_method(compiler__Type *t, string name) {
  array_compiler__Fn tmp49 = t->methods;
  for (int tmp50 = 0; tmp50 < tmp49.len; tmp50++) {
    compiler__Fn method = ((compiler__Fn *)tmp49.data)[tmp50];

    if (string_eq(method.name, name)) {
      compiler__Fn tmp51 = OPTION_CAST(compiler__Fn)(method);
      return opt_ok(&tmp51, sizeof(compiler__Fn));
    };
  };
  return opt_none();
}
void compiler__Table_add_gen_type(compiler__Table *table, string type_name,
                                  string gen_type) {
  compiler__Type tmp52 = {0};
  bool tmp53 = map_get(/*table.v : 542*/ table->typesmap, type_name, &tmp52);

  compiler__Type t = tmp52;
  if ((_IN(string, (gen_type), t.gen_types))) {

    return;
  };
  _PUSH(&t.gen_types, (/*typ = array_string   tmp_typ=string*/ gen_type), tmp54,
        string);
  map_set(&table->typesmap, type_name, &(compiler__Type[]){t});
}
compiler__Type compiler__Parser_find_type(compiler__Parser *p, string name) {
...
compiler__Type compiler__Table_find_type(compiler__Table *t, string name_) {
  ...
  compiler__Type tmp55 = {0};
  bool tmp56 = map_get(/*table.v : 567*/ t->typesmap, name, &tmp55);
...
bool compiler__Parser_satisfies_interface(compiler__Parser *p,
  ...
  array_compiler__Fn tmp61 = int_typ.methods;
  for (int tmp62 = 0; tmp62 < tmp61.len; tmp62++) {
...
bool compiler__Table_is_interface(compiler__Table *table, string name) {
  ...
  compiler__Type tmp63 = {0};
  bool tmp64 = map_get(/*table.v : 743*/ table->typesmap, name, &tmp63);

  compiler__Type t = tmp63;
  return t.cat == compiler__compiler__TypeCategory_interface_;
}
bool compiler__Table_main_exists(compiler__Table *t) {
  map_compiler__Fn tmp65 = t->fns;
...
Option_compiler__Var compiler__Table_find_const(compiler__Table *t,
                                                string name) {
  array_compiler__Var tmp67 = t->consts;
  for (int tmp68 = 0; tmp68 < tmp67.len; tmp68++) {
    compiler__Var c = ((compiler__Var *)tmp67.data)[tmp68];

    if (string_eq(c.name, name)) {
      compiler__Var tmp69 = OPTION_CAST(compiler__Var)(c);
      return opt_ok(&tmp69, sizeof(compiler__Var));
    };
  };
  return opt_none();
}
...
bool compiler__is_valid_int_const(string val, string typ) {
  ...
  if (string_eq(tmp72, tos3("byte"))) {
    return 0 <= x && x <= 255;
  } else if (string_eq(tmp72, tos3("u16"))) {
    return 0 <= x && x <= 65535;
  } else if (string_eq(tmp72, tos3("i8"))) {
    return -128 <= x && x <= 127;
  };
  return 1;
}
string compiler__Parser_typ_to_fmt(compiler__Parser *p, string typ, int level) {
  ...
  if (string_eq(tmp73, tos3("string"))) {
    return tos3("%.*s");
  } else if (string_eq(tmp73, tos3("ustring"))) {
    return tos3("%.*s");
  } else if ((string_eq(tmp73, tos3("byte"))) ||
             (string_eq(tmp73, tos3("bool"))) ||
             (string_eq(tmp73, tos3("int"))) ||
             (string_eq(tmp73, tos3("char"))) ||
             (string_eq(tmp73, tos3("byte"))) ||
             (string_eq(tmp73, tos3("i16"))) ||
             (string_eq(tmp73, tos3("i8")))) {
    return tos3("%d");
  } else if ((string_eq(tmp73, tos3("u16"))) ||
             (string_eq(tmp73, tos3("u32")))) {
    return tos3("%u");
  } else if ((string_eq(tmp73, tos3("f64"))) ||
             (string_eq(tmp73, tos3("f32")))) {
    return tos3("%f");
  } else if (string_eq(tmp73, tos3("i64"))) {
    return tos3("%lld");
  } else if (string_eq(tmp73, tos3("u64"))) {
    return tos3("%llu");
  } else if ((string_eq(tmp73, tos3("byte*"))) ||
             (string_eq(tmp73, tos3("byteptr")))) {
    return tos3("%s");
  } else if (string_eq(tmp73, tos3("void"))) {
...
bool compiler__is_compile_time_const(string s_) {
  ...
  string tmp74 = s;
  array_byte bytes_tmp74 = string_bytes(tmp74);
  ;
  for (int tmp75 = 0; tmp75 < tmp74.len; tmp75++) {
    byte c = ((byte *)bytes_tmp74.data)[tmp75];
...
string compiler__Table_find_misspelled_fn(compiler__Table *table, string name,
  ...
  map_compiler__Fn tmp86 = table->fns;
...
string compiler__Table_find_misspelled_imported_mod(compiler__Table *table,
  ...
  string n1 = ((string_starts_with(name, tos3("main.")))
                   ...
                   : (name));
  map_string tmp89 = p->import_table.imports;
  array_string keys_tmp89 = map_keys(&tmp89);
  for (int l = 0; l < keys_tmp89.len; l++) {
    string alias = ((string *)keys_tmp89.data)[l];
    string mod = tos3("");
    map_get(tmp89, alias, &mod);
...
string compiler__Table_find_misspelled_const(compiler__Table *table,
  ...
  array_compiler__Var tmp90 = table->consts;
  for (int tmp91 = 0; tmp91 < tmp90.len; tmp91++) {
    compiler__Var cnst = ((compiler__Var *)tmp90.data)[tmp91];
...
compiler__Table_find_misspelled_type(compiler__Table *table, string name,
  ...
  map_compiler__Type tmp92 = table->typesmap;
  array_string keys_tmp92 = map_keys(&tmp92);
  for (int l = 0; l < keys_tmp92.len; l++) {
    string _ = ((string *)keys_tmp92.data)[l];
...
string compiler__type_cat_str(compiler__TypeCategory tc) {
  compiler__TypeCategory tmp93 = tc;

  string tc_str =
      ((tmp93 == compiler__compiler__TypeCategory_builtin)
           ? (tos3("builtin"))
           : ((tmp93 == compiler__compiler__TypeCategory_struct_)
                  ? (tos3("struct"))
                  : ((tmp93 == compiler__compiler__TypeCategory_func)
                         ? (tos3("function"))
                         : ((tmp93 ==
