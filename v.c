...
Option_array_string os__read_lines(string path) {
  ...
  while (fgets((char *)(byte *)buf + buf_index, buf_len - buf_index, fp) != 0) {
    ...
    _PUSH(&res, (/*typ = array_string   tmp_typ=string*/ tos_clone(buf)), tmp10,
          string);
    buf_index = 0;
  };
  fclose(fp);
...
Option_array_ustring os__read_ulines(string path) {
  Option_array_string tmp12 = os__read_lines(path);
  array_string lines;
  if (!tmp12.ok) {
    string err = tmp12.error;
    int errcode = tmp12.ecode;
    string tmp13 = OPTION_CAST(string)(err);
    return opt_ok(&tmp13, sizeof(string));
  }
  lines = *(array_string *)tmp12.data;
  ;
  array_ustring ulines = new_array_from_c_array(
      0, 0, sizeof(ustring), EMPTY_ARRAY_OF_ELEMS(ustring, 0){TCCSKIP(0)});
  array_string tmp14 = lines;
  for (int tmp15 = 0; tmp15 < tmp14.len; tmp15++) {
    string myline = ((string *)tmp14.data)[tmp15];

    _PUSH(&ulines,
          (/*typ = array_ustring   tmp_typ=ustring*/ string_ustring(myline)),
          tmp16, ustring);
  };
  array_ustring tmp17 = OPTION_CAST(array_ustring)(ulines);
  return opt_ok(&tmp17, sizeof(array_ustring));
}
Option_os__File os__open(string path) {
  ...
  os__File tmp18 = OPTION_CAST(os__File)(file);
  return opt_ok(&tmp18, sizeof(os__File));
}
Option_os__File os__create(string path) {
  os__File file = (os__File){.cfile = 0};
#ifdef _WIN32
  ...
  os__File tmp19 = OPTION_CAST(os__File)(file);
  return opt_ok(&tmp19, sizeof(os__File));
}
Option_os__File os__open_append(string path) {
  os__File file = (os__File){.cfile = 0};
#ifdef _WIN32
...
string os__sigint_to_signal_name(int si) {
  ...
  if ((tmp22 == 30) || (tmp22 == 10) || (tmp22 == 16)) {
    return tos3("SIGUSR1");
  } else if ((tmp22 == 31) || (tmp22 == 12) || (tmp22 == 17)) {
    return tos3("SIGUSR2");
  } else if ((tmp22 == 20) || (tmp22 == 17) || (tmp22 == 18)) {
    return tos3("SIGCHLD");
  } else if ((tmp22 == 19) || (tmp22 == 18) || (tmp22 == 25)) {
    return tos3("SIGCONT");
  } else if ((tmp22 == 17) || (tmp22 == 19) || (tmp22 == 23)) {
    return tos3("SIGSTOP");
  } else if ((tmp22 == 18) || (tmp22 == 20) || (tmp22 == 24)) {
    return tos3("SIGTSTP");
  } else if ((tmp22 == 21) || (tmp22 == 21) || (tmp22 == 26)) {
    return tos3("SIGTTIN");
  } else if ((tmp22 == 22) || (tmp22 == 22) || (tmp22 == 27)) {
    return tos3("SIGTTOU");
  } else if (tmp22 == 5) {
    return tos3("SIGTRAP");
  } else if (tmp22 == 7) {
...
array_string os__get_lines() {
  ...
  while (1) {
    ...
    _PUSH(&inputstr, (/*typ = array_string   tmp_typ=string*/ line), tmp31,
          string);
  };
  return inputstr;
}
...
void compiler__V_cc(compiler__V *v) {
  ...
  if (v->pref->fast) {
    ...
    if (string_eq(v->pref->ccompiler, tos3("cc")) &&
      ...
      _PUSH(&a, (/*typ = array_string   tmp_typ=string*/ tos3("-m64")), tmp2,
            string);
    };
#endif
    ;
  ...
  if (compiler__Table_known_type(&/* ? */ *p->table, name)) {
    if (!is_c && (compiler__Parser_peek(&/* ? */ *p) ==
      ...
      if ((_IN(string, (typ), map_keys(&/* ? */ p->cur_fn.dispatch_of.inst)))) {
        string tmp10 = tos3("");
        bool tmp11 = map_get(/*expression.v : 244*/ p->cur_fn.dispatch_of.inst,
                             typ, &tmp10);
    ...
    if (string_ends_with(receiver.typ, tos3("er"))) {
      ...
      if (t.cat == compiler__compiler__TypeCategory_interface_) {
        ...
        for (int i = 0; i < tmp56.len; i++) {
          compiler__Fn method = ((compiler__Fn *)tmp56.data)[i];
...
void compiler__Parser_fn_args(compiler__Parser *p, compiler__Fn *f) {
  ...
  while (p->tok != compiler__compiler__TokenKind_rpar) {
    ...
    array_string tmp62 = names;
    for (int tmp63 = 0; tmp63 < tmp62.len; tmp63++) {
      string name = ((string *)tmp62.data)[tmp63];
...
void compiler__Parser_fn_call_args(compiler__Parser *p, compiler__Fn *f) {
  ...
  array_string saved_args = new_array_from_c_array(
      0, 0, sizeof(string), EMPTY_ARRAY_OF_ELEMS(string, 0){TCCSKIP(0)});
  array_compiler__Var tmp66 = f->args;
  for (int i = 0; i < tmp66.len; i++) {
    compiler__Var arg = ((compiler__Var *)tmp66.data)[i];
    ...
    if (type_mismatch && f->is_generic) {
      _PUSH(&saved_args, (/*typ = array_string   tmp_typ=string*/ got), tmp68,
            string);
...
compiler__TypeInst compiler__Parser_extract_type_inst(compiler__Parser *p,
  ...
  if (string_ne(f->typ, tos3("void"))) {
    _PUSH(&args, (/*typ = array_string   tmp_typ=string*/ f->typ), tmp73,
          string);
  };
  array_string tmp74 = args;
  for (int tmp75 = 0; tmp75 < tmp74.len; tmp75++) {
    string e = ((string *)tmp74.data)[tmp75];
    ...
    if (string_starts_with(ti, tos3("fn ("))) {
      array_string fn_args = string_split(
          ...
          tos3(","));
      bool found = 0;
      array_string tmp80 = fn_args;
      for (int tmp81 = 0; tmp81 < tmp80.len; tmp81++) {
        string fa_ = ((string *)tmp80.data)[tmp81];
      ...
      if (string_ne(tmp88, ti)) {
        ...
        compiler__Parser_error(
            p, _STR("type parameter `%.*s` has type %.*s, not `%.*s`", tp.len,
                    tp.str, tmp90.len, tmp90.str, ti.len, ti.str));
      };
      continue;
    };
  ...
  if (string_eq(tmp92, tos3("")) && (_IN(string, (f->typ), f->type_pars))) {
    map_set(&r.inst, f->typ, &(string[]){tos3("_ANYTYPE_")});
  };
  array_string tmp94 = f->type_pars;
...
array_string compiler__Parser_replace_type_params(compiler__Parser *p,
  ...
  array_string sig = new_array_from_c_array(
      0, 0, sizeof(string), EMPTY_ARRAY_OF_ELEMS(string, 0){TCCSKIP(0)});
  array_compiler__Var tmp98 = f->args;
  for (int tmp99 = 0; tmp99 < tmp98.len; tmp99++) {
    compiler__Var a = ((compiler__Var *)tmp98.data)[tmp99];

    _PUSH(&sig, (/*typ = array_string   tmp_typ=string*/ a.typ), tmp100,
          string);
  };
  _PUSH(&sig, (/*typ = array_string   tmp_typ=string*/ f->typ), tmp101, string);
  array_string r = new_array_from_c_array(
      0, 0, sizeof(string), EMPTY_ARRAY_OF_ELEMS(string, 0){TCCSKIP(0)});
  array_string tmp102 = sig;
  for (int _ = 0; _ < tmp102.len; _++) {
    string a = ((string *)tmp102.data)[_];
    ...
    if (string_starts_with(fi, tos3("fn ("))) {
      ...
      _PUSH(&fn_args,
            ...
            tmp105, string);
      array_string tmp106 = fn_args;
      for (int i = 0; i < tmp106.len; i++) {
        string fa_ = ((string *)tmp106.data)[i];
      ...
      _PUSH(&r, (/*typ = array_string   tmp_typ=string*/ fr), tmp111, string);
      continue;
    };
    ...
    _PUSH(&r, (/*typ = array_string   tmp_typ=string*/ fr), tmp118, string);
  };
  return r;
}
string compiler__Parser_register_vargs_stuct(compiler__Parser *p, string typ,
...
compiler__Parser_fn_call_vargs(compiler__Parser *p, compiler__Fn f) {
  ...
  while (p->tok != compiler__compiler__TokenKind_rpar) {
    ...
    if (!f.is_generic) {
      ...
      if (types.len > 0) {
        array_string tmp128 = types;
        for (int tmp129 = 0; tmp129 < tmp128.len; tmp129++) {
          string t = ((string *)tmp128.data)[tmp129];
                        ...
                        !string_ends_with(varg_type, tos3("*")))
                           ...
                           : ((!string_ends_with(last_arg.typ, tos3("*")) &&
                               string_ends_with(varg_type, tos3("*")))
                                  ? (tos3("*"))
                                  : (tos3("")));
    _PUSH(&types, (/*typ = array_string   tmp_typ=string*/ varg_type), tmp130,
          string);
    _PUSH(&values,
          (/*typ = array_string   tmp_typ=string*/ _STR(
  ...
  array_compiler__VargAccess tmp132 = p->table->varg_access;
  for (int tmp133 = 0; tmp133 < tmp132.len; tmp133++) {
    compiler__VargAccess va = ((compiler__VargAccess *)tmp132.data)[tmp133];
...
string compiler__Parser_register_multi_return_stuct(compiler__Parser *p,
  ...
  compiler__Table_register_type2(
      ...
      (compiler__Type){.cat = compiler__compiler__TypeCategory_struct_,
                       ...
                       .is_placeholder = 0,
                       .gen_str = 0});
  array_string tmp138 = string_split(
      string_replace(string_replace(typ, tos3("_V_MulRet_"), tos3("")),
                     tos3("_PTR_"), tos3("*")),
      tos3("_V_"));
  for (int i = 0; i < tmp138.len; i++) {
    string t = ((string *)tmp138.data)[i];
...
void compiler__Parser_rename_generic_fn_instance(compiler__Parser *p,
  ...
  array_string tmp140 = map_keys(&/* ? */ ti.inst);
  for (int tmp141 = 0; tmp141 < tmp140.len; tmp141++) {
    ...
    f->name = string_add(string_add(f->name, tos3("_")),
                         compiler__type_to_safe_str(tmp142));
  };
}
void compiler__Parser_dispatch_generic_fn_instance(compiler__Parser *p,
                                                   compiler__Fn *f,
                                                   compiler__TypeInst ti) {
  bool new_inst = 1;
  array_compiler__TypeInst tmp144 = f->type_inst;
  for (int tmp145 = 0; tmp145 < tmp144.len; tmp145++) {
    compiler__TypeInst e = ((compiler__TypeInst *)tmp144.data)[tmp145];
  ...
  for (int tmp160 = 0; tmp160 < tmp159.len; tmp160++) {
    compiler__Var arg = ((compiler__Var *)tmp159.data)[tmp160];
  ...
  compiler__Parser_genln(
      ...
      _STR("%.*s%.*s %.*s(%.*s) {",
           ...
           compiler__Parser_get_linkage_prefix(&/* ? */ *p).str, f->typ.len,
           f->typ.str, f->name.len, f->name.str, str_args.len, str_args.str));
  compiler__Parser_statements(p);
  p->in_dispatch = 0;
  ...
  array_string tmp163 = p->cgen->lines;
  for (int tmp164 = 0; tmp164 < tmp163.len; tmp164++) {
    string l = ((string *)tmp163.data)[tmp164];

    _PUSH(&p->cgen->fns, (/*typ = array_string   tmp_typ=string*/ l), tmp165,
          string);
  };
...
string compiler__Fn_str_args(compiler__Fn *f, compiler__Table *table) {
  ...
  for (int i = 0; i < tmp167.len; i++) {
    compiler__Var arg = ((compiler__Var *)tmp167.data)[i];
...
string compiler__Parser_find_misspelled_local_var(compiler__Parser *p,
  ...
  array_compiler__Var tmp168 = p->local_vars;
  for (int tmp169 = 0; tmp169 < tmp168.len; tmp169++) {
    compiler__Var var = ((compiler__Var *)tmp168.data)[tmp169];
...
bool array_compiler__Fn_contains(array_compiler__Fn fns, compiler__Fn f) {
  array_compiler__Fn tmp170 = fns;
  for (int tmp171 = 0; tmp171 < tmp170.len; tmp171++) {
    compiler__Fn ff = ((compiler__Fn *)tmp170.data)[tmp171];
...
void compiler__V_generate_init(compiler__V *v) {
  ...
  if (v->pref->build_mode == compiler__compiler__BuildMode_default_mode) {
    ...
    array_string tmp13 = v->table->imports;
    for (int tmp14 = 0; tmp14 < tmp13.len; tmp14++) {
      string mod = ((string *)tmp13.data)[tmp14];
...
void compiler__V_generate_main(compiler__V *v) {
  ...
  if (v->pref->build_mode != compiler__compiler__BuildMode_build_module) {
    if (!compiler__Table_main_exists(&/* ? */ *v->table) && !v->pref->is_test) {
      ...
      map_compiler__Fn tmp16 = v->table->fns;
...
void compiler__V_run_compiled_executable_and_exit(compiler__V v) {
  ...
  array_string tmp17 = args;
  for (int i = 0; i < tmp17.len; i++) {
    string a = ((string *)tmp17.data)[i];
...
array_string compiler__V_v_files_from_dir(compiler__V *v, string dir) {
  ...
  Option_array_string tmp20 = os__ls(dir);
  array_string files;
  if (!tmp20.ok) {
  ...
  files = *(array_string *)tmp20.data;
  ;
  if (v->pref->is_verbose) {
    printf("v_files_from_dir (\"%.*s\")\n", dir.len, dir.str);
  };
  array_string_sort(&/* ? */ files);
  array_string tmp21 = files;
  for (int tmp22 = 0; tmp22 < tmp21.len; tmp22++) {
...
void compiler__V_add_v_files_to_compile(compiler__V *v) {
  ...
  for (int tmp29 = 0; tmp29 < tmp28.len; tmp29++) {
    ...
    if (p.v_script) {
      ...
      _PUSH(&p.table->imports,
            (/*typ = array_string   tmp_typ=string*/ tos3("os")), tmp30,
            string);
  ...
  array_string tmp31 = imported_mods;
  for (int tmp32 = 0; tmp32 < tmp31.len; tmp32++) {
    string mod = ((string *)tmp31.data)[tmp32];
  ...
  array_compiler__Parser tmp38 = v->parsers;
  for (int tmp39 = 0; tmp39 < tmp38.len; tmp39++) {
    compiler__Parser p = ((compiler__Parser *)tmp38.data)[tmp39];
...
array_string compiler__V_get_user_files(compiler__V *v) {
  ...
  if (is_test_with_imports) {
    _PUSH(&user_files, (/*typ = array_string   tmp_typ=string*/ dir), tmp43,
          string);
  ...
  if (string_ends_with(dir, tos3(".v")) ||
    ...
    _PUSH(&user_files, (/*typ = array_string   tmp_typ=string*/ dir), tmp46,
          string);
    ...
    for (int tmp48 = 0; tmp48 < tmp47.len; tmp48++) {
      ...
      _PUSH(&user_files, (/*typ = array_string   tmp_typ=string*/ file), tmp49,
            string);
    };
  };
  if (user_files.len == 0) {
...
void compiler__V_parse_lib_imports(compiler__V *v) {
  ...
  int tmp53 = 0;
  ;
  for (int tmp54 = tmp53; tmp54 < v->parsers.len; tmp54++) {
    int i = tmp54;
    ...
    for (int l = 0; l < keys_tmp55.len; l++) {
      ...
      Option_string tmp58 = compiler__V_find_module_path(&/* ? */ *v, mod);
      string import_path;
      if (!tmp58.ok) {
      ...
      _PUSH(&done_imports, (/*typ = array_string   tmp_typ=string*/ mod), tmp75,
            string);
    };
  };
}
...
array_string compiler__env_vflags_and_os_args() {
  ...
  if (string_ne(tos3(""), vflags)) {
    ...
    _PUSH_MANY(&args, (/*typ = array_string   tmp_typ=string*/ os__args), tmp91,
               array_string);
  };
  return args;
}
...
compiler__OS compiler__os_from_string(string os) {
  ...
  if (string_eq(tmp92, tos3("linux"))) {
    return compiler__compiler__OS_linux;
  } else if (string_eq(tmp92, tos3("windows"))) {
    return compiler__compiler__OS_windows;
  } else if (string_eq(tmp92, tos3("mac"))) {
    return compiler__compiler__OS_mac;
  } else if (string_eq(tmp92, tos3("freebsd"))) {
    return compiler__compiler__OS_freebsd;
  } else if (string_eq(tmp92, tos3("openbsd"))) {
    return compiler__compiler__OS_openbsd;
  } else if (string_eq(tmp92, tos3("netbsd"))) {
    return compiler__compiler__OS_netbsd;
  } else if (string_eq(tmp92, tos3("dragonfly"))) {
    return compiler__compiler__OS_dragonfly;
  } else if (string_eq(tmp92, tos3("js"))) {
    return compiler__compiler__OS_js;
  } else if (string_eq(tmp92, tos3("solaris"))) {
    return compiler__compiler__OS_solaris;
  } else if (string_eq(tmp92, tos3("android"))) {
    return compiler__compiler__OS_android;
  } else if (string_eq(tmp92, tos3("msvc"))) {
...
compiler__V *compiler__new_v_compiler_with_args(array_string args) {
  ...
  _PUSH_MANY(&allargs, (/*typ = array_string   tmp_typ=string*/ args), tmp93,
             array_string);
...
void compiler__Parser_const_decl(compiler__Parser *p) {
  ...
  while (p->tok == compiler__compiler__TokenKind_name) {
    ...
    Option_compiler__Var tmp22 =
        compiler__Table_find_const(&/* ? */ *p->v->table, name);

    if (tmp22.ok) {
      compiler__Var my_const = *(compiler__Var *)tmp22.data;
      if (string_eq(my_const.typ, tos3("void"))) {
        array_compiler__Var tmp23 = p->v->table->consts;
        for (int i = 0; i < tmp23.len; i++) {
          compiler__Var v = ((compiler__Var *)tmp23.data)[i];
...
compiler__TypeCategory compiler__key_to_type_cat(compiler__TokenKind tok) {
  ...
  if (tmp31 == compiler__compiler__TokenKind_key_interface) {
    return compiler__compiler__TypeCategory_interface_;
  } else if (tmp31 == compiler__compiler__TokenKind_key_struct) {
    return compiler__compiler__TypeCategory_struct_;
  } else if (tmp31 == compiler__compiler__TokenKind_key_union) {
...
void compiler__Parser_check_not_reserved(compiler__Parser *p) {
  bool tmp32 = 0;
  bool tmp33 =
      map_get(/*parser.v : 710*/ compiler__Reserved_Types, p->lit, &tmp32);
...
string compiler__Parser_get_type(compiler__Parser *p) {
  ...
  if ((_IN(string, (p->lit), map_keys(&/* ? */ ti)))) {
    string tmp35 = tos3("");
    bool tmp36 = map_get(/*parser.v : 890*/ ti, p->lit, &tmp35);

    if (!tmp36)
      tmp35 = tos((byte *)"", 0);

    typ = string_add(typ, tmp35);
  } else {
...
string compiler__Parser_dot(compiler__Parser *p, string str_typ_,
  ...
  if (has_field) {
    string struct_field =
        (string_ne(typ.name, tos3("Option")))
            ? (compiler__Table_var_cgen_name(&/* ? */ *p->table, field_name))
            : (field_name);
    Option_compiler__Var tmp94 = compiler__Table_find_field(
    ...
    field = *(compiler__Var *)tmp94.data;
    ;
  ...
  method = *(compiler__Fn *)tmp95.data;
  ;
...
string compiler__Parser_assoc(compiler__Parser *p) {
  compiler__Parser_next(p);
  string name = compiler__Parser_check_name(p);
  Option_compiler__Var tmp115 = compiler__Parser_find_var(&/* ? */ *p, name);
  compiler__Var var;
  if (!tmp115.ok) {
  ...
  while (p->tok != compiler__compiler__TokenKind_rcbr) {
    ...
    string field = compiler__Parser_check_name(p);
    _PUSH(&fields, (/*typ = array_string   tmp_typ=string*/ field), tmp116,
          string);
    compiler__Parser_gen(p, _STR(".%.*s = ", field.len, field.str));
    compiler__Parser_check(p, compiler__compiler__TokenKind_colon);
    compiler__Parser_bool_expression(p);
  ...
  array_compiler__Var tmp117 = T.fields;
  for (int tmp118 = 0; tmp118 < tmp117.len; tmp118++) {
    compiler__Var ffield = ((compiler__Var *)tmp117.data)[tmp118];
...
string compiler__Parser_array_init(compiler__Parser *p) {
  ...
  if (p->tok == compiler__compiler__TokenKind_name && !p->inside_const) {
    ...
    if (compiler__Table_known_const(&/* ? */ *p->table, const_name)) {
      Option_compiler__Var tmp119 =
          compiler__Table_find_const(&/* ? */ *p->table, const_name);
      compiler__Var c;
      if (!tmp119.ok) {
        string err = tmp119.error;
        int errcode = tmp119.ecode;
        v_exit(1);
      }
      c = *(compiler__Var *)tmp119.data;
      ;
...
void compiler__Parser_return_st(compiler__Parser *p) {
  ...
  if (fn_returns) {
    ...
    _PUSH(&types, (/*typ = array_string   tmp_typ=string*/ expr_type), tmp132,
          string);
    while (p->tok == compiler__compiler__TokenKind_comma) {
      ...
      string typ = _V_mret_typ_expr.var_0;
      string expr = _V_mret_typ_expr.var_1;
      _PUSH(&types, (/*typ = array_string   tmp_typ=string*/ typ), tmp133,
            string);
      _PUSH(&mr_values,
    ...
    if (types.len > 1) {
      ...
      array_string tmp135 = mr_values;
      for (int ret_val_idx = 0; ret_val_idx < tmp135.len; ret_val_idx++) {
        string ret_val = ((string *)tmp135.data)[ret_val_idx];
...
string compiler__Parser_get_deferred_text(compiler__Parser *p) {
  ...
  array_string tmp140 = p->cur_fn.defer_text;
  for (int tmp141 = 0; tmp141 < tmp140.len; tmp141++) {
    string text = ((string *)tmp140.data)[tmp141];
...
void compiler__Parser_go_statement(compiler__Parser *p) {
  ...
  if (compiler__Parser_peek(&/* ? */ *p) == compiler__compiler__TokenKind_dot) {
    ...
    method = *(compiler__Fn *)tmp143.data;
    ;
    compiler__Parser_async_fn_call(p, method, 0, var_name, v.typ);
  } else {
    string f_name = p->lit;
    Option_compiler__Fn tmp144 = compiler__Table_find_fn(
...
string compiler__Parser_js_decode(compiler__Parser *p) {
  ...
  if (string_eq(op, tos3("decode"))) {
    ...
    compiler__Type T = compiler__Table_find_type(&/* ? */ *p->table, typ);
    array_compiler__Var tmp145 = T.fields;
    for (int tmp146 = 0; tmp146 < tmp145.len; tmp146++) {
      compiler__Var field = ((compiler__Var *)tmp145.data)[tmp146];
...
void compiler__Parser_check_unused_imports(compiler__Parser *p) {
  ...
  string output = tos3("");
  map_string tmp154 = p->import_table.imports;
  array_string keys_tmp154 = map_keys(&tmp154);
  for (int l = 0; l < keys_tmp154.len; l++) {
    string alias = ((string *)keys_tmp154.data)[l];
    string mod = tos3("");
    map_get(tmp154, alias, &mod);
