...
typedef enum {
	v__table__TypeExtra_unset, // 0
	v__table__TypeExtra_optional, // 1
	v__table__TypeExtra_variadic, // 2
} v__table__TypeExtra;
...
typedef struct v__ast__LineComment v__ast__LineComment;
typedef struct v__ast__MultiLineComment v__ast__MultiLineComment;
...
typedef enum {
	...
	v__token__Kind_line_comment, // 54
	v__token__Kind_mline_comment, // 55
...
typedef map map_string_v__table__Var;
...
struct v__ast__MultiLineComment {
	string text;
};

struct v__ast__LineComment {
	string text;
};
...
struct v__table__Table {
	...
	map_string_v__table__Var consts;
...
struct v__ast__CallExpr {
	...
	array_v__table__Type exp_arg_types;
	bool is_c;
...
typedef struct {
	v__ast__Scope* arg0;
	v__ast__Var arg1;
} multi_return_v__ast__Scope_v__ast__Var;
...
int _const_os__sys_open_nocancel; // inited later
int _const_os__sys_stat64; // inited later
#include <dirent.h>
#include <unistd.h>
#include <fcntl.h>
...
v__table__Type v__table__type_clear_extra(v__table__Type t);
v__table__TypeExtra v__table__type_extra(v__table__Type t);
v__table__Type v__table__type_set_extra(v__table__Type t, v__table__TypeExtra extra);
bool v__table__type_is_optional(v__table__Type t);
v__table__Type v__table__type_to_optional(v__table__Type t);
bool v__table__type_is_variadic(v__table__Type t);
v__table__Type v__table__type_to_variadic(v__table__Type t);
...
void v__table__Table_register_const(v__table__Table* t, v__table__Var v);
void v__table__Table_register_global(v__table__Table* t, string name, v__table__Type typ);
...
typedef Option Option_v__table__Var;
Option_v__table__Var v__table__Table_find_const(v__table__Table* t, string name);
...
void v__builder__verror(string err);
...
bool _const_v__parser__colored_output; // inited later
v__ast__Stmt v__parser__parse_stmt(string text, v__table__Table* table, v__ast__Scope* scope);
v__ast__File v__parser__parse_file(string path, v__table__Table* table, v__scanner__CommentsMode comments_mode, v__pref__Preferences* pref);
array_v__ast__File v__parser__parse_files(array_string paths, v__table__Table* table, v__pref__Preferences* pref);
...
v__ast__LineComment v__parser__Parser_line_comment(v__parser__Parser* p);
...
void v__parser__Parser_error_at_line(v__parser__Parser* p, string s, int line_nr);
...
typedef Option Option_multi_return_v__ast__Scope_v__ast__Var;
Option_multi_return_v__ast__Scope_v__ast__Var v__ast__Scope_find_scope_and_var(v__ast__Scope* s, string name);
...
void v__ast__Scope_register_var(v__ast__Scope* s, v__ast__Var var);
void v__ast__Scope_override_var(v__ast__Scope* s, v__ast__Var var);
...
string v__ast__Scope_show(v__ast__Scope* sc, int level);
...
v__checker__Checker v__checker__new_checker(v__table__Table* table);
...
array_v__table__TypeSymbol v__gen__Gen_sort_structs(v__gen__Gen* g, array_v__table__TypeSymbol types);
...
void v__gen__x64__Gen_gen_print_from_expr(v__gen__x64__Gen* g, v__ast__Expr expr);
...
v__token__Token v__scanner__Scanner_scan_res(v__scanner__Scanner* s, v__token__Kind tok_kind, string lit);
...
char * v_typeof_sumtype_106(int sidx) { /* v.table.TypeInfo */ 
	switch(sidx) {
		case 106: return "v.table.TypeInfo";
		case 97: return "v.table.Array";
		case 98: return "v.table.ArrayFixed";
		case 99: return "v.table.Map";
		case 100: return "v.table.Struct";
		case 101: return "v.table.MultiReturn";
		case 102: return "v.table.Alias";
		case 103: return "v.table.Enum";
		case 104: return "v.table.SumType";
		case 105: return "v.table.FnType";
...
char * v_typeof_sumtype_123(int sidx) { /* v.ast.Stmt */ 
	switch(sidx) {
		...
		case 219: return "v.ast.GlobalDecl";
		case 126: return "v.ast.FnDecl";
		case 215: return "v.ast.Return";
		case 163: return "v.ast.Module";
		case 160: return "v.ast.Import";
		case 175: return "v.ast.ExprStmt";
		case 199: return "v.ast.ForStmt";
		case 213: return "v.ast.StructDecl";
		case 200: return "v.ast.ForCStmt";
		case 201: return "v.ast.ForInStmt";
		case 149: return "v.ast.CompIf";
		case 211: return "v.ast.ConstDecl";
		case 178: return "v.ast.Attr";
		case 169: return "v.ast.BranchStmt";
		case 218: return "v.ast.HashStmt";
		case 217: return "v.ast.AssignStmt";
		case 224: return "v.ast.EnumDecl";
		case 225: return "v.ast.TypeDecl";
		case 171: return "v.ast.DeferStmt";
		case 174: return "v.ast.GotoLabel";
		case 173: return "v.ast.GotoStmt";
		case 166: return "v.ast.LineComment";
		case 165: return "v.ast.MultiLineComment";
		case 168: return "v.ast.AssertStmt";
		case 170: return "v.ast.UnsafeStmt";
		case 172: return "v.ast.GoStmt";
		case 167: return "v.ast.Block";
		case 214: return "v.ast.InterfaceDecl";
		default: return "unknown v.ast.Stmt";
	}
}
char * v_typeof_sumtype_176(int sidx) { /* v.ast.Expr */ 
	switch(sidx) {
		case 176: return "v.ast.Expr";
		case 193: return "v.ast.InfixExpr";
		case 202: return "v.ast.IfExpr";
		case 206: return "v.ast.StringLiteral";
		case 210: return "v.ast.IntegerLiteral";
		case 186: return "v.ast.CharLiteral";
		case 209: return "v.ast.FloatLiteral";
		case 179: return "v.ast.Ident";
		case 150: return "v.ast.CallExpr";
		case 187: return "v.ast.BoolLiteral";
		case 181: return "v.ast.StructInit";
		case 208: return "v.ast.ArrayInit";
		case 198: return "v.ast.SelectorExpr";
		case 194: return "v.ast.PostfixExpr";
		case 177: return "v.ast.AssignExpr";
		case 195: return "v.ast.PrefixExpr";
		case 196: return "v.ast.IndexExpr";
		case 197: return "v.ast.RangeExpr";
		case 220: return "v.ast.MatchExpr";
		case 184: return "v.ast.CastExpr";
		case 185: return "v.ast.EnumVal";
		case 229: return "v.ast.Assoc";
		case 190: return "v.ast.SizeOf";
		case 189: return "v.ast.None";
		case 183: return "v.ast.MapInit";
		case 205: return "v.ast.IfGuardExpr";
		case 188: return "v.ast.ParExpr";
		case 152: return "v.ast.OrExpr";
		case 230: return "v.ast.ConcatExpr";
		case 223: return "v.ast.Type";
		case 192: return "v.ast.AsCast";
		case 191: return "v.ast.TypeOf";
		case 207: return "v.ast.StringInterLiteral";
		default: return "unknown v.ast.Expr";
	}
}
char * v_typeof_sumtype_225(int sidx) { /* v.ast.TypeDecl */ 
	switch(sidx) {
		case 225: return "v.ast.TypeDecl";
		case 228: return "v.ast.AliasTypeDecl";
		case 226: return "v.ast.SumTypeDecl";
		case 227: return "v.ast.FnTypeDecl";
		default: return "unknown v.ast.TypeDecl";
	}
}
char * v_typeof_sumtype_233(int sidx) { /* v.ast.IdentInfo */ 
	switch(sidx) {
		case 233: return "v.ast.IdentInfo";
		case 232: return "v.ast.IdentFn";
		case 180: return "v.ast.IdentVar";
...
array new_array(int mylen, int cap, int elm_size) { 
	/*assign_stmt*/int cap_ = (cap == 0 ? 1 : cap);
	/*assign_stmt*/array arr = (array){
		.len = mylen,
		.cap = cap_,
...
void array_ensure_cap(array* a, int required) { 
	...
	/*assign_stmt*/int cap = (a->cap == 0 ? 2 : a->cap * 2);
	while (required > cap) {
		cap *= 2;
	}
	if (a->cap == 0) {
...
array array_repeat(array a, int count) { 
	...
	/*assign_stmt*/int size = count * a.len * a.element_size;
	if (size == 0) {
		size = a.element_size;
	}
	/*assign_stmt*/array arr = (array){
	...
	for (int tmp3 = 0; tmp3 < count; tmp3++) { 
		int i = tmp3;
		memcpy(arr.data + i * a.len * a.element_size, a.data, a.len * a.element_size);
	}
	return arr;
}
...
void array_insert(array* a, int i, voidptr val) { 
	...
	/*assign_stmt*/int size = a->element_size;
...
array array_slice(array a, int start, int _end) { 
	...
	#endif
	/*assign_stmt*/int l = end - start;
	/*assign_stmt*/array res = (array){
		.element_size = a.element_size,
...
array array_slice2(array a, int start, int _end, bool end_max) { 
	/*assign_stmt*/int end = (end_max ? a.len : _end);
	return array_slice(a, start, end);
}

array array_clone(array* a) { 
	/*assign_stmt*/int size = a->cap * a->element_size;
	if (size == 0) {
		size++;
	}
	/*assign_stmt*/array arr = (array){
...
void array_push(array* a, voidptr val) { 
	array_ensure_cap(a, a->len + 1);
	memcpy(a->data + a->element_size * a->len, val, a->element_size);
	a->len++;
}

void array_push_many(array* a3, voidptr val, int size) { 
	if (a3->data == val) {
		/*assign_stmt*/array copy = array_clone(a3);
		array_ensure_cap(a3, a3->len + size);
		memcpy(a3->data + a3->element_size * a3->len, copy.data, a3->element_size * size);
	} else {
		array_ensure_cap(a3, a3->len + size);
		memcpy(a3->data + a3->element_size * a3->len, val, a3->element_size * size);
	}
	a3->len += size;
}
...
array array_reverse(array a) { 
	...
	for (int tmp2 = 0; tmp2 < a.len; tmp2++) { 
		int i = tmp2;
		memcpy(arr.data + i * arr.element_size, a.data + (a.len - 1 - i) * arr.element_size, arr.element_size);
	}
	return arr;
}
...
string array_string_str(array_string a) { 
	/*assign_stmt*/strings__Builder sb = strings__new_builder(a.len * 3);
	strings__Builder_write(&sb, tos3("["));
	for (int tmp1 = 0; tmp1 < a.len; tmp1++) { 
		int i = tmp1;
		/*assign_stmt*/string val = (*(string*)array_get(a, i));
		strings__Builder_write(&sb, tos3("\""));
...
string array_int_str(array_int a) { 
	/*assign_stmt*/strings__Builder sb = strings__new_builder(a.len * 13);
	strings__Builder_write(&sb, tos3("["));
	for (int tmp1 = 0; tmp1 < a.len; tmp1++) { 
		int i = tmp1;
		/*assign_stmt*/string val = int_str((*(int*)array_get(a, i)));
		strings__Builder_write(&sb, val);
		string_free(val);
		if (i < a.len - 1) {
			strings__Builder_write(&sb, tos3(", "));
...
string array_bool_str(array_bool a) { 
	...
	for (int tmp1 = 0; tmp1 < a.len; tmp1++) { 
		int i = tmp1;
		/*assign_stmt*/bool val = (*(bool*)array_get(a, i));
		if (val) {
...
string array_byte_hex(array_byte b) { 
	/*assign_stmt*/byteptr hex = v_malloc(b.len * 2 + 1);
	/*assign_stmt*/int dst_i = 0;
	// FOR IN
	for (int tmp1 = 0; tmp1 < b.len; tmp1++) {
		byte i = ((byte*)b.data)[tmp1];
		/*assign_stmt*/byte n0 = i >> 4;
		hex[dst_i++] = (n0 < 10 ? n0 + '0' : n0 + 87);
		/*assign_stmt*/byte n1 = (i & 0xF);
...
int copy(array_byte dst, array_byte src) { 
	if (dst.len > 0 && src.len > 0) {
		/*assign_stmt*/int min = 0;
		min = (dst.len < src.len ? dst.len : src.len);
		memcpy(dst.data, array_slice(src, 0, min).data, dst.element_size * min);
		return min;
	}
	return 0;
}
...
int array_int_reduce(array_int a, int (*iter)(int accum, int curr), int accum_start) { 
	/*assign_stmt*/int _accum = accum_start;
	// FOR IN
	for (int tmp1 = 0; tmp1 < a.len; tmp1++) {
...
array_voidptr array_pointers(array a) { 
	/*assign_stmt*/array_voidptr res = new_array(0, 0, sizeof(voidptr));
	for (int tmp1 = 0; tmp1 < a.len; tmp1++) { 
		int i = tmp1;
		_PUSH(&res, (a.data + i * a.element_size), tmp2, voidptr);
	}
	return res;
}
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/voidptr output_handle = GetStdHandle(STD_OUTPUT_HANDLE);
		/*assign_stmt*/int bytes_written = 0;
		if (is_atty(1) > 0) {
			/*assign_stmt*/u16* wide_str = string_to_wide(s);
			/*assign_stmt*/int wide_len = wcslen(wide_str);
...
#ifdef VPREALLOC
	// #if prealloc
		/*assign_stmt*/byteptr res = g_m2_ptr;
		g_m2_ptr += n;
		_const_nr_mallocs++;
		return res;
	#else
		/*assign_stmt*/byteptr ptr = malloc(n);
		if (ptr == 0) {
...
voidptr memdup(voidptr src, int sz) { 
	...
	/*assign_stmt*/byteptr mem = v_malloc(sz);
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/u32 mode = ((u32)(0));
		/*assign_stmt*/voidptr osfh = ((voidptr)(_get_osfhandle(fd)));
...
bool print_backtrace_skipping_top_frames_nix(int xskipframes) { 
	/*assign_stmt*/int skipframes = xskipframes + 2;
...
#ifdef __APPLE__
	// #if macos
		/*assign_stmt*/array_fixed_byteptr_100 buffer= {0};
		/*assign_stmt*/int nr_ptrs = backtrace(&/*qq*/buffer, 100);
...
bool print_backtrace_skipping_top_frames_linux(int skipframes) { 
	...
	// #if not android
		...
		// #if glibc
			/*assign_stmt*/array_fixed_byteptr_100 buffer= {0};
			/*assign_stmt*/int nr_ptrs = backtrace(&/*qq*/buffer, 100);
			/*assign_stmt*/int nr_actual_frames = nr_ptrs - skipframes;
			/*assign_stmt*/array_string sframes = new_array(0, 0, sizeof(string));
			/*assign_stmt*/byteptr* csymbols = backtrace_symbols(&buffer[skipframes], nr_actual_frames);
			for (int tmp1 = 0; tmp1 < nr_actual_frames; tmp1++) { 
				int i = tmp1;
				_PUSH(&sframes, (tos2(((byteptr)(((voidptr)(csymbols[i])))))), tmp2, string);
			}
			// FOR IN
			for (int tmp3 = 0; tmp3 < sframes.len; tmp3++) {
				string sframe = ((string*)sframes.data)[tmp3];
				/*assign_stmt*/string executable = string_all_before(sframe, tos3("("));
				/*assign_stmt*/string addr = string_all_before(string_all_after(sframe, tos3("[")), tos3("]"));
				/*assign_stmt*/string beforeaddr = string_all_before(sframe, tos3("["));
				/*assign_stmt*/string cmd = _STR("addr2line -e %.*s %.*s", executable.len, executable.str, addr.len, addr.str);
				/*assign_stmt*/voidptr f = popen(cmd.str, "r");
				if (isnil(f)) {
					println(sframe);
					continue;
				}
				/*assign_stmt*/array_fixed_byte_1000 buf= {0};
				/*assign_stmt*/string output = tos3("");
...
//[inline]
string f64_strsci(f64 x, int digit_num) { 
	/*assign_stmt*/int n_digit = digit_num;
	if (n_digit < 1) {
		n_digit = 1;
	} else if (n_digit > 17) {
		n_digit = 17;
...
string ptr_str(voidptr ptr) { 
	/*assign_stmt*/string buf1 = u64_hex(((u64)(ptr)));
	return buf1;
}

//[inline]
string int_str_l(int nn, int max) { 
	/*assign_stmt*/int n = nn;
	/*assign_stmt*/int d = 0;
	if (n == 0) {
		return tos3("0");
	}
	/*assign_stmt*/byteptr buf = v_malloc(max + 1);
	/*assign_stmt*/bool is_neg = false;
	if (n < 0) {
		n = -n;
		is_neg = true;
	}
	/*assign_stmt*/int index = max;
	buf[index--] = '\0';
	while (n > 0) {
		/*assign_stmt*/int n1 = n / 100;
		d = ((n - (n1 * 100)) << 1);
		n = n1;
...
string u32_str(u32 nn) { 
	/*assign_stmt*/u32 n = nn;
	/*assign_stmt*/u32 d = ((u32)(0));
	if (n == 0) {
		return tos3("0");
	}
	/*assign_stmt*/int max = 12;
	/*assign_stmt*/byteptr buf = v_malloc(max + 1);
	/*assign_stmt*/int index = max;
	buf[index--] = '\0';
	while (n > 0) {
		/*assign_stmt*/u32 n1 = n / ((u32)(100));
...
string i64_str(i64 nn) { 
	/*assign_stmt*/i64 n = nn;
	/*assign_stmt*/i64 d = ((i64)(0));
	if (n == 0) {
		return tos3("0");
	}
	/*assign_stmt*/int max = 20;
	/*assign_stmt*/byteptr buf = vcalloc(max + 1);
	/*assign_stmt*/bool is_neg = false;
	if (n < 0) {
		n = -n;
		is_neg = true;
...
string int_hex(int nn) { 
	/*assign_stmt*/u32 n = ((u32)(nn));
	/*assign_stmt*/int max = 10;
	/*assign_stmt*/byteptr buf = v_malloc(max + 1);
	/*assign_stmt*/int index = max;
	buf[index--] = '\0';
	while (n > 0) {
		/*assign_stmt*/u32 d = (n & 0xF);
		n = n >> 4;
...
string u64_hex(u64 nn) { 
	/*assign_stmt*/u64 n = nn;
	/*assign_stmt*/int max = 18;
	/*assign_stmt*/byteptr buf = v_malloc(max + 1);
	/*assign_stmt*/int index = max;
	buf[index--] = '\0';
	while (n > 0) {
		/*assign_stmt*/u64 d = (n & 0xF);
		n = n >> 4;
		buf[index--] = (d < 10 ? d + '0' : d + 87);
	}
	index++;
...
string rune_str(rune c) { 
	/*assign_stmt*/int fst_byte = (((int)(c)) >> 8 * 3 & 0xff);
	/*assign_stmt*/int len = utf8_char_len(fst_byte);
	/*assign_stmt*/string str = (string){
		.len = len,
		.str = v_malloc(len + 1),
	};
...
array_byte array_byte_clone(array_byte b) { 
	/*assign_stmt*/array_byte res = array_repeat(new_array_from_c_array(1, 1, sizeof(byte), (byte[1]){	
	((byte)(0)), 
}), b.len);
	for (int tmp1 = 0; tmp1 < b.len; tmp1++) { 
		int i = tmp1;
...
u32 DenseArray_push(DenseArray* d, KeyValue kv) { 
	...
	/*assign_stmt*/u32 push_index = d->size;
...
void DenseArray_zeros_to_end(DenseArray* d) { 
	/*assign_stmt*/u32 count = ((u32)(0));
	for (int tmp1 = 0; tmp1 < d->size; tmp1++) { 
		int i = tmp1;
		if (d->data[i].key.str != 0) {
			/*assign_stmt*/KeyValue tmp = d->data[count];
...
map new_map_init(int n, int value_bytes, string* keys, voidptr values) { 
	/*assign_stmt*/map out = new_map(n, value_bytes);
	for (int tmp1 = 0; tmp1 < n; tmp1++) { 
		int i = tmp1;
		map_set(&out, keys[i], values + i * value_bytes);
	}
	return out;
}
...
//[inline]
multi_return_u32_u32 map_key_to_index(map m, string key) { 
	/*assign_stmt*/u32 hash = ((u32)(hash__wyhash__wyhash_c(key.str, ((u64)(key.len)), 0)));
	/*assign_stmt*/u32 index = (hash & m.cap);
	/*assign_stmt*/u32 meta = (((hash >> m.shift) & _const_hash_mask)) | _const_probe_inc;
	return (multi_return_u32_u32){.arg0=index,.arg1=meta};
}

//[inline]
multi_return_u32_u32 meta_less(u32* metas, u32 i, u32 m) { 
	/*assign_stmt*/u32 index = i;
	/*assign_stmt*/u32 meta = m;
...
//[inline]
u32* map_meta_greater(map* m, u32* ms, u32 i, u32 me, u32 kvi) { 
	/*assign_stmt*/u32* metas = ms;
	/*assign_stmt*/u32 meta = me;
	/*assign_stmt*/u32 index = i;
	/*assign_stmt*/u32 kv_index = kvi;
	while (metas[index] != 0) {
		if (meta > metas[index]) {
			/*assign_stmt*/u32 tmp_meta = metas[index];
			metas[index] = meta;
			meta = tmp_meta;
			/*assign_stmt*/u32 tmp_index = metas[index + 1];
	...
	metas[index] = meta;
	metas[index + 1] = kv_index;
	/*assign_stmt*/u32 probe_count = (meta >> _const_hashbits) - 1;
	if ((probe_count << 1) == m->extra_metas) {
		m->extra_metas += _const_extra_metas_inc;
		/*assign_stmt*/u32 mem_size = (m->cap + 2 + m->extra_metas);
...
void map_set(map* m, string key, voidptr value) { 
	/*assign_stmt*/f32 load_factor = ((f32)(m->size << 1)) / ((f32)(m->cap));
	if (load_factor > _const_max_load_factor) {
		map_expand(m);
	}
	multi_return_u32_u32 mr_7093 = map_key_to_index(/*rec*/*m, key);
	u32 index = mr_7093.arg0;
	u32 meta = mr_7093.arg1;
	multi_return_u32_u32 mr_7127 = meta_less(m->metas, index, meta);
	index = mr_7127.arg0;
	meta = mr_7127.arg1;
	while (meta == m->metas[index]) {
		/*assign_stmt*/u32 kv_index = m->metas[index + 1];
	...
	/*assign_stmt*/KeyValue kv = (KeyValue){
		.key = key,
		.value = v_malloc(m->value_bytes),
	};
	memcpy(kv.value, value, m->value_bytes);
	/*assign_stmt*/u32 kv_index = DenseArray_push(&m->key_values, kv);
	m->metas = map_meta_greater(m, m->metas, index, meta, kv_index);
	m->size++;
}

void map_expand(map* m) { 
	/*assign_stmt*/u32 old_cap = m->cap;
	m->cap = ((m->cap + 2) << 1) - 2;
	if (m->window == 0) {
...
void map_rehash(map* m) { 
	/*assign_stmt*/int meta_bytes = sizeof(u32) * (m->cap + 2 + m->extra_metas);
	m->metas = ((u32*)(realloc(m->metas, meta_bytes)));
	memset(m->metas, 0, meta_bytes);
	for (/*assign_stmt*/u32 i = ((u32)(0));
	i < m->key_values.size; i++) {
		if (m->key_values.data[i].key.str == 0) {
			continue;
		}
		/*assign_stmt*/KeyValue kv = m->key_values.data[i];
		multi_return_u32_u32 mr_8273 = map_key_to_index(/*rec*/*m, kv.key);
		u32 index = mr_8273.arg0;
		u32 meta = mr_8273.arg1;
		multi_return_u32_u32 mr_8311 = meta_less(m->metas, index, meta);
		index = mr_8311.arg0;
		meta = mr_8311.arg1;
...
void map_cached_rehash(map* m, u32 old_cap) { 
	/*assign_stmt*/u32* new_meta = ((u32*)(vcalloc(sizeof(u32) * (m->cap + 2 + m->extra_metas))));
	/*assign_stmt*/u32 old_extra_metas = m->extra_metas;
	for (/*assign_stmt*/u32 i = ((u32)(0));
	i <= old_cap + old_extra_metas; i += 2) {
		if (m->metas[i] == 0) {
			continue;
		}
		/*assign_stmt*/u32 old_meta = m->metas[i];
		/*assign_stmt*/u32 old_probe_count = ((old_meta >> _const_hashbits) - 1) << 1;
		/*assign_stmt*/u32 old_index = ((i - old_probe_count) & (m->cap >> 1));
		/*assign_stmt*/u32 index = ((old_index | (old_meta << m->shift)) & m->cap);
		/*assign_stmt*/u32 meta = ((old_meta & _const_hash_mask)) | _const_probe_inc;
		multi_return_u32_u32 mr_8898 = meta_less(new_meta, index, meta);
		index = mr_8898.arg0;
		meta = mr_8898.arg1;
		/*assign_stmt*/u32 kv_index = m->metas[i + 1];
...
bool map_get(map m, string key, voidptr out) { 
	multi_return_u32_u32 mr_9145 = map_key_to_index(m, key);
	u32 index = mr_9145.arg0;
	u32 meta = mr_9145.arg1;
	multi_return_u32_u32 mr_9179 = meta_less(m.metas, index, meta);
	index = mr_9179.arg0;
	meta = mr_9179.arg1;
	while (meta == m.metas[index]) {
		/*assign_stmt*/u32 kv_index = m.metas[index + 1];
...
voidptr map_get2(map m, string key) { 
	multi_return_u32_u32 mr_9520 = map_key_to_index(m, key);
	u32 index = mr_9520.arg0;
	u32 meta = mr_9520.arg1;
	multi_return_u32_u32 mr_9554 = meta_less(m.metas, index, meta);
	index = mr_9554.arg0;
	meta = mr_9554.arg1;
	while (meta == m.metas[index]) {
		/*assign_stmt*/u32 kv_index = m.metas[index + 1];
		if (string_eq(key, m.key_values.data[kv_index].key)) {
			/*assign_stmt*/byteptr out = v_malloc(m.value_bytes);
			memcpy(out, m.key_values.data[kv_index].value, m.value_bytes);
			return out;
		}
		index += 2;
...
voidptr map_get3(map m, string key, voidptr zero) { 
	multi_return_u32_u32 mr_9945 = map_key_to_index(m, key);
	u32 index = mr_9945.arg0;
	u32 meta = mr_9945.arg1;
	multi_return_u32_u32 mr_9979 = meta_less(m.metas, index, meta);
	index = mr_9979.arg0;
	meta = mr_9979.arg1;
	while (meta == m.metas[index]) {
		/*assign_stmt*/u32 kv_index = m.metas[index + 1];
...
bool map_exists(map m, string key) { 
	...
	multi_return_u32_u32 mr_10413 = map_key_to_index(m, key);
	u32 index = mr_10413.arg0;
	u32 meta = mr_10413.arg1;
	multi_return_u32_u32 mr_10447 = meta_less(m.metas, index, meta);
	index = mr_10447.arg0;
	meta = mr_10447.arg1;
	while (meta == m.metas[index]) {
		/*assign_stmt*/u32 kv_index = m.metas[index + 1];
...
void map_delete(map* m, string key) { 
	multi_return_u32_u32 mr_10723 = map_key_to_index(/*rec*/*m, key);
	u32 index = mr_10723.arg0;
	u32 meta = mr_10723.arg1;
	multi_return_u32_u32 mr_10757 = meta_less(m->metas, index, meta);
	index = mr_10757.arg0;
	meta = mr_10757.arg1;
	while (meta == m->metas[index]) {
		/*assign_stmt*/u32 kv_index = m->metas[index + 1];
...
array_string map_keys(map* m) { 
	/*assign_stmt*/array_string keys = array_repeat(new_array_from_c_array(1, 1, sizeof(string), (string[1]){	
	tos3(""), 
}), m->size);
	if (m->value_bytes == 0) {
		return keys;
...
string map_string_str(map_string m) { 
	...
	/*assign_stmt*/strings__Builder sb = strings__new_builder(50);
...
SortedMap new_sorted_map_init(int n, int value_bytes, string* keys, voidptr values) { 
	/*assign_stmt*/SortedMap out = new_sorted_map(n, value_bytes);
	for (int tmp1 = 0; tmp1 < n; tmp1++) { 
		int i = tmp1;
		SortedMap_set(&out, keys[i], values + i * value_bytes);
	}
	return out;
}
...
void SortedMap_set(SortedMap* m, string key, voidptr value) { 
	/*assign_stmt*/mapnode* node = m->root;
	/*assign_stmt*/int child_index = 0;
	/*assign_stmt*/mapnode* parent = ((mapnode*)(0));
	while (1) {
...
void mapnode_split_child(mapnode* n, int child_index, mapnode* y) { 
	/*assign_stmt*/mapnode* z = new_node();
	z->size = _const_mid_index;
	y->size = _const_mid_index;
	for (/*assign_stmt*/int j = _const_mid_index - 1;
	j >= 0; j--) {
	...
	if (!isnil(y->children)) {
		...
		for (/*assign_stmt*/int jj = _const_degree - 1;
		jj >= 0; jj--) {
...
bool mapnode_remove_key(mapnode* n, string k) { 
	/*assign_stmt*/int idx = mapnode_find_key(n, k);
	if (idx < n->size && string_eq(n->keys[idx], k)) {
		...
		/*assign_stmt*/bool flag = (idx == n->size ? true : false);
...
void mapnode_remove_from_non_leaf(mapnode* n, int idx) { 
	/*assign_stmt*/string k = n->keys[idx];
	if (((mapnode*)(n->children[idx]))->size >= _const_degree) {
		/*assign_stmt*/mapnode* current = ((mapnode*)(n->children[idx]));
		while (!isnil(current->children)) {
			current = ((mapnode*)(current->children[current->size]));
		}
		/*assign_stmt*/string predecessor = current->keys[current->size - 1];
		...
		/*assign_stmt*/mapnode* current = ((mapnode*)(n->children[idx + 1]));
		while (!isnil(current->children)) {
			current = ((mapnode*)(current->children[0]));
		}
		/*assign_stmt*/string successor = current->keys[0];
...
void mapnode_borrow_from_prev(mapnode* n, int idx) { 
	/*assign_stmt*/mapnode* child = ((mapnode*)(n->children[idx]));
	/*assign_stmt*/mapnode* sibling = ((mapnode*)(n->children[idx - 1]));
	for (/*assign_stmt*/int i = child->size - 1;
	i >= 0; i--) {
		child->keys[i + 1] = child->keys[i];
		child->values[i + 1] = child->values[i];
	}
	if (!isnil(child->children)) {
		for (/*assign_stmt*/int i = child->size;
		i >= 0; i--) {
...
void SortedMap_delete(SortedMap* m, string key) { 
	...
	/*assign_stmt*/bool removed = mapnode_remove_key(m->root, key);
	if (removed) {
		m->size--;
	}
	if (m->root->size == 0) {
...
int mapnode_subkeys(mapnode* n, array_string* keys, int at) { 
	/*assign_stmt*/int position = at;
	if (!isnil(n->children)) {
		for (int tmp2 = 0; tmp2 < n->size; tmp2++) { 
			int i = tmp2;
			/*assign_stmt*/mapnode* child = ((mapnode*)(n->children[i]));
			position += mapnode_subkeys(child, keys, position);
			array_set(&keys, position, &(string[]) { n->keys[i] });
			position++;
		}
		/*assign_stmt*/mapnode* child = ((mapnode*)(n->children[n->size]));
		position += mapnode_subkeys(child, keys, position);
	} else {
...
string cstring_to_vstring(byteptr cstr) { 
	/*assign_stmt*/int slen = strlen(cstr);
	/*assign_stmt*/byteptr s = ((byteptr)(memdup(cstr, slen + 1)));
	s[slen] = '\0';
	return tos(s, slen);
}

string string_replace_once(string s, string rep, string with) { 
	/*assign_stmt*/Option_int index = string_index(s, rep);
	if (!index.ok) {
...
string string_replace(string s, string rep, string with) { 
	...
	/*assign_stmt*/array_int idxs = new_array(0, 0, sizeof(int));
	/*assign_stmt*/int idx = 0;
	while (1) {
	...
	/*assign_stmt*/int new_len = s.len + idxs.len * (with.len - rep.len);
	/*assign_stmt*/byteptr b = v_malloc(new_len + 1);
	/*assign_stmt*/int idx_pos = 0;
	/*assign_stmt*/int cur_idx = (*(int*)array_get(idxs, idx_pos));
	/*assign_stmt*/int b_i = 0;
	for (/*assign_stmt*/int i = 0;
	i < s.len; i++) {
		if (i == cur_idx) {
...
string string_replace_each(string s, array_string vals) { 
	...
	/*assign_stmt*/int new_len = s.len;
	/*assign_stmt*/array_RepIndex idxs = new_array(0, 0, sizeof(RepIndex));
	/*assign_stmt*/int idx = 0;
	for (/*assign_stmt*/int rep_i = 0;
	rep_i < vals.len; rep_i += 2) {
		/*assign_stmt*/string rep = (*(string*)array_get(vals, rep_i));
		/*assign_stmt*/string with = (*(string*)array_get(vals, rep_i + 1));
		while (1) {
			idx = string_index_after(s, rep, idx);
			if (idx == -1) {
				break;
	...
	/*assign_stmt*/byteptr b = v_malloc(new_len + 1);
	/*assign_stmt*/int idx_pos = 0;
	/*assign_stmt*/RepIndex cur_idx = (*(RepIndex*)array_get(idxs, idx_pos));
	/*assign_stmt*/int b_i = 0;
	for (/*assign_stmt*/int i = 0;
	i < s.len; i++) {
		if (i == cur_idx.idx) {
			/*assign_stmt*/string rep = (*(string*)array_get(vals, cur_idx.val_idx));
			/*assign_stmt*/string with = (*(string*)array_get(vals, cur_idx.val_idx + 1));
...
string string_add(string s, string a) { 
	/*assign_stmt*/int new_len = a.len + s.len;
	/*assign_stmt*/string res = (string){
		.len = new_len,
...
array_string string_split_nth(string s, string delim, int nth) { 
	/*assign_stmt*/array_string res = new_array(0, 0, sizeof(string));
	/*assign_stmt*/int i = 0;
	if (delim.len == 0) {
		i = 1;
	...
	/*assign_stmt*/int start = 0;
	/*assign_stmt*/int nth_1 = nth - 1;
	while (i <= s.len) {
		/*assign_stmt*/bool is_delim = s.str[i] == delim.str[0];
		/*assign_stmt*/int j = 0;
		while (is_delim && j < delim.len) {
			is_delim = is_delim && s.str[i + j] == delim.str[j];
			j++;
		}
		/*assign_stmt*/bool last = i == s.len - 1;
		if (is_delim || last) {
			if (!is_delim && last) {
				i++;
			}
			/*assign_stmt*/string val = string_substr(s, start, i);
			if (string_starts_with(val, delim)) {
				val = string_right(val, delim.len);
			}
			/*assign_stmt*/bool was_last = nth > 0 && res.len == nth_1;
			if (was_last) {
...
array_string string_split_into_lines(string s) { 
	...
	for (/*assign_stmt*/int i = 0;
	i < s.len; i++) {
		/*assign_stmt*/bool is_lf = s.str[i] == '\n';
		/*assign_stmt*/bool is_crlf = i != s.len - 1 && s.str[i] == '\r' && s.str[i + 1] == '\n';
		/*assign_stmt*/bool is_eol = is_lf || is_crlf;
		/*assign_stmt*/bool is_last = (is_crlf ? i == s.len - 2 : i == s.len - 1);
		if (is_eol || is_last) {
			if (is_last && !is_eol) {
				i++;
			}
			/*assign_stmt*/string line = string_substr(s, start, i);
...
string string_substr2(string s, int start, int _end, bool end_max) { 
	/*assign_stmt*/int end = (end_max ? s.len : _end);
...
int string_index_kmp(string s, string p) { 
	...
	/*assign_stmt*/array_int prefix = array_repeat(new_array_from_c_array(1, 1, sizeof(int), (int[1]){	
	0, 
}), p.len);
	/*assign_stmt*/int j = 0;
	for (/*assign_stmt*/int i = 1;
...
int string_index_any(string s, string chars) { 
	...
	byte c = chars.str[tmp1];
		/*assign_stmt*/Option_int index = string_index(s, byte_str(c));
		if (!index.ok) {
		string err = index.v_error;
		int errcode = index.ecode;
			continue;
...
int string_index_after(string s, string p, int start) { 
	...
	/*assign_stmt*/int i = strt;
	while (i < s.len) {
		/*assign_stmt*/int j = 0;
		/*assign_stmt*/int ii = i;
...
string string_to_lower(string s) { 
	/*assign_stmt*/byteptr b = v_malloc(s.len + 1);
	for (int tmp1 = 0; tmp1 < s.len; tmp1++) { 
		int i = tmp1;
		b[i] = tolower(s.str[i]);
	}
...
string string_capitalize(string s) { 
	...
	/*assign_stmt*/string sl = string_to_lower(s);
	/*assign_stmt*/string cap = string_add(string_to_upper(byte_str(string_at(sl, 0))), string_right(sl, 1));
	return cap;
}

string string_title(string s) { 
	/*assign_stmt*/array_string words = string_split(s, tos3(" "));
	/*assign_stmt*/array_string tit = new_array(0, 0, sizeof(string));
	// FOR IN
	for (int tmp1 = 0; tmp1 < words.len; tmp1++) {
		string word = ((string*)words.data)[tmp1];
		_PUSH(&tit, (string_capitalize(word)), tmp2, string);
	}
	/*assign_stmt*/string title = array_string_join(tit, tos3(" "));
	return title;
}

string string_find_between(string s, string start, string end) { 
	/*assign_stmt*/Option_int start_pos = string_index(s, start);
	if (!start_pos.ok) {
	string err = start_pos.v_error;
	int errcode = start_pos.ecode;
		return tos3("");
	};
	/*assign_stmt*/string val = string_right(s, /*opt*/(*(int*)start_pos.data) + start.len);
	/*assign_stmt*/Option_int end_pos = string_index(val, end);
	if (!end_pos.ok) {
...
bool array_string_contains(array_string ar, string val) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < ar.len; tmp1++) {
		string s = ((string*)ar.data)[tmp1];
		if (string_eq(s, val)) {
			return true;
		}
	}
...
string string_trim(string s, string cutset) { 
	...
	/*assign_stmt*/array_byte cs_arr = string_bytes(cutset);
	/*assign_stmt*/int pos_left = 0;
	/*assign_stmt*/int pos_right = s.len - 1;
	/*assign_stmt*/bool cs_match = true;
...
int compare_lower_strings(string* a, string* b) { 
	/*assign_stmt*/string aa = string_to_lower(/*rec*/*a);
	/*assign_stmt*/string bb = string_to_lower(/*rec*/*b);
...
ustring string_ustring(string s) { 
	/*assign_stmt*/ustring res = (ustring){
		.s = s,
	...
	for (/*assign_stmt*/int i = 0;
	i < s.len; i++) {
		/*assign_stmt*/int char_len = utf8_char_len(s.str[i]);
...
ustring ustring_add(ustring u, ustring a) { 
	...
	for (/*assign_stmt*/int i = 0;
	i < u.s.len; i++) {
		/*assign_stmt*/int char_len = utf8_char_len(u.s.str[i]);
	...
	for (/*assign_stmt*/int i = 0;
	i < a.s.len; i++) {
		/*assign_stmt*/int char_len = utf8_char_len(a.s.str[i]);
...
string ustring_substr(ustring u, int _start, int _end) { 
	...
	#endif
	/*assign_stmt*/int end = (_end >= u.len ? u.s.len : (*(int*)array_get(u.runes, _end)));
...
string string_all_before(string s, string dot) { 
	/*assign_stmt*/Option_int pos = string_index(s, dot);
	if (!pos.ok) {
...
string string_all_before_last(string s, string dot) { 
	/*assign_stmt*/Option_int pos = string_last_index(s, dot);
	if (!pos.ok) {
	string err = pos.v_error;
	int errcode = pos.ecode;
		return s;
...
string array_string_join(array_string a, string del) { 
	...
	for (int i = 0; i < a.len; i++) {
		string val = ((string*)a.data)[i];
		for (int tmp2 = 0; tmp2 < val.len; tmp2++) { 
			int j = tmp2;
			/*assign_stmt*/byte c = string_at(val, j);
...
string string_limit(string s, int max) { 
	/*assign_stmt*/ustring u = string_ustring(s);
	if (u.len <= max) {
		return s;
	}
...
array_byte string_bytes(string s) { 
	...
	/*assign_stmt*/array_byte buf = array_repeat(new_array_from_c_array(1, 1, sizeof(byte), (byte[1]){	
	((byte)(0)), 
}), s.len);
...
string string_repeat(string s, int count) { 
	...
	/*assign_stmt*/byteptr ret = v_malloc(s.len * count + 1);
...
string string_strip_margin(string s, varg_byte del) { 
	...
	/*assign_stmt*/byteptr ret = v_malloc(s.len + 1);
	/*assign_stmt*/int count = 0;
	for (/*assign_stmt*/int i = 0;
	i < s.len; i++) {
		if ((string_at(s, i) == '\n' || string_at(s, i) == '\r')) {
...
string utf32_to_str(u32 code) { 
	/*assign_stmt*/int icode = ((int)(code));
	/*assign_stmt*/byteptr buffer = v_malloc(5);
	if (icode <= 127) {
		buffer[0] = icode;
		return tos(buffer, 1);
	}
...
string utf32_to_str_no_malloc(u32 code, voidptr buf) { 
	/*assign_stmt*/int icode = ((int)(code));
	/*assign_stmt*/byteptr buffer = ((byteptr)(buf));
	if (icode <= 127) {
		buffer[0] = icode;
		return tos(buffer, 1);
	}
...
int string_utf32_code(string _rune) { 
	...
	/*assign_stmt*/byte b = ((byte)(((int)(string_at(_rune, 0)))));
	b = b << _rune.len;
	/*assign_stmt*/int res = ((int)(b));
	/*assign_stmt*/int shift = 6 - _rune.len;
	for (/*assign_stmt*/int i = 1;
	i < _rune.len; i++) {
		/*assign_stmt*/int c = ((int)(string_at(_rune, i)));
		res = res << shift;
		res |= (c & 63);
		shift = 6;
	}
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/int num_chars = (MultiByteToWideChar(_const_CP_UTF8, 0, _str.str, _str.len, 0, 0));
		/*assign_stmt*/u16* wstr = ((u16*)(v_malloc((num_chars + 1) * 2)));
		if (!isnil(wstr)) {
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/int wstr_len = wcslen(_wstr);
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/int num_chars = WideCharToMultiByte(_const_CP_UTF8, 0, _wstr, len, 0, 0, 0, 0);
		/*assign_stmt*/byteptr str_to = v_malloc(num_chars + 1);
		if (!isnil(str_to)) {
...
int utf8_getchar() { 
	/*assign_stmt*/int c = getchar();
	/*assign_stmt*/int len = utf8_len(~c);
	if (c < 0) {
		return 0;
	} else if (len == 0) {
		return c;
		...
		/*assign_stmt*/int uc = (c & ((1 << (7 - len)) - 1));
		for (/*assign_stmt*/int i = 0;
		i + 1 < len; i++) {
			/*assign_stmt*/int c2 = getchar();
			if (c2 != -1 && (c2 >> 6) == 2) {
				uc <<= 6;
				uc |= ((c2 & 63));
			} else if (c2 == -1) {
...
array_string join_flags_and_argument() { 
	/*assign_stmt*/string vosargs = os__getenv(tos3("VOSARGS"));
	if (string_ne(vosargs, tos3(""))) {
		return string_split(vosargs, tos3(" "));
	}
	/*assign_stmt*/array_string args = new_array(0, 0, sizeof(string));
	/*assign_stmt*/string vflags = os__getenv(tos3("VFLAGS"));
...
void parse_flags(string flag, internal__flag__Instance* f, internal__flag__MainCmdPreferences* prefs) { 
	if (string_eq(flag, tos3("v"))) {
		...
		/*assign_stmt*/Option_int level = internal__flag__Instance_int(f);
		if (!level.ok) {
...
void set_vroot_folder(string vroot_path) { 
	/*assign_stmt*/string vname = (string_eq(os__user_os(), tos3("windows")) ? tos3("v.exe") : tos3("v"));
	os__setenv(tos3("VEXE"), os__real_path(array_string_join(new_array_from_c_array(2, 2, sizeof(string), (string[2]){	
	vroot_path, vname, 
}), _const_os__path_separator)), true);
}

void launch_tool(v__pref__VerboseLevel verbosity, string tool_name) { 
	/*assign_stmt*/string vexe = v__pref__vexe_path();
	/*assign_stmt*/string vroot = os__dir(vexe);
	set_vroot_folder(vroot);
	/*assign_stmt*/string tool_args = array_string_join(array_slice(_const_os__args, 1, _const_os__args.len), tos3(" "));
	/*assign_stmt*/string tool_exe = path_of_executable(os__real_path(_STR("%.*s/cmd/tools/%.*s", vroot.len, vroot.str, tool_name.len, tool_name.str)));
	/*assign_stmt*/string tool_source = os__real_path(_STR("%.*s/cmd/tools/%.*s.v", vroot.len, vroot.str, tool_name.len, tool_name.str));
	/*assign_stmt*/string tool_command = _STR("\"%.*s\" %.*s", tool_exe.len, tool_exe.str, tool_args.len, tool_args.str);
	if (v__pref__VerboseLevel_is_higher_or_equal(verbosity, v__pref__VerboseLevel_level_two)) {
	...
	/*assign_stmt*/bool should_compile = false;
	...
	if (should_compile) {
		/*assign_stmt*/string compilation_command = _STR("\"%.*s\" ", vexe.len, vexe.str);
		...
		if (v__pref__VerboseLevel_is_higher_or_equal(verbosity, v__pref__VerboseLevel_level_three)) {
			eprintln(_STR("Compiling %.*s with: \"%.*s\"", tool_name.len, tool_name.str, compilation_command.len, compilation_command.str));
		}
		/*assign_stmt*/Option_os__Result tool_compilation = os__exec(compilation_command);
...
_const_os__args = os__init_os_args(argc, (byteptr*)argv);
	/*assign_stmt*/internal__flag__MainCmdPreferences prefs = (internal__flag__MainCmdPreferences){
		.verbosity = {0},
		.action = {0},
		.unknown_flag = tos3(""),
	};
	/*assign_stmt*/Option_array_string values = internal__flag__parse_main_cmd(_const_os__args, parse_flags, &/*qq*/prefs);
	if (!values.ok) {
	string err = values.v_error;
	int errcode = values.ecode;
		println(tos3("V Error: An error has occurred while parsing flags: "));
		println(err);
		v_exit(1);
	};
	if (v__pref__VerboseLevel_is_higher_or_equal(prefs.verbosity, v__pref__VerboseLevel_level_two)) {
		println(_STR("V %.*s %.*s", _const_v_version.len, _const_v_version.str, vhash().len, vhash().str));
	}
	if (v__pref__VerboseLevel_is_higher_or_equal(prefs.verbosity, v__pref__VerboseLevel_level_three)) {
		println(tos3("Parsed preferences: "));
		println(_STR("Remaining: %d", /*opt*/(*(array_string*)values.data)));
	}
	if (prefs.verbosity == v__pref__VerboseLevel_level_one && /*opt*/(*(array_string*)values.data).len == 0) {
		println(tos3("`v -v` now runs V with verbose mode set to level one which doesn't do anything."));
	...
	if (/*opt*/(*(array_string*)values.data).len == 0 && prefs.action == internal__flag__MainCmdAction_help) {
		invoke_help_and_exit(/*opt*/(*(array_string*)values.data));
	}
	if (/*opt*/(*(array_string*)values.data).len == 0 || string_eq((*(string*)array_get(/*opt*/(*(array_string*)values.data), 0)), tos3("-")) || string_eq((*(string*)array_get(/*opt*/(*(array_string*)values.data), 0)), tos3("repl"))) {
	...
	/*assign_stmt*/string command = (*(string*)array_get(/*opt*/(*(array_string*)values.data), 0));
	...
	if (string_eq(command, tos3("create")) || string_eq(command, tos3("init"))) {
		...
		disallow_unknown_flags(prefs);
		if (/*opt*/(*(array_string*)values.data).len == 1) {
			println(tos3("V Error: Expected argument: Module name to output documentations for"));
			v_exit(1);
		}
		/*assign_stmt*/v__table__Table* table = v__table__new_table();
		println(v__doc__doc((*(string*)array_get(/*opt*/(*(array_string*)values.data), 1)), table));
		return 0;
	}
	...
	if (string_eq(command, tos3("run")) || string_eq(command, tos3("build")) || string_ends_with(command, tos3(".v")) || os__exists(command)) {
		/*assign_stmt*/array_string arg = join_flags_and_argument();
...
void print_version_and_exit() { 
	/*assign_stmt*/string version_hash = vhash();
	println(_STR("V %.*s %.*s", _const_v_version.len, _const_v_version.str, version_hash.len, version_hash.str));
	v_exit(0);
}

string vhash() { 
	/*assign_stmt*/array_fixed_byte_50 buf= {0};
	buf[0] = 0;
...
void disallow_unknown_flags(internal__flag__MainCmdPreferences prefs) { 
	...
	println(_STR("V Error: Unexpected flag found: %.*s", prefs.unknown_flag.len, prefs.unknown_flag.str));
	v_exit(1);
}
...
void create_symlink() { 
	...
	#endif
	/*assign_stmt*/string vexe = v__pref__vexe_path();
	/*assign_stmt*/string link_path = tos3("/usr/local/bin/v");
	/*assign_stmt*/Option_os__Result ret = os__exec(_STR("ln -sf %.*s %.*s", vexe.len, vexe.str, link_path.len, link_path.str));
	if (!ret.ok) {
...
string strings__Builder_last_n(strings__Builder* b, int n) { 
	...
	/*assign_stmt*/array_byte buf = array_slice(b->buf, b->len - n, b->buf.len);
...
string strings__Builder_after(strings__Builder* b, int n) { 
	...
	/*assign_stmt*/array_byte buf = array_slice(b->buf, n, b->buf.len);
	/*assign_stmt*/array_byte copy = array_clone(&buf);
...
int strings__levenshtein_distance(string a, string b) { 
	/*assign_stmt*/array_int f = array_repeat(new_array_from_c_array(1, 1, sizeof(int), (int[1]){	
	0, 
}), b.len + 1);
	...
	byte ca = a.str[tmp2];
		/*assign_stmt*/int j = 1;
		/*assign_stmt*/int fj1 = (*(int*)array_get(f, 0));
		(*(int*)array_get(f, 0))++;
		for (int tmp3 = 0; tmp3 < b.len; tmp3++) {
		byte cb = b.str[tmp3];
			/*assign_stmt*/int mn = ((*(int*)array_get(f, j)) + 1 <= (*(int*)array_get(f, j - 1)) + 1 ? (*(int*)array_get(f, j)) + 1 : (*(int*)array_get(f, j - 1)) + 1);
			if (cb != ca) {
...
f32 strings__levenshtein_distance_percentage(string a, string b) { 
	/*assign_stmt*/int d = strings__levenshtein_distance(a, b);
	/*assign_stmt*/int l = (a.len >= b.len ? a.len : b.len);
...
f32 strings__dice_coefficient(string s1, string s2) { 
	...
	/*assign_stmt*/string a = (s1.len > s2.len ? s1 : s2);
	/*assign_stmt*/string b = (string_eq(a, s1) ? s2 : s1);
	/*assign_stmt*/map_string_int first_bigrams = new_map(1, sizeof(int));
	for (int tmp6 = 0; tmp6 < a.len - 1; tmp6++) { 
		int i = tmp6;
		/*assign_stmt*/string bigram = string_substr(a, i, i + 2);
		/*assign_stmt*/int q = (_IN_MAP(bigram, first_bigrams) ? (*(int*)map_get3(first_bigrams, bigram, &(int[]){ 0 })) + 1 : 1);
		map_set(&first_bigrams, bigram, &(int[]) { q });
	}
	/*assign_stmt*/int intersection_size = 0;
	for (int tmp8 = 0; tmp8 < b.len - 1; tmp8++) { 
		int i = tmp8;
		/*assign_stmt*/string bigram = string_substr(b, i, i + 2);
		/*assign_stmt*/int count = (_IN_MAP(bigram, first_bigrams) ? (*(int*)map_get3(first_bigrams, bigram, &(int[]){ 0 })) : 0);
		if (count > 0) {
...
string strings__repeat_string(string s, int n) { 
	...
	/*assign_stmt*/int slen = s.len;
	/*assign_stmt*/int blen = slen * n;
	/*assign_stmt*/byte* bytes = ((byte*)(0));
		bytes = v_malloc(blen + 1);
	for (int tmp2 = 0; tmp2 < n; tmp2++) { 
		int bi = tmp2;
		/*assign_stmt*/int bislen = bi * slen;
...
string strconv__ftoa__Dec32_get_string_32(strconv__ftoa__Dec32 d, bool neg, int i_n_digit) { 
	/*assign_stmt*/int n_digit = i_n_digit + 1;
	/*assign_stmt*/u32 out = d.m;
	/*assign_stmt*/int out_len = strconv__ftoa__decimal_len_32(out);
	/*assign_stmt*/int out_len_original = out_len;
	/*assign_stmt*/array_byte buf = array_repeat(new_array_from_c_array(1, 1, sizeof(byte), (byte[1]){	
	((byte)(0)), 
}), out_len + 5 + 1 + 1);
	/*assign_stmt*/int i = 0;
	...
	i++;
	/*assign_stmt*/int exp = d.e + out_len_original - 1;
	if (exp < 0) {
		array_set(&buf, i, &(byte[]) { '-' });
		i++;
		exp = -exp;
	...
	/*assign_stmt*/int d1 = exp % 10;
	/*assign_stmt*/int d0 = exp / 10;
...
multi_return_strconv__ftoa__Dec32_bool strconv__ftoa__f32_to_decimal_exact_int(u32 i_mant, u32 exp) { 
	/*assign_stmt*/strconv__ftoa__Dec32 d = (strconv__ftoa__Dec32){
		.m = 0,
		.e = 0,
	};
	/*assign_stmt*/u32 e = exp - _const_strconv__ftoa__bias32;
	if (e > _const_strconv__ftoa__mantbits32) {
		return (multi_return_strconv__ftoa__Dec32_bool){.arg0=d,.arg1=false};
	}
	/*assign_stmt*/u32 shift = _const_strconv__ftoa__mantbits32 - e;
	/*assign_stmt*/u32 mant = i_mant | 0x00800000;
	d.m = mant >> shift;
	if ((d.m << shift) != mant) {
		return (multi_return_strconv__ftoa__Dec32_bool){.arg0=d,.arg1=false};
	}
...
strconv__ftoa__Dec32 strconv__ftoa__f32_to_decimal(u32 mant, u32 exp) { 
	/*assign_stmt*/int e2 = 0;
	/*assign_stmt*/u32 m2 = ((u32)(0));
	if (exp == 0) {
	...
	/*assign_stmt*/bool even = ((m2 & 1)) == 0;
	/*assign_stmt*/bool accept_bounds = even;
	/*assign_stmt*/u32 mv = ((u32)(4 * m2));
	/*assign_stmt*/u32 mp = ((u32)(4 * m2 + 2));
	/*assign_stmt*/u32 mm_shift = strconv__ftoa__bool_to_u32(mant != 0 || exp <= 1);
	/*assign_stmt*/u32 mm = ((u32)(4 * m2 - 1 - mm_shift));
	/*assign_stmt*/u32 vr = ((u32)(0));
	/*assign_stmt*/u32 vp = ((u32)(0));
	/*assign_stmt*/u32 vm = ((u32)(0));
	/*assign_stmt*/int e10 = 0;
	/*assign_stmt*/bool vm_is_trailing_zeros = false;
	/*assign_stmt*/bool vr_is_trailing_zeros = false;
	/*assign_stmt*/byte last_removed_digit = ((byte)(0));
	if (e2 >= 0) {
		/*assign_stmt*/u32 q = strconv__ftoa__log10_pow2(e2);
		e10 = ((int)(q));
		/*assign_stmt*/int k = _const_strconv__ftoa__pow5_inv_num_bits_32 + strconv__ftoa__pow5_bits(((int)(q))) - 1;
		/*assign_stmt*/int i = -e2 + ((int)(q)) + k;
		...
		if (q != 0 && (vp - 1) / 10 <= vm / 10) {
			/*assign_stmt*/int l = _const_strconv__ftoa__pow5_inv_num_bits_32 + strconv__ftoa__pow5_bits(((int)(q - 1))) - 1;
		...
		/*assign_stmt*/u32 q = strconv__ftoa__log10_pow5(-e2);
		e10 = ((int)(q)) + e2;
		/*assign_stmt*/int i = -e2 - ((int)(q));
		/*assign_stmt*/int k = strconv__ftoa__pow5_bits(i) - _const_strconv__ftoa__pow5_num_bits_32;
		/*assign_stmt*/int j = ((int)(q)) - k;
	...
	/*assign_stmt*/int removed = 0;
	/*assign_stmt*/u32 out = ((u32)(0));
...
string strconv__ftoa__f32_to_str(f32 f, int n_digit) { 
	/*assign_stmt*/strconv__ftoa__Uf32 u1 = (strconv__ftoa__Uf32){
		.f = 0,
		.u = 0,
	};
	u1.f = f;
	/*assign_stmt*/u32 u = u1.u;
	/*assign_stmt*/bool neg = (u >> (_const_strconv__ftoa__mantbits32 + _const_strconv__ftoa__expbits32)) != 0;
	/*assign_stmt*/u32 mant = (u & ((((u32)(1)) << _const_strconv__ftoa__mantbits32) - ((u32)(1))));
	/*assign_stmt*/u32 exp = ((u >> _const_strconv__ftoa__mantbits32) & ((((u32)(1)) << _const_strconv__ftoa__expbits32) - ((u32)(1))));
...
string strconv__ftoa__Dec64_get_string_64(strconv__ftoa__Dec64 d, bool neg, int i_n_digit) { 
	/*assign_stmt*/int n_digit = i_n_digit + 1;
	/*assign_stmt*/u64 out = d.m;
	/*assign_stmt*/int out_len = strconv__ftoa__decimal_len_64(out);
	/*assign_stmt*/int out_len_original = out_len;
	/*assign_stmt*/array_byte buf = array_repeat(new_array_from_c_array(1, 1, sizeof(byte), (byte[1]){	
	((byte)(0)), 
}), out_len + 6 + 1 + 1);
...
multi_return_strconv__ftoa__Dec64_bool strconv__ftoa__f64_to_decimal_exact_int(u64 i_mant, u64 exp) { 
	/*assign_stmt*/strconv__ftoa__Dec64 d = (strconv__ftoa__Dec64){
		.m = 0,
		.e = 0,
	};
	/*assign_stmt*/u64 e = exp - _const_strconv__ftoa__bias64;
	if (e > _const_strconv__ftoa__mantbits64) {
		return (multi_return_strconv__ftoa__Dec64_bool){.arg0=d,.arg1=false};
	}
	/*assign_stmt*/u32 shift = _const_strconv__ftoa__mantbits64 - e;
	/*assign_stmt*/u64 mant = i_mant | ((u64)(0x0010000000000000));
	d.m = mant >> shift;
	if ((d.m << shift) != mant) {
		return (multi_return_strconv__ftoa__Dec64_bool){.arg0=d,.arg1=false};
	}
...
strconv__ftoa__Dec64 strconv__ftoa__f64_to_decimal(u64 mant, u64 exp) { 
	...
	/*assign_stmt*/bool even = ((m2 & 1)) == 0;
	/*assign_stmt*/bool accept_bounds = even;
	/*assign_stmt*/u64 mv = ((u64)(4 * m2));
	/*assign_stmt*/u64 mm_shift = strconv__ftoa__bool_to_u64(mant != 0 || exp <= 1);
	/*assign_stmt*/u64 vr = ((u64)(0));
	/*assign_stmt*/u64 vp = ((u64)(0));
	/*assign_stmt*/u64 vm = ((u64)(0));
	/*assign_stmt*/int e10 = 0;
	/*assign_stmt*/bool vm_is_trailing_zeros = false;
	/*assign_stmt*/bool vr_is_trailing_zeros = false;
	if (e2 >= 0) {
		/*assign_stmt*/u32 q = strconv__ftoa__log10_pow2(e2) - strconv__ftoa__bool_to_u32(e2 > 3);
		e10 = ((int)(q));
		/*assign_stmt*/int k = _const_strconv__ftoa__pow5_inv_num_bits_64 + strconv__ftoa__pow5_bits(((int)(q))) - 1;
		/*assign_stmt*/int i = -e2 + ((int)(q)) + k;
		/*assign_stmt*/strconv__ftoa__Uint128 mul = (*(strconv__ftoa__Uint128*)array_get(_const_strconv__ftoa__pow5_inv_split_64, q));
		...
		/*assign_stmt*/u32 q = strconv__ftoa__log10_pow5(-e2) - strconv__ftoa__bool_to_u32(-e2 > 1);
		e10 = ((int)(q)) + e2;
		/*assign_stmt*/int i = -e2 - ((int)(q));
		/*assign_stmt*/int k = strconv__ftoa__pow5_bits(i) - _const_strconv__ftoa__pow5_num_bits_64;
		/*assign_stmt*/int j = ((int)(q)) - k;
		/*assign_stmt*/strconv__ftoa__Uint128 mul = (*(strconv__ftoa__Uint128*)array_get(_const_strconv__ftoa__pow5_split_64, i));
	...
	/*assign_stmt*/int removed = 0;
	/*assign_stmt*/byte last_removed_digit = ((byte)(0));
	/*assign_stmt*/u64 out = ((u64)(0));
	if (vm_is_trailing_zeros || vr_is_trailing_zeros) {
		while (1) {
			/*assign_stmt*/u64 vp_div_10 = vp / 10;
			/*assign_stmt*/u64 vm_div_10 = vm / 10;
			if (vp_div_10 <= vm_div_10) {
				break;
			}
			/*assign_stmt*/u64 vm_mod_10 = vm % 10;
			/*assign_stmt*/u64 vr_div_10 = vr / 10;
			/*assign_stmt*/u64 vr_mod_10 = vr % 10;
		...
		/*assign_stmt*/bool round_up = false;
		while (vp / 100 > vm / 100) {
			round_up = (vr % 100) >= 50;
			vr /= 100;
			vp /= 100;
...
string strconv__ftoa__f64_to_str(f64 f, int n_digit) { 
	/*assign_stmt*/strconv__ftoa__Uf64 u1 = (strconv__ftoa__Uf64){
		.f = 0,
		.u = 0,
	};
	u1.f = f;
	/*assign_stmt*/u64 u = u1.u;
	/*assign_stmt*/bool neg = (u >> (_const_strconv__ftoa__mantbits64 + _const_strconv__ftoa__expbits64)) != 0;
	/*assign_stmt*/u64 mant = (u & ((((u64)(1)) << _const_strconv__ftoa__mantbits64) - ((u64)(1))));
	/*assign_stmt*/u64 exp = ((u >> _const_strconv__ftoa__mantbits64) & ((((u64)(1)) << _const_strconv__ftoa__expbits64) - ((u64)(1))));
...
u32 strconv__ftoa__mul_shift_32(u32 m, u64 mul, int ishift) { 
	// assert
	if( ishift > 32 ){}else{
		eprintln(_STR("/Users/alex/code/v/vlib/strconv/ftoa/utilities.v:100: FAIL: fn strconv.ftoa.mul_shift_32(): assert (ishift > 32)"));
		exit(1);
	}
	multi_return_u64_u64 mr_2322 = math__bits__mul_64(((u64)(m)), mul);
	u64 hi = mr_2322.arg0;
	u64 lo = mr_2322.arg1;
	/*assign_stmt*/u64 shifted_sum = (lo >> ((u64)(ishift))) + (hi << ((u64)(64 - ishift)));
	strconv__ftoa__assert1(shifted_sum <= _const_math__max_u32, tos3("shiftedSum <= math.max_u32"));
...
u32 strconv__ftoa__pow5_factor_32(u32 i_v) { 
	/*assign_stmt*/u32 v = i_v;
	for (/*assign_stmt*/u32 n = ((u32)(0));
	true; n++) {
		/*assign_stmt*/u32 q = v / 5;
		/*assign_stmt*/u32 r = v % 5;
		if (r != 0) {
			return n;
		}
		v = q;
...
int strconv__ftoa__decimal_len_64(u64 u) { 
	/*assign_stmt*/int log2 = 64 - math__bits__leading_zeros_64(u) - 1;
	/*assign_stmt*/int t = (log2 + 1) * 1233 >> 12;
...
u64 strconv__ftoa__mul_shift_64(u64 m, strconv__ftoa__Uint128 mul, int shift) { 
	...
	/*assign_stmt*/strconv__ftoa__Uint128 sum = (strconv__ftoa__Uint128){
		.hi = hihi,
		.lo = lohi + hilo,
	};
	if (sum.lo < lohi) {
...
u32 strconv__ftoa__pow5_factor_64(u64 v_i) { 
	/*assign_stmt*/u64 v = v_i;
	for (/*assign_stmt*/u32 n = ((u32)(0));
	true; n++) {
		/*assign_stmt*/u64 q = v / 5;
		/*assign_stmt*/u64 r = v % 5;
		if (r != 0) {
			return n;
		}
		v = q;
...
string strconv__ftoa__f64_to_str_l(f64 f) { 
	/*assign_stmt*/string s = strconv__ftoa__f64_to_str(f, 18);
	if (s.len > 2 && (string_at(s, 0) == 'n' || string_at(s, 1) == 'i')) {
		return s;
	}
	/*assign_stmt*/bool m_sgn_flag = false;
	/*assign_stmt*/int sgn = 1;
	/*assign_stmt*/array_fixed_byte_26 b= {0};
	/*assign_stmt*/int d_pos = 1;
	/*assign_stmt*/int i = 0;
	/*assign_stmt*/int i1 = 0;
	/*assign_stmt*/int exp = 0;
	/*assign_stmt*/int exp_sgn = 1;
	for (int tmp2 = 0; tmp2 < s.len; tmp2++) {
	byte c = s.str[tmp2];
		if (c == '-') {
			sgn = -1;
...
u64 hash__wyhash__wyhash64(byteptr key, u64 len, u64 seed_) { 
	...
	/*assign_stmt*/byte* p = &key[0];
	/*assign_stmt*/u64 seed = seed_;
	/*assign_stmt*/u64 i = (len & 63);
	if (i < 4) {
	...
	/*assign_stmt*/u64 see1 = seed;
	/*assign_stmt*/u64 see2 = seed;
	/*assign_stmt*/u64 see3 = seed;
	p = p + i;
	for (/*assign_stmt*/i = len - i;
	i >= 64; i -= 64) {
...
//[inline]
u64 hash__wyhash__wymum(u64 a, u64 b) { 
	/*assign_stmt*/u32 mask32 = ((u32)(4294967295));
	/*assign_stmt*/u64 x0 = (a & mask32);
	/*assign_stmt*/u64 x1 = a >> 32;
	/*assign_stmt*/u64 y0 = (b & mask32);
	/*assign_stmt*/u64 y1 = b >> 32;
	/*assign_stmt*/u64 w0 = x0 * y0;
	/*assign_stmt*/u64 t = x1 * y0 + (w0 >> 32);
	/*assign_stmt*/u64 w1 = (t & mask32);
	/*assign_stmt*/u64 w2 = t >> 32;
	w1 += x0 * y1;
	/*assign_stmt*/u64 hi = x1 * y1 + w2 + (w1 >> 32);
	/*assign_stmt*/u64 lo = a * b;
	return hi ^ lo;
}
...
multi_return_u32_u32_u32 strconv__lsr96(u32 s2, u32 s1, u32 s0) { 
	/*assign_stmt*/u32 r0 = ((u32)(0));
	/*assign_stmt*/u32 r1 = ((u32)(0));
	/*assign_stmt*/u32 r2 = ((u32)(0));
	r0 = (s0 >> 1) | (((s1 & ((u32)(1)))) << 31);
	r1 = (s1 >> 1) | (((s2 & ((u32)(1)))) << 31);
	r2 = s2 >> 1;
...
multi_return_int_strconv__PrepNumber strconv__parser(string s) { 
	/*assign_stmt*/int state = _const_strconv__fsm_a;
	/*assign_stmt*/int digx = 0;
	/*assign_stmt*/byte c = ' ';
	/*assign_stmt*/int result = _const_strconv__parser_ok;
	/*assign_stmt*/bool expneg = false;
	/*assign_stmt*/int expexp = 0;
	/*assign_stmt*/int i = 0;
	/*assign_stmt*/strconv__PrepNumber pn = (strconv__PrepNumber){
		.negative = 0,
		.exponent = 0,
		.mantissa = 0,
	};
...
u64 strconv__converter(strconv__PrepNumber* pn) { 
	/*assign_stmt*/int binexp = 92;
	/*assign_stmt*/u32 s2 = ((u32)(0));
	/*assign_stmt*/u32 s1 = ((u32)(0));
	/*assign_stmt*/u32 s0 = ((u32)(0));
	/*assign_stmt*/u32 q2 = ((u32)(0));
	/*assign_stmt*/u32 q1 = ((u32)(0));
	/*assign_stmt*/u32 q0 = ((u32)(0));
	/*assign_stmt*/u32 r2 = ((u32)(0));
	/*assign_stmt*/u32 r1 = ((u32)(0));
	/*assign_stmt*/u32 r0 = ((u32)(0));
	/*assign_stmt*/u32 mask28 = ((u32)(0xF << 28));
	/*assign_stmt*/u64 result = ((u64)(0));
	...
	/*assign_stmt*/int nbit = 7;
	/*assign_stmt*/u32 check_round_bit = ((u32)(1)) << ((u32)(nbit));
	/*assign_stmt*/u32 check_round_mask = ((u32)(0xFFFFFFFF)) << ((u32)(nbit));
	...
	if (binexp > 2046) {
		...
		/*assign_stmt*/u64 q = ((u64)(0));
		/*assign_stmt*/u64 binexs2 = ((u64)(binexp)) << 52;
...
f64 strconv__atof64(string s) { 
	...
	/*assign_stmt*/int res_parsing = 0;
	/*assign_stmt*/strconv__Float64u res = (strconv__Float64u){
		.f = 0,
		.u = 0,
	};
...
u64 strconv__common_parse_uint(string s, int _base, int _bit_size, bool error_on_non_digit, bool error_on_high_digit) { 
	/*assign_stmt*/int bit_size = _bit_size;
	/*assign_stmt*/int base = _base;
	if (s.len < 1 || !strconv__underscore_ok(s)) {
		return ((u64)(0));
	}
	/*assign_stmt*/bool base0 = base == 0;
	/*assign_stmt*/int start_index = 0;
	if (2 <= base && base <= 36) {
	} else if (base == 0) {
		base = 10;
		if (string_at(s, 0) == '0') {
	...
	/*assign_stmt*/u64 cutoff = _const_strconv__max_u64 / ((u64)(base)) + ((u64)(1));
	/*assign_stmt*/u64 max_val = (bit_size == 64 ? _const_strconv__max_u64 : (((u64)(1)) << ((u64)(bit_size))) - ((u64)(1)));
	/*assign_stmt*/bool underscores = false;
	/*assign_stmt*/u64 n = ((u64)(0));
	for (int tmp7 = start_index; tmp7 < s.len; tmp7++) { 
		int i = tmp7;
		/*assign_stmt*/byte c = string_at(s, i);
		/*assign_stmt*/byte cl = strconv__byte_to_lower(c);
		/*assign_stmt*/byte d = ((byte)(0));
		if (c == '_' && base0) {
			underscores = true;
			continue;
		} else if ('0' <= c && c <= '9') {
...
i64 strconv__common_parse_int(string _s, int base, int _bit_size, bool error_on_non_digit, bool error_on_high_digit) { 
	/*assign_stmt*/string s = _s;
	/*assign_stmt*/int bit_size = _bit_size;
	if (s.len < 1) {
		return ((i64)(0));
	}
	/*assign_stmt*/bool neg = false;
	if (string_at(s, 0) == '+') {
	...
	/*assign_stmt*/u64 un = strconv__common_parse_uint(s, base, bit_size, error_on_non_digit, error_on_high_digit);
	if (un == 0) {
		return ((i64)(0));
	}
	if (bit_size == 0) {
	...
	/*assign_stmt*/u64 cutoff = ((u64)(1)) << ((u64)(bit_size - 1));
	if (!neg && un >= cutoff) {
...
int strconv__atoi(string s) { 
	if ((_const_strconv__int_size == 32 && (0 < s.len && s.len < 10)) || (_const_strconv__int_size == 64 && (0 < s.len && s.len < 19))) {
		...
		for (int tmp4 = start_idx; tmp4 < s.len; tmp4++) { 
			int i = tmp4;
			/*assign_stmt*/byte ch = string_at(s, i) - '0';
			if (ch > 9) {
				return 0;
			}
			n = n * 10 + ((int)(ch));
	...
	/*assign_stmt*/i64 int64 = strconv__parse_int(s, 10, 0);
	return ((int)(int64));
}

bool strconv__underscore_ok(string s) { 
	/*assign_stmt*/byte saw = '^';
	/*assign_stmt*/int i = 0;
	if (s.len >= 1 && (string_at(s, 0) == '-' || string_at(s, 0) == '+')) {
		i++;
	}
	/*assign_stmt*/bool hex = false;
...
Option_array_string internal__flag__Instance_parse_impl(internal__flag__Instance* p, array_string args, voidptr value, internal__flag__void_cb callback) { 
	while (p->current_pos + 1 < p->args.len) {
		p->current_pos++;
		/*assign_stmt*/string next = (*(string*)array_get(p->args, p->current_pos));
		...
		/*assign_stmt*/string flag_name = tos3("");
		bool tmp3;
...
Option_int internal__flag__Instance_int(internal__flag__Instance* p) { 
	/*assign_stmt*/Option_string val = internal__flag__Instance_string(p);
	if (!val.ok) {
...
void internal__flag__Instance_is_equivalent_to(internal__flag__Instance* p, array_string flags) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < flags.len; tmp1++) {
		string v = ((string*)flags.data)[tmp1];
		map_set(&p->encountered, v, &(bool[]) { true });
	}
}

// TypeDecl
Option_array_string internal__flag__parse_pref(array_string args, void (*callback)(string, internal__flag__Instance*, v__pref__Preferences*), v__pref__Preferences* obj) { 
	/*assign_stmt*/internal__flag__Instance p = (internal__flag__Instance){
		.args = args,
		.current_pos = 0,
		.current_flag = tos3(""),
		.equal_val = tos3(""),
	...
	/*assign_stmt*/Option_array_string tmp = internal__flag__Instance_parse_impl(&p, args, obj, ((internal__flag__void_cb)(callback)));
	if (!tmp.ok) {
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/voidptr s = _wgetenv(string_to_wide(key));
		if (s == 0) {
			return tos3("");
		}
		return string_from_wide(s);
	#else
		/*assign_stmt*/char* s = getenv(key.str);
		if (s == 0) {
			return tos3("");
		}
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/string format = _STR("%.*s=%.*s", name.len, name.str, value.len, value.str);
		if (overwrite) {
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/string format = _STR("%.*s=", name.len, name.str);
		return _putenv(format.str);
	#else
...
map_string_string os__environ() { 
	/*assign_stmt*/map_string_string res = new_map(1, sizeof(string));
	
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/u16* estrings = GetEnvironmentStringsW();
		/*assign_stmt*/string eline = tos3("");
		for (/*assign_stmt*/u16* c = estrings;
		*c != 0; c = c + eline.len + 1) {
			eline = string_from_wide(c);
			/*assign_stmt*/int eq_index = string_index_byte(eline, '=');
			if (eq_index > 0) {
	...
	#else
		/*assign_stmt*/byteptr* e = ((byteptr*)(&environ));
		for (/*assign_stmt*/int i = 0;
		!isnil(&/*qq*/e[i]); i++) {
			/*assign_stmt*/string eline = cstring_to_vstring(&/*qq*/e[i]);
			/*assign_stmt*/int eq_index = string_index_byte(eline, '=');
			if (eq_index > 0) {
				map_set(&res, string_substr(eline, 0, eq_index), &(string[]) { string_substr(eline, eq_index + 1, eline.len) });
			}
...
array_byte os__File_read_bytes_at(os__File* f, int size, int pos) { 
	/*assign_stmt*/array_byte arr = array_repeat(new_array_from_c_array(1, 1, sizeof(byte), (byte[1]){	
	'0', 
}), size);
	fseek(f->cfile, pos, SEEK_SET);
	/*assign_stmt*/int nreadbytes = fread(arr.data, 1, size, f->cfile);
	fseek(f->cfile, 0, SEEK_SET);
	return array_slice(arr, 0, nreadbytes);
}

Option_array_byte os__read_bytes(string path) { 
	/*assign_stmt*/FILE* fp = os__vfopen(path, tos3("rb"));
	if (isnil(fp)) {
		return v_error(_STR("failed to open file \"%.*s\"", path.len, path.str));
	}
	fseek(fp, 0, SEEK_END);
	/*assign_stmt*/int fsize = ftell(fp);
	rewind(fp);
	/*assign_stmt*/array_byte res = array_repeat(new_array_from_c_array(1, 1, sizeof(byte), (byte[1]){	
	'0', 
}), fsize);
	/*assign_stmt*/int nr_read_elements = fread(res.data, fsize, 1, fp);
	fclose(fp);
	return opt_ok(& (array_byte []) { array_slice(res, 0, nr_read_elements * fsize) }, sizeof(array_byte));
}

Option_string os__read_file(string path) { 
	/*assign_stmt*/string mode = tos3("rb");
	/*assign_stmt*/FILE* fp = os__vfopen(path, mode);
	if (isnil(fp)) {
		return v_error(_STR("failed to open file \"%.*s\"", path.len, path.str));
	}
	fseek(fp, 0, SEEK_END);
...
int os__file_size(string path) { 
	/*assign_stmt*/struct stat s = (struct stat){
		.st_size = 0,
		.st_mode = 0,
		.st_mtime = 0,
	};
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/string _old = string_replace(old, tos3("/"), tos3("\\"));
		/*assign_stmt*/string _new = string_replace(new, tos3("/"), tos3("\\"));
		CopyFile(string_to_wide(_old), string_to_wide(_new), false);
		/*assign_stmt*/u32 result = GetLastError();
		if (result == 0) {
...
Option_bool os__cp_all(string osource_path, string odest_path, bool overwrite) { 
	/*assign_stmt*/string source_path = os__real_path(osource_path);
	/*assign_stmt*/string dest_path = os__real_path(odest_path);
	if (!os__exists(source_path)) {
		return v_error(tos3("Source path doesn\'t exist"));
	}
	if (!os__is_dir(source_path)) {
		/*assign_stmt*/string adjusted_path = (os__is_dir(dest_path) ? os__join_path(dest_path, (varg_string){.len=1,.args={os__file_name(source_path)}}) : dest_path);
	...
	/*assign_stmt*/Option_array_string files = os__ls(source_path);
	if (!files.ok) {
	...
	// FOR IN
	for (int tmp8 = 0; tmp8 < /*opt*/(*(array_string*)files.data).len; tmp8++) {
		string file = ((string*)/*opt*/(*(array_string*)files.data).data)[tmp8];
		/*assign_stmt*/string sp = os__join_path(source_path, (varg_string){.len=1,.args={file}});
		/*assign_stmt*/string dp = os__join_path(dest_path, (varg_string){.len=1,.args={file}});
		if (os__is_dir(sp)) {
...
Option_array_string os__read_lines(string path) { 
	/*assign_stmt*/Option_string buf = os__read_file(path);
	if (!buf.ok) {
...
Option_array_ustring os__read_ulines(string path) { 
	/*assign_stmt*/Option_array_string lines = os__read_lines(path);
	if (!lines.ok) {
	string err = lines.v_error;
	int errcode = lines.ecode;
		return v_error(err);
	};
	/*assign_stmt*/array_ustring ulines = new_array(0, 0, sizeof(ustring));
	// FOR IN
	for (int tmp1 = 0; tmp1 < /*opt*/(*(array_string*)lines.data).len; tmp1++) {
		string myline = ((string*)/*opt*/(*(array_string*)lines.data).data)[tmp1];
		_PUSH(&ulines, (string_ustring(myline)), tmp2, ustring);
	}
	return opt_ok(& (array_ustring []) { ulines }, sizeof(array_ustring));
}

Option_os__File os__open_append(string path) { 
	/*assign_stmt*/os__File file = (os__File){
		.cfile = 0,
		.fd = 0,
		.opened = 0,
	};
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/u16* wpath = string_to_wide(string_replace(path, tos3("/"), tos3("\\")));
		/*assign_stmt*/string mode = tos3("ab");
		file = (os__File){
	...
	#else
		/*assign_stmt*/byteptr cpath = path.str;
		file = (os__File){
...
Option_os__File os__open_file(string path, string mode, varg_int options) { 
	...
	/*assign_stmt*/int permission = 0666;
	if (options.len > 0) {
	...
	#endif
	/*assign_stmt*/string p = path;
	
#ifdef _WIN32
	// #if windows
		p = string_replace(path, tos3("/"), tos3("\\"));
	#endif
	/*assign_stmt*/int fd = open(((charptr)(p.str)), flags, permission);
	if (fd == -1) {
		return v_error(os__posix_get_error_msg(errno));
	}
	/*assign_stmt*/voidptr cfile = fdopen(fd, ((charptr)(mode.str)));
	if (isnil(cfile)) {
...
voidptr os__vpopen(string path) { 
	...
	// #if windows
		/*assign_stmt*/string mode = tos3("rb");
		/*assign_stmt*/u16* wpath = string_to_wide(path);
...
multi_return_int_bool os__posix_wait4_to_exit_status(int waitret) { 
	...
	#else
		/*assign_stmt*/int ret = 0;
		/*assign_stmt*/bool is_signaled = true;
...
string os__posix_get_error_msg(int code) { 
	/*assign_stmt*/charptr ptr_text = strerror(code);
	if (ptr_text == 0) {
		return tos3("");
	}
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/string wcmd = (cmd.len > 1 && string_at(cmd, 0) == '"' && string_at(cmd, 1) != '"' ? _STR("\"%.*s\"", cmd.len, cmd.str) : cmd);
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/string p = string_replace(path, tos3("/"), tos3("\\"));
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/string p = os__real_path(path);
		return (os__exists(p) && string_ends_with(p, tos3(".exe")));
	#endif
	
#ifdef __sun
	// #if solaris
		/*assign_stmt*/struct stat statbuf = (struct stat){
			.st_size = 0,
			.st_mode = 0,
			.st_mtime = 0,
		};
...
void os__rmdir_all(string path) { 
	/*assign_stmt*/Option_array_string items = os__ls(path);
	if (!items.ok) {
	...
	// FOR IN
	for (int tmp1 = 0; tmp1 < /*opt*/(*(array_string*)items.data).len; tmp1++) {
		string item = ((string*)/*opt*/(*(array_string*)items.data).data)[tmp1];
...
void os__print_c_errno() { 
	/*assign_stmt*/int e = errno;
	/*assign_stmt*/string se = tos_clone(((byteptr)(strerror(errno))));
	println(_STR("errno=%d err=%.*s", e, se.len, se.str));
}

string os__file_ext(string path) { 
	/*assign_stmt*/Option_int pos = string_last_index(path, tos3("."));
	if (!pos.ok) {
	string err = pos.v_error;
	int errcode = pos.ecode;
		return tos3("");
...
string os__dir(string path) { 
	/*assign_stmt*/Option_int pos = string_last_index(path, _const_os__path_separator);
	if (!pos.ok) {
	string err = pos.v_error;
	int errcode = pos.ecode;
		return tos3(".");
...
string os__base_dir(string path) { 
	/*assign_stmt*/Option_int posx = string_last_index(path, _const_os__path_separator);
	if (!posx.ok) {
...
string os__get_line() { 
	/*assign_stmt*/string str = os__get_raw_line();
...
string os__get_raw_line() { 
...
#ifdef _WIN32
	// #if windows
			/*assign_stmt*/int max_line_chars = 256;
			/*assign_stmt*/byteptr buf = v_malloc(max_line_chars * 2);
			/*assign_stmt*/voidptr h_input = GetStdHandle(_const_os__STD_INPUT_HANDLE);
			/*assign_stmt*/int bytes_read = 0;
			if (is_atty(0) > 0) {
				ReadConsole(h_input, buf, max_line_chars * 2, &bytes_read, 0);
				return string_from_wide2(((u16*)(buf)), bytes_read);
			}
			/*assign_stmt*/int offset = 0;
			while (1) {
				/*assign_stmt*/byteptr pos = buf + offset;
				/*assign_stmt*/bool res = ReadFile(h_input, pos, 1, &bytes_read, 0);
				if (!res || bytes_read == 0) {
					break;
				}
				if (*pos == '\n' || *pos == '\r') {
	...
	#else
		/*assign_stmt*/size_t max = ((size_t)(0));
		/*assign_stmt*/charptr buf = ((charptr)(0));
		/*assign_stmt*/int nr_chars = getline(&buf, &max, stdin);
...
array_string os__get_lines() { 
	/*assign_stmt*/string line = tos3("");
	/*assign_stmt*/array_string inputstr = new_array(0, 0, sizeof(string));
	while (1) {
		line = os__get_line();
		if (line.len <= 0) {
			break;
...
string os__get_lines_joined() { 
	/*assign_stmt*/string line = tos3("");
	/*assign_stmt*/string inputstr = tos3("");
	while (1) {
		line = os__get_line();
		if (line.len <= 0) {
			break;
...
void os__write_file(string path, string text) { 
	/*assign_stmt*/Option_os__File f = os__create(path);
	if (!f.ok) {
...
string os__executable() { 
...
#ifdef __linux__
	// #if linux
		/*assign_stmt*/byteptr result = vcalloc(_const_os__MAX_PATH);
		/*assign_stmt*/int count = readlink("/proc/self/exe", result, _const_os__MAX_PATH);
		if (count < 0) {
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/int max = 512;
		/*assign_stmt*/u16* result = ((u16*)(vcalloc(max * 2)));
		/*assign_stmt*/int len = GetModuleFileName(0, result, max);
	...
	// #if macos
		/*assign_stmt*/byteptr result = vcalloc(_const_os__MAX_PATH);
		/*assign_stmt*/int pid = getpid();
		/*assign_stmt*/int ret = proc_pidpath(pid, result, _const_os__MAX_PATH);
		if (ret <= 0) {
	...
	// #if freebsd
		/*assign_stmt*/byteptr result = vcalloc(_const_os__MAX_PATH);
		/*assign_stmt*/array_int mib = new_array_from_c_array(4, 4, sizeof(int), (int[4]){	
		1, 14, 12, -1, 
});
		/*assign_stmt*/int size = _const_os__MAX_PATH;
	...
	// #if netbsd
		/*assign_stmt*/byteptr result = vcalloc(_const_os__MAX_PATH);
		/*assign_stmt*/int count = readlink("/proc/curproc/exe", result, _const_os__MAX_PATH);
		if (count < 0) {
	...
	// #if dragonfly
		/*assign_stmt*/byteptr result = vcalloc(_const_os__MAX_PATH);
		/*assign_stmt*/int count = readlink("/proc/curproc/file", result, _const_os__MAX_PATH);
		if (count < 0) {
...
string os__executable_fallback() { 
	/*assign_stmt*/string exepath = (*(string*)array_get(_const_os__args, 0));
	if (!os__is_abs_path(exepath)) {
		if (string_contains(exepath, _const_os__path_separator)) {
			...
			/*assign_stmt*/Option_string foundpath = os__find_abs_path_of_executable(exepath);
			if (!foundpath.ok) {
...
Option_string os__find_abs_path_of_executable(string exepath) { 
	...
	/*assign_stmt*/string res = tos3("");
	/*assign_stmt*/string env_path_delimiter = (string_eq(os__user_os(), tos3("windows")) ? tos3(";") : tos3(":"));
	/*assign_stmt*/array_string paths = string_split(os__getenv(tos3("PATH")), env_path_delimiter);
	// FOR IN
	for (int tmp3 = 0; tmp3 < paths.len; tmp3++) {
		string p = ((string*)paths.data)[tmp3];
		/*assign_stmt*/string found_abs_path = os__join_path(p, (varg_string){.len=1,.args={exepath}});
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/string _path = string_replace(path, tos3("/"), tos3("\\"));
		/*assign_stmt*/u32 attr = GetFileAttributesW(string_to_wide(_path));
		...
		/*assign_stmt*/int val = (((int)(statbuf.st_mode)) & _const_os__S_IFMT);
...
string os__getwd() { 
	...
	// #if windows
		/*assign_stmt*/int max = 512;
		/*assign_stmt*/u16* buf = ((u16*)(vcalloc(max * 2)));
		if (_wgetcwd(buf, max) == 0) {
			return tos3("");
		}
		return string_from_wide(buf);
	#else
		/*assign_stmt*/byteptr buf = vcalloc(512);
		if (getcwd(buf, 512) == 0) {
			return tos3("");
		}
		return tos2(buf);
...
string os__real_path(string fpath) { 
	/*assign_stmt*/byteptr fullpath = vcalloc(_const_os__MAX_PATH);
	/*assign_stmt*/charptr ret = ((charptr)(0));
...
string os__join_path(string base, varg_string dirs) { 
	/*assign_stmt*/array_string result = new_array(0, 0, sizeof(string));
...
array_string os__walk_ext(string path, string ext) { 
	...
	/*assign_stmt*/Option_array_string files = os__ls(path);
	if (!files.ok) {
	string err = files.v_error;
	int errcode = files.ecode;
		return new_array(0, 0, sizeof(string));
	...
	/*assign_stmt*/array_string res = new_array(0, 0, sizeof(string));
	/*assign_stmt*/string separator = (string_ends_with(path, _const_os__path_separator) ? tos3("") : _const_os__path_separator);
	// FOR IN
	for (int i = 0; i < /*opt*/(*(array_string*)files.data).len; i++) {
		string file = ((string*)/*opt*/(*(array_string*)files.data).data)[i];
		if (string_starts_with(file, tos3("."))) {
			continue;
		}
		/*assign_stmt*/string p = string_add(string_add(path, separator), file);
...
void os__walk(string path, void (*f)(string path)) { 
	...
	// FOR IN
	for (int tmp2 = 0; tmp2 < /*opt*/(*(array_string*)files.data).len; tmp2++) {
		string file = ((string*)/*opt*/(*(array_string*)files.data).data)[tmp2];
		/*assign_stmt*/string p = string_add(string_add(path, _const_os__path_separator), file);
		if (os__is_dir(p) && !os__is_link(p)) {
			os__walk(p, f);
...
int os__file_last_mod_unix(string path) { 
	/*assign_stmt*/struct stat attr = (struct stat){
		.st_size = 0,
		.st_mode = 0,
		.st_mtime = 0,
	};
...
void os__mkdir_all(string path) { 
	/*assign_stmt*/string p = (string_starts_with(path, _const_os__path_separator) ? _const_os__path_separator : tos3(""));
	// FOR IN
	for (int tmp2 = 0; tmp2 < string_split(path, _const_os__path_separator).len; tmp2++) {
		string subdir = ((string*)string_split(path, _const_os__path_separator).data)[tmp2];
...
#ifndef _WIN32
	// #if not windows
		/*assign_stmt*/string xdg_cache_home = os__getenv(tos3("XDG_CACHE_HOME"));
		if (string_ne(xdg_cache_home, tos3(""))) {
			return xdg_cache_home;
		}
	#endif
	/*assign_stmt*/string cdir = string_add(os__home_dir(), tos3(".cache"));
...
string os__temp_dir() { 
	/*assign_stmt*/string path = os__getenv(tos3("TMPDIR"));
...
string os__resource_abs_path(string path) { 
	/*assign_stmt*/string base_path = os__real_path(os__dir(os__executable()));
	/*assign_stmt*/string vresource = os__getenv(tos3("V_RESOURCE_PATH"));
	if (vresource.len != 0) {
		base_path = vresource;
	}
...
Option_array_string os__ls(string path) { 
	/*assign_stmt*/array_string res = new_array(0, 0, sizeof(string));
	/*assign_stmt*/voidptr dir = opendir(path.str);
	if (isnil(dir)) {
		return v_error(_STR("ls() couldnt open dir \"%.*s\"", path.len, path.str));
	}
	/*assign_stmt*/struct dirent* ent = ((struct dirent*)(0));
	while (1) {
		ent = readdir(dir);
		if (isnil(ent)) {
			break;
		}
		/*assign_stmt*/string name = tos_clone(((byteptr)(ent->d_name)));
...
Option_bool os__mkdir(string path) { 
	...
	/*assign_stmt*/string apath = os__real_path(path);
	/*assign_stmt*/int r = mkdir(apath.str, 511);
	if (r == -1) {
		return v_error(os__posix_get_error_msg(errno));
	}
	return opt_ok(& (bool []) { true }, sizeof(bool));
...
Option_os__Result os__exec(string cmd) { 
	/*assign_stmt*/string pcmd = _STR("%.*s 2>&1", cmd.len, cmd.str);
	/*assign_stmt*/voidptr f = os__vpopen(pcmd);
	if (isnil(f)) {
		return v_error(_STR("exec(\"%.*s\") failed", cmd.len, cmd.str));
	}
	/*assign_stmt*/array_fixed_byte_4096 buf= {0};
	/*assign_stmt*/strings__Builder res = strings__new_builder(1024);
	while (fgets(((charptr)(buf)), 4096, f) != 0) {
		strings__Builder_write_bytes(&res, &/*qq*/buf, vstrlen(&/*qq*/buf));
	}
	/*assign_stmt*/string soutput = string_trim_space(strings__Builder_str(&res));
	/*assign_stmt*/int exit_code = os__vpclose(f);
...
Option_bool os__symlink(string origin, string target) { 
	/*assign_stmt*/int res = symlink(origin.str, target.str);
	if (res == 0) {
		return opt_ok(& (bool []) { true }, sizeof(bool));
	}
	return v_error(os__posix_get_error_msg(errno));
...
void v__pref__Preferences_fill_with_defaults(v__pref__Preferences* p) { 
	...
	/*assign_stmt*/string vlib_path = os__join_path(p->vroot, (varg_string){.len=1,.args={tos3("vlib")}});
	...
	// FOR IN
	for (int i = 0; i < p->lookup_path.len; i++) {
		string path = ((string*)p->lookup_path.data)[i];
	...
	/*assign_stmt*/string rpath = os__real_path(p->path);
	if (string_eq(p->out_name, tos3(""))) {
		/*assign_stmt*/string filename = string_trim_space(os__file_name(rpath));
		/*assign_stmt*/string base = string_all_before_last(filename, tos3("."));
		if (string_eq(base, tos3(""))) {
			base = filename;
		}
		/*assign_stmt*/string target_dir = (os__is_dir(rpath) ? rpath : os__dir(rpath));
	...
	/*assign_stmt*/string rpath_name = os__file_name(rpath);
...
string v__pref__vexe_path() { 
	/*assign_stmt*/string vexe = os__getenv(tos3("VEXE"));
	if (string_ne(vexe, tos3(""))) {
		return vexe;
	}
	/*assign_stmt*/string real_vexe_path = os__real_path(os__executable());
...
void internal__compile__V_cc(internal__compile__V* v) { 
	...
	/*assign_stmt*/string vexe = v__pref__vexe_path();
	/*assign_stmt*/string vdir = os__dir(vexe);
	/*assign_stmt*/bool ends_with_c = string_ends_with(v->pref->out_name, tos3(".c"));
	/*assign_stmt*/bool ends_with_js = string_ends_with(v->pref->out_name, tos3(".js"));
	if (v->pref->is_pretty_c && !ends_with_js) {
		/*assign_stmt*/Option_os__Result format_result = os__exec(_STR("clang-format -i -style=file \"%.*s\"", v->out_name_c.len, v->out_name_c.str));
		if (!format_result.ok) {
	...
	if (ends_with_c || ends_with_js) {
		...
		// #if not js
			if (ends_with_js) {
				/*assign_stmt*/string vjs_path = string_add(vexe, tos3("js"));
				if (!os__exists(vjs_path)) {
					println(tos3("V.js compiler not found, building..."));
					/*assign_stmt*/int ret = os__system(_STR("%.*s -o %.*s -os js %.*s/cmd/v", vexe.len, vexe.str, vjs_path.len, vjs_path.str, vdir.len, vdir.str));
					if (ret == 0) {
						println(tos3("Done."));
					} else {
						println(tos3("Failed."));
				...
				/*assign_stmt*/int ret = os__system(_STR("%.*s -o %.*s %.*s", vjs_path.len, vjs_path.str, v->pref->out_name.len, v->pref->out_name.str, v->pref->path.len, v->pref->path.str));
				if (ret == 0) {
	...
	#endif
	/*assign_stmt*/array_string a = new_array_from_c_array(10, 10, sizeof(string), (string[10]){	
...
#ifndef __ANDROID__
			// #if not android
				/*assign_stmt*/string tcc_3rd = _STR("%.*s/thirdparty/tcc/bin/tcc", vdir.len, vdir.str);
				/*assign_stmt*/string tcc_path = tos3("/var/tmp/tcc/bin/tcc");
	...
	if (v->pref->build_mode == v__pref__BuildMode_build_module) {
		/*assign_stmt*/string out_dir = (string_starts_with(v->pref->path, tos3("vlib")) ? _STR("%.*s%.*scache%.*s%.*s", _const_internal__compile__v_modules_path.len, _const_internal__compile__v_modules_path.str, _const_os__path_separator.len, _const_os__path_separator.str, _const_os__path_separator.len, _const_os__path_separator.str, v->pref->path.len, v->pref->path.str) : _STR("%.*s%.*s%.*s", _const_internal__compile__v_modules_path.len, _const_internal__compile__v_modules_path.str, _const_os__path_separator.len, _const_os__path_separator.str, v->pref->path.len, v->pref->path.str));
		/*assign_stmt*/string pdir = string_all_before_last(out_dir, _const_os__path_separator);
		if (!os__is_dir(pdir)) {
			os__mkdir_all(pdir);
		}
	...
	/*assign_stmt*/bool debug_mode = v->pref->is_debug;
	/*assign_stmt*/string debug_options = tos3("-g");
	/*assign_stmt*/string optimization_options = tos3("-O2");
	/*assign_stmt*/string guessed_compiler = v->pref->ccompiler;
	...
	if (string_contains(v->pref->ccompiler, tos3("clang")) || string_eq(guessed_compiler, tos3("clang"))) {
		...
		/*assign_stmt*/bool have_flto = true;
	...
	// FOR IN
	for (int tmp43 = 0; tmp43 < internal__compile__V_generate_hotcode_reloading_compiler_flags(v).len; tmp43++) {
		string f = ((string*)internal__compile__V_generate_hotcode_reloading_compiler_flags(v).data)[tmp43];
		_PUSH(&a, (f), tmp44, string);
	}
	/*assign_stmt*/string libs = tos3("");
	if (v->pref->build_mode == v__pref__BuildMode_build_module) {
	...
	/*assign_stmt*/array_internal__compile__CFlag cflags = internal__compile__V_get_os_cflags(v);
	...
	/*assign_stmt*/string args = array_string_join(a, tos3(" "));
	start:
	internal__compile__todo();
	/*assign_stmt*/string cmd = _STR("%.*s %.*s", v->pref->ccompiler.len, v->pref->ccompiler.str, args.len, args.str);
	if (v__pref__VerboseLevel_is_higher_or_equal(v->pref->verbosity, v__pref__VerboseLevel_level_one)) {
		println(tos3("\n=========="));
		println(cmd);
	}
	/*assign_stmt*/i64 ticks = time__ticks();
	/*assign_stmt*/Option_os__Result res = os__exec(cmd);
	if (!res.ok) {
	...
	if (/*opt*/(*(os__Result*)res.data).exit_code != 0) {
		...
		if (v->pref->is_debug) {
			/*assign_stmt*/string eword = tos3("error:");
			/*assign_stmt*/string khighlight = (term__can_show_color_on_stdout() ? term__red(eword) : eword);
			println(string_replace(/*opt*/(*(os__Result*)res.data).output, eword, khighlight));
			internal__compile__verror(_STR("\n==================\nC error. This should never happen.\n\nV compiler version: V %.*s %.*s\nHost OS: %.*s\nTarget OS: %.*s\n\nIf you were not working with C interop and are not sure about what's happening,\nplease put the whole output in a pastebin and contact us through the following ways with a link to the pastebin:\n- Raise an issue on GitHub: https://github.com/vlang/v/issues/new/choose\n- Ask a question in #help on Discord: https://discord.gg/vlang", _const_internal__compile__v_version.len, _const_internal__compile__v_version.str, internal__compile__vhash().len, internal__compile__vhash().str, v__pref__OS_str(v__pref__get_host_os()).len, v__pref__OS_str(v__pref__get_host_os()).str, v__pref__OS_str(v->pref->os).len, v__pref__OS_str(v->pref->os).str));
		} else {
			if (/*opt*/(*(os__Result*)res.data).output.len < 30) {
				println(/*opt*/(*(os__Result*)res.data).output);
			} else {
				/*assign_stmt*/array_string elines = internal__compile__error_context_lines(/*opt*/(*(os__Result*)res.data).output, tos3("error:"), 1, 12);
				println(tos3("=================="));
				// FOR IN
				for (int tmp78 = 0; tmp78 < elines.len; tmp78++) {
					string eline = ((string*)elines.data)[tmp78];
					println(eline);
				}
				println(tos3("..."));
				println(tos3("=================="));
	...
	/*assign_stmt*/i64 diff = time__ticks() - ticks;
	if (v__pref__VerboseLevel_is_higher_or_equal(v->pref->verbosity, v__pref__VerboseLevel_level_one)) {
	...
	if (v->pref->compress) {
		...
		// #if windows
			...
			return;
		#endif
		/*assign_stmt*/int ret = os__system(_STR("strip %.*s", v->pref->out_name.len, v->pref->out_name.str));
		if (ret != 0) {
			println(tos3("strip failed"));
			return;
		}
		/*assign_stmt*/int ret2 = os__system(_STR("upx --lzma -qqq %.*s", v->pref->out_name.len, v->pref->out_name.str));
		if (ret2 != 0) {
...
void internal__compile__V_build_thirdparty_obj_files(internal__compile__V* c) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < internal__compile__V_get_os_cflags(c).len; tmp1++) {
		internal__compile__CFlag flag = ((internal__compile__CFlag*)internal__compile__V_get_os_cflags(c).data)[tmp1];
		if (string_ends_with(flag.value, tos3(".o"))) {
			/*assign_stmt*/array_internal__compile__CFlag rest_of_module_flags = internal__compile__V_get_rest_of_module_cflags(c, &/*qq*/flag);
...
void internal__compile__V_build_thirdparty_obj_file(internal__compile__V* v, string path, array_internal__compile__CFlag moduleflags) { 
	/*assign_stmt*/string obj_path = os__real_path(path);
	if (os__exists(obj_path)) {
		return;
	}
	println(_STR("%.*s not found, building it...", obj_path.len, obj_path.str));
	/*assign_stmt*/string parent = os__dir(obj_path);
	/*assign_stmt*/Option_array_string files = os__ls(parent);
	if (!files.ok) {
	string err = files.v_error;
	int errcode = files.ecode;
		v_panic(err);
	};
	/*assign_stmt*/string cfiles = tos3("");
	// FOR IN
	for (int tmp2 = 0; tmp2 < /*opt*/(*(array_string*)files.data).len; tmp2++) {
		string file = ((string*)/*opt*/(*(array_string*)files.data).data)[tmp2];
	...
	/*assign_stmt*/string btarget = array_internal__compile__CFlag_c_options_before_target(moduleflags);
	/*assign_stmt*/string atarget = array_internal__compile__CFlag_c_options_after_target(moduleflags);
	/*assign_stmt*/string cmd = _STR("%.*s %.*s %.*s -c -o \"%.*s\" %.*s %.*s ", v->pref->ccompiler.len, v->pref->ccompiler.str, v->pref->third_party_option.len, v->pref->third_party_option.str, btarget.len, btarget.str, obj_path.len, obj_path.str, cfiles.len, cfiles.str, atarget.len, atarget.str);
	/*assign_stmt*/Option_os__Result res = os__exec(cmd);
	if (!res.ok) {
	string err = res.v_error;
	int errcode = res.ecode;
...
array_string internal__compile__error_context_lines(string text, string keyword, int before, int after) { 
	/*assign_stmt*/string khighlight = (term__can_show_color_on_stdout() ? term__red(keyword) : keyword);
	/*assign_stmt*/int eline_idx = 0;
	/*assign_stmt*/array_string lines = string_split_into_lines(text);
	// FOR IN
	...
	/*assign_stmt*/int idx_s = (eline_idx - before >= 0 ? eline_idx - before : 0);
	/*assign_stmt*/int idx_e = (idx_s + after < lines.len ? idx_s + after : lines.len);
...
array_internal__compile__CFlag internal__compile__V_get_os_cflags(internal__compile__V* v) { 
	/*assign_stmt*/array_internal__compile__CFlag flags = new_array(0, 0, sizeof(internal__compile__CFlag));
	/*assign_stmt*/array_string ctimedefines = new_array(0, 0, sizeof(string));
...
array_internal__compile__CFlag internal__compile__V_get_rest_of_module_cflags(internal__compile__V* v, internal__compile__CFlag* c) { 
	...
	/*assign_stmt*/array_internal__compile__CFlag cflags = internal__compile__V_get_os_cflags(v);
	// FOR IN
	for (int tmp1 = 0; tmp1 < cflags.len; tmp1++) {
		internal__compile__CFlag flag = ((internal__compile__CFlag*)cflags.data)[tmp1];
...
string internal__compile__CFlag_format(internal__compile__CFlag* cf) { 
	/*assign_stmt*/string value = cf->value;
...
internal__compile__V* internal__compile__new_v(v__pref__Preferences* pref) { 
	/*assign_stmt*/string rdir = os__real_path(pref->path);
	/*assign_stmt*/string out_name_c = internal__compile__get_vtmp_filename(pref->out_name, tos3(".tmp.c"));
	if (pref->is_so) {
		out_name_c = internal__compile__get_vtmp_filename(pref->out_name, tos3(".tmp.so.c"));
	}
	/*assign_stmt*/strings__Builder vgen_buf = strings__new_builder(1000);
	strings__Builder_writeln(&vgen_buf, tos3("module vgen\nimport strings"));
	/*assign_stmt*/string compiled_dir = (os__is_dir(rdir) ? rdir : os__dir(rdir));
...
v__builder__Builder internal__compile__V_new_v2(internal__compile__V* v) { 
	/*assign_stmt*/v__builder__Builder b = v__builder__new_builder(v->pref);
	b = // assoc
	(v__builder__Builder){
		.os = v->pref->os, 
...
string internal__compile__get_vtmp_folder() { 
	/*assign_stmt*/string vtmp = os__join_path(os__temp_dir(), (varg_string){.len=1,.args={tos3("v")}});
	if (!os__is_dir(vtmp)) {
...
string internal__compile__get_vtmp_filename(string base_file_name, string postfix) { 
	/*assign_stmt*/string vtmp = internal__compile__get_vtmp_folder();
...
void internal__compile__V_compile_x64(internal__compile__V* v) { 
	...
	/*assign_stmt*/v__builder__Builder b = internal__compile__V_new_v2(v);
...
void internal__compile__compile(string command, array_string args) { 
	...
	multi_return_v__pref__Preferences_array_string mr_4444 = internal__compile__parse_arguments(args);
	v__pref__Preferences prefs = mr_4444.arg0;
	array_string remaining = mr_4444.arg1;
	internal__compile__check_for_common_mistake(args, &/*qq*/prefs);
	/*assign_stmt*/internal__compile__V* v = internal__compile__new_v(&/*qq*/prefs);
	...
	/*assign_stmt*/benchmark__Benchmark tmark = benchmark__new_benchmark();
...
void internal__compile__run_compiled_executable_and_exit(internal__compile__V* v, array_string remaining_args) { 
	...
	/*assign_stmt*/string cmd = _STR("\"%.*s\"", v->pref->out_name.len, v->pref->out_name.str);
	...
	if (v->pref->is_test) {
		/*assign_stmt*/int ret = os__system(cmd);
		if (ret != 0) {
			v_exit(1);
		}
	}
...
void internal__compile__V_set_module_lookup_paths(internal__compile__V* v) { 
	...
	/*assign_stmt*/string x = os__join_path(v->compiled_dir, (varg_string){.len=1,.args={tos3("modules")}});
	if (v__pref__VerboseLevel_is_higher_or_equal(v->pref->verbosity, v__pref__VerboseLevel_level_two)) {
...
array_string internal__compile__V_get_builtin_files(internal__compile__V* v) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < v->pref->lookup_path.len; tmp1++) {
		string location = ((string*)v->pref->lookup_path.data)[tmp1];
...
array_string internal__compile__V_get_user_files(internal__compile__V* v) { 
	/*assign_stmt*/string dir = v->pref->path;
	internal__compile__V_log(v, _STR("get_v_files(%.*s)", dir.len, dir.str));
	/*assign_stmt*/array_string user_files = new_array(0, 0, sizeof(string));
	/*assign_stmt*/string vroot = os__dir(v__pref__vexe_path());
	/*assign_stmt*/string preludes_path = os__join_path(vroot, (varg_string){.len=3,.args={tos3("cmd"), tos3("tools"), tos3("preludes")}});
	if (v->pref->is_live) {
	...
	/*assign_stmt*/bool is_test = string_ends_with(dir, tos3("_test.v"));
	/*assign_stmt*/bool is_internal_module_test = false;
	if (is_test) {
		/*assign_stmt*/Option_string tcontent = os__read_file(dir);
		if (!tcontent.ok) {
		string err = tcontent.v_error;
		int errcode = tcontent.ecode;
			v_panic(_STR("%.*s does not exist", dir.len, dir.str));
		};
		/*assign_stmt*/array_string slines = string_split_into_lines(string_trim_space(/*opt*/(*(string*)tcontent.data)));
		// FOR IN
		for (int tmp10 = 0; tmp10 < slines.len; tmp10++) {
			string sline = ((string*)slines.data)[tmp10];
			/*assign_stmt*/string line = string_trim_space(sline);
			if (line.len > 2) {
	...
	if (is_internal_module_test) {
		/*assign_stmt*/string single_test_v_file = os__real_path(dir);
		if (v__pref__VerboseLevel_is_higher_or_equal(v->pref->verbosity, v__pref__VerboseLevel_level_two)) {
	...
	/*assign_stmt*/bool is_real_file = os__exists(dir) && !os__is_dir(dir);
	if (is_real_file && (string_ends_with(dir, tos3(".v")) || string_ends_with(dir, tos3(".vsh")))) {
		/*assign_stmt*/string single_v_file = dir;
		...
		/*assign_stmt*/array_string files = internal__compile__V_v_files_from_dir(v, dir);
		// FOR IN
		for (int tmp21 = 0; tmp21 < files.len; tmp21++) {
			string file = ((string*)files.data)[tmp21];
			_PUSH(&user_files, (file), tmp22, string);
		}
	}
	if (user_files.len == 0) {
...
array_string internal__compile__V_v_files_from_dir(internal__compile__V* v, string dir) { 
	...
	/*assign_stmt*/Option_array_string files = os__ls(dir);
	if (!files.ok) {
	string err = files.v_error;
	int errcode = files.ecode;
		v_panic(err);
	...
	// FOR IN
	for (int tmp4 = 0; tmp4 < /*opt*/(*(array_string*)files.data).len; tmp4++) {
		string file = ((string*)/*opt*/(*(array_string*)files.data).data)[tmp4];
		...
		if (v->pref->compile_defines_all.len > 0 && string_contains(file, tos3("_d_"))) {
			/*assign_stmt*/bool allowed = false;
			// FOR IN
			for (int tmp17 = 0; tmp17 < v->pref->compile_defines.len; tmp17++) {
				string cdefine = ((string*)v->pref->compile_defines.data)[tmp17];
				/*assign_stmt*/string file_postfix = _STR("_d_%.*s.v", cdefine.len, cdefine.str);
...
void internal__compile__parse_c_options(string flag, internal__flag__Instance* f, v__pref__Preferences* prefs) { 
	if (string_eq(flag, tos3("cc")) || string_eq(flag, tos3("compiler"))) {
		...
		/*assign_stmt*/Option_string tmp = internal__flag__Instance_string(f);
		if (!tmp.ok) {
		string err = tmp.v_error;
		int errcode = tmp.ecode;
		...
		/*assign_stmt*/Option_string operation = internal__flag__Instance_string(f);
		if (!operation.ok) {
		...
		/*assign_stmt*/Option_string cflag = internal__flag__Instance_string(f);
		if (!cflag.ok) {
...
multi_return_v__pref__Preferences_array_string internal__compile__parse_arguments(array_string args) { 
	/*assign_stmt*/v__pref__Preferences p = (v__pref__Preferences){
		.enable_globals = true,
		.os = {0},
		.backend = {0},
		.build_mode = {0},
	...
	/*assign_stmt*/array_string backend = os__cmdline__options(args, tos3("-b"));
	...
	if (backend.len == 1) {
		/*assign_stmt*/Option_v__pref__Backend x = v__pref__backend_from_string((*(string*)array_get(backend, 0)));
		if (!x.ok) {
	...
	/*assign_stmt*/Option_array_string remaining2 = internal__flag__parse_pref(args, internal__compile__parse_options, &/*qq*/p);
	if (!remaining2.ok) {
	...
	/*assign_stmt*/array_string remaining = /*opt*/(*(array_string*)remaining2.data);
...
void internal__compile__parse_options(string flag, internal__flag__Instance* f, v__pref__Preferences* prefs) { 
	if (string_eq(flag, tos3("path"))) {
		/*assign_stmt*/Option_string path_str = internal__flag__Instance_string(f);
		if (!path_str.ok) {
		...
		/*assign_stmt*/Option_string define = internal__flag__Instance_string(f);
		if (!define.ok) {
		...
		/*assign_stmt*/Option_string to_enable = internal__flag__Instance_string(f);
		if (!to_enable.ok) {
...
//[inline]
void internal__compile__parse_define(v__pref__Preferences* prefs, string define) { 
	/*assign_stmt*/array_string define_parts = string_split(define, tos3("="));
...
void internal__compile__parse_executable_options(string flag, internal__flag__Instance* f, v__pref__Preferences* prefs) { 
	if (string_eq(flag, tos3("os")) || string_eq(flag, tos3("target-os"))) {
		...
		/*assign_stmt*/Option_string target_os = internal__flag__Instance_string(f);
		if (!target_os.ok) {
		...
		/*assign_stmt*/Option_v__pref__OS tmp = v__pref__os_from_string(/*opt*/(*(string*)target_os.data));
		if (!tmp.ok) {
		string err = tmp.v_error;
		int errcode = tmp.ecode;
		...
		/*assign_stmt*/Option_string target_arch = internal__flag__Instance_string(f);
		if (!target_arch.ok) {
...
array_string internal__compile__V_generate_hotcode_reloading_compiler_flags(internal__compile__V* v) { 
	/*assign_stmt*/array_string a = new_array(0, 0, sizeof(string));
...
Option_string internal__compile__find_windows_kit_internal(internal__compile__RegKey key, array_string versions) { 
	...
	// #if windows
			// FOR IN
			for (int tmp1 = 0; tmp1 < versions.len; tmp1++) {
				string version = ((string*)versions.data)[tmp1];
				/*assign_stmt*/int required_bytes = 0;
				/*assign_stmt*/voidptr result = RegQueryValueEx(key, string_to_wide(version), 0, 0, 0, &required_bytes);
				/*assign_stmt*/int length = required_bytes / 2;
				if (result != 0) {
					continue;
				}
				/*assign_stmt*/int alloc_length = (required_bytes + 2);
				/*assign_stmt*/u16* value = ((u16*)(v_malloc(alloc_length)));
				if (isnil(value)) {
					continue;
				}
				/*assign_stmt*/voidptr result2 = RegQueryValueEx(key, string_to_wide(version), 0, 0, value, &alloc_length);
				if (result2 != 0) {
					continue;
				}
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/internal__compile__RegKey root_key = ((internal__compile__RegKey)(0));
		/*assign_stmt*/voidptr rc = RegOpenKeyEx(_const_internal__compile__HKEY_LOCAL_MACHINE, string_to_wide("SOFTWARE\\Microsoft\\Windows Kits\\Installed Roots"), 0, _const_internal__compile__KEY_QUERY_VALUE | _const_internal__compile__KEY_WOW64_32KEY | _const_internal__compile__KEY_ENUMERATE_SUB_KEYS, &root_key);
		if (rc != 0) {
			// defer
			#ifdef _WIN32
		...
		/*assign_stmt*/Option_string kit_root = internal__compile__find_windows_kit_internal(root_key, new_array_from_c_array(2, 2, sizeof(string), (string[2]){	
		...
		/*assign_stmt*/string kit_lib = string_add(/*opt*/(*(string*)kit_root.data), tos3("Lib"));
		/*assign_stmt*/Option_array_string files = os__ls(kit_lib);
		if (!files.ok) {
		string err = files.v_error;
		int errcode = files.ecode;
			v_panic(err);
		};
		/*assign_stmt*/string highest_path = tos3("");
		/*assign_stmt*/int highest_int = 0;
		// FOR IN
		for (int tmp2 = 0; tmp2 < /*opt*/(*(array_string*)files.data).len; tmp2++) {
			string f = ((string*)/*opt*/(*(array_string*)files.data).data)[tmp2];
			/*assign_stmt*/string no_dot = string_replace(f, tos3("."), tos3(""));
			/*assign_stmt*/int v_int = string_int(no_dot);
			if (v_int > highest_int) {
				highest_int = v_int;
				highest_path = f;
			}
		}
		/*assign_stmt*/string kit_lib_highest = string_add(kit_lib, _STR("\\%.*s", highest_path.len, highest_path.str));
		/*assign_stmt*/string kit_include_highest = string_replace(kit_lib_highest, tos3("Lib"), tos3("Include"));
		// defer
		#ifdef _WIN32
			RegCloseKey(root_key);
		#endif
...
Option_internal__compile__VsInstallation internal__compile__find_vs(string vswhere_dir, string host_arch) { 
	...
	#endif
	/*assign_stmt*/Option_os__Result res = os__exec(_STR("\"%.*s\\Microsoft Visual Studio\\Installer\\vswhere.exe\" -latest -prerelease -products * -requires Microsoft.VisualStudio.Component.VC.Tools.x86.x64 -property installationPath", vswhere_dir.len, vswhere_dir.str));
	if (!res.ok) {
	string err = res.v_error;
	int errcode = res.ecode;
		return v_error(err);
	};
	/*assign_stmt*/Option_string version = os__read_file(_STR("%.*s\\VC\\Auxiliary\\Build\\Microsoft.VCToolsVersion.default.txt", /*opt*/(*(os__Result*)res.data).output.len, /*opt*/(*(os__Result*)res.data).output.str));
	if (!version.ok) {
	...
	/*assign_stmt*/string version2 = /*opt*/(*(string*)version.data);
	/*assign_stmt*/string v = (string_ends_with(/*opt*/(*(string*)version.data), tos3("\n")) ? string_substr(version2, 0, /*opt*/(*(string*)version.data).len - 2) : version2);
	/*assign_stmt*/string lib_path = _STR("%.*s\\VC\\Tools\\MSVC\\%.*s\\lib\\%.*s", /*opt*/(*(os__Result*)res.data).output.len, /*opt*/(*(os__Result*)res.data).output.str, v.len, v.str, host_arch.len, host_arch.str);
	/*assign_stmt*/string include_path = _STR("%.*s\\VC\\Tools\\MSVC\\%.*s\\include", /*opt*/(*(os__Result*)res.data).output.len, /*opt*/(*(os__Result*)res.data).output.str, v.len, v.str);
	if (os__exists(_STR("%.*s\\vcruntime.lib", lib_path.len, lib_path.str))) {
		/*assign_stmt*/string p = _STR("%.*s\\VC\\Tools\\MSVC\\%.*s\\bin\\Host%.*s\\%.*s", /*opt*/(*(os__Result*)res.data).output.len, /*opt*/(*(os__Result*)res.data).output.str, v.len, v.str, host_arch.len, host_arch.str, host_arch.len, host_arch.str);
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/string processor_architecture = os__getenv(tos3("PROCESSOR_ARCHITECTURE"));
		/*assign_stmt*/string vswhere_dir = (string_eq(processor_architecture, tos3("x86")) ? tos3("%ProgramFiles%") : tos3("%ProgramFiles(x86)%"));
		/*assign_stmt*/string host_arch = (string_eq(processor_architecture, tos3("x86")) ? tos3("X86") : tos3("X64"));
		/*assign_stmt*/Option_internal__compile__WindowsKit wk = internal__compile__find_windows_kit_root(host_arch);
		if (!wk.ok) {
		string err = wk.v_error;
		int errcode = wk.ecode;
			return v_error(tos3("Unable to find windows sdk"));
		};
		/*assign_stmt*/Option_internal__compile__VsInstallation vs = internal__compile__find_vs(vswhere_dir, host_arch);
		if (!vs.ok) {
...
void internal__compile__V_cc_msvc(internal__compile__V* v) { 
	/*assign_stmt*/Option_internal__compile__MsvcResult r = internal__compile__find_msvc();
	if (!r.ok) {
	...
	/*assign_stmt*/string out_name_obj = os__real_path(string_add(v->out_name_c, tos3(".obj")));
	/*assign_stmt*/array_string a = new_array_from_c_array(4, 4, sizeof(string), (string[4]){	
	...
	/*assign_stmt*/array_string real_libs = new_array_from_c_array(3, 3, sizeof(string), (string[3]){	
	tos3("kernel32.lib"), tos3("user32.lib"), tos3("advapi32.lib"), 
});
	/*assign_stmt*/internal__compile__MsvcStringFlags sflags = array_internal__compile__CFlag_msvc_string_flags(internal__compile__V_get_os_cflags(v));
	_PUSH_MANY(&real_libs, (sflags.real_libs), tmp16, array_string);
	/*assign_stmt*/array_string inc_paths = sflags.inc_paths;
	/*assign_stmt*/array_string lib_paths = sflags.lib_paths;
	/*assign_stmt*/array_string other_flags = sflags.other_flags;
	...
	/*assign_stmt*/string args = array_string_join(a, tos3(" "));
	/*assign_stmt*/string cmd = _STR("\"%.*s\" %.*s", /*opt*/(*(internal__compile__MsvcResult*)r.data).full_cl_exe_path.len, /*opt*/(*(internal__compile__MsvcResult*)r.data).full_cl_exe_path.str, args.len, args.str);
	if (v__pref__VerboseLevel_is_higher_or_equal(v->pref->verbosity, v__pref__VerboseLevel_level_one)) {
		println(tos3("\n========== cl cmd line:"));
		println(cmd);
		println(tos3("==========\n"));
...
void internal__compile__build_thirdparty_obj_file_with_msvc(string path, array_internal__compile__CFlag moduleflags) { 
	/*assign_stmt*/Option_internal__compile__MsvcResult msvc = internal__compile__find_msvc();
	if (!msvc.ok) {
	...
	/*assign_stmt*/string obj_path = _STR("%.*sbj", path.len, path.str);
	...
	/*assign_stmt*/string include_string = _STR("-I \"%.*s\" -I \"%.*s\" -I \"%.*s\" -I \"%.*s\"", /*opt*/(*(internal__compile__MsvcResult*)msvc.data).ucrt_include_path.len, /*opt*/(*(internal__compile__MsvcResult*)msvc.data).ucrt_include_path.str, /*opt*/(*(internal__compile__MsvcResult*)msvc.data).vs_include_path.len, /*opt*/(*(internal__compile__MsvcResult*)msvc.data).vs_include_path.str, /*opt*/(*(internal__compile__MsvcResult*)msvc.data).um_include_path.len, /*opt*/(*(internal__compile__MsvcResult*)msvc.data).um_include_path.str, /*opt*/(*(internal__compile__MsvcResult*)msvc.data).shared_include_path.len, /*opt*/(*(internal__compile__MsvcResult*)msvc.data).shared_include_path.str);
	/*assign_stmt*/string btarget = array_internal__compile__CFlag_c_options_before_target_msvc(moduleflags);
	/*assign_stmt*/string atarget = array_internal__compile__CFlag_c_options_after_target_msvc(moduleflags);
	/*assign_stmt*/string cmd = _STR("\"%.*s\" /volatile:ms /Zi /DNDEBUG %.*s /c %.*s %.*s %.*s /Fo\"%.*s\"", /*opt*/(*(internal__compile__MsvcResult*)msvc.data).full_cl_exe_path.len, /*opt*/(*(internal__compile__MsvcResult*)msvc.data).full_cl_exe_path.str, include_string.len, include_string.str, btarget.len, btarget.str, cfiles.len, cfiles.str, atarget.len, atarget.str, obj_path.len, obj_path.str);
...
internal__compile__MsvcStringFlags array_internal__compile__CFlag_msvc_string_flags(array_internal__compile__CFlag cflags) { 
	/*assign_stmt*/array_string real_libs = new_array(0, 0, sizeof(string));
	/*assign_stmt*/array_string inc_paths = new_array(0, 0, sizeof(string));
	/*assign_stmt*/array_string lib_paths = new_array(0, 0, sizeof(string));
	/*assign_stmt*/array_string other_flags = new_array(0, 0, sizeof(string));
	// FOR IN
	for (int tmp1 = 0; tmp1 < cflags.len; tmp1++) {
		internal__compile__CFlag flag = ((internal__compile__CFlag*)cflags.data)[tmp1];
		if (string_eq(flag.name, tos3("-l"))) {
			...
			/*assign_stmt*/string lib_lib = string_add(flag.value, tos3(".lib"));
	...
	/*assign_stmt*/array_string lpaths = new_array(0, 0, sizeof(string));
	// FOR IN
	for (int tmp10 = 0; tmp10 < lib_paths.len; tmp10++) {
		string l = ((string*)lib_paths.data)[tmp10];
		_PUSH(&lpaths, (string_add(string_add(tos3("/LIBPATH:\""), os__real_path(l)), tos3("\""))), tmp11, string);
	}
...
void internal__compile__parse_and_output_new_format(array_string args) { 
	/*assign_stmt*/array_internal__compile__Deprecated list = new_array(0, 0, sizeof(internal__compile__Deprecated));
	/*assign_stmt*/array_string obsolete = new_array(0, 0, sizeof(string));
	/*assign_stmt*/string os = os__cmdline__option(args, tos3("-os"), tos3(""));
	...
	if (list.len > 0) {
		...
		for (int tmp22 = 0; tmp22 < list.len; tmp22++) {
			internal__compile__Deprecated deprecation = ((internal__compile__Deprecated*)list.data)[tmp22];
	...
	if (obsolete.len > 0) {
		...
		// FOR IN
		for (int tmp25 = 0; tmp25 < obsolete.len; tmp25++) {
			string obsoleted = ((string*)obsolete.data)[tmp25];
			println(_STR("   `%.*s` has been removed", obsoleted.len, obsoleted.str));
		}
		println(tos3(""));
	}
...
array_internal__compile__Deprecated internal__compile__add_if_found_deprecated(array_string args, string deprecated, string alt) { 
	if (_IN(string, deprecated, args)) {
		/*assign_stmt*/internal__compile__Deprecated new = (string_ends_with(alt, tos3("*")) ? (internal__compile__Deprecated){
				.old = deprecated,
...
void internal__help__print_and_exit(string topic) { 
	...
	/*assign_stmt*/string target_topic = os__join_path(vroot, (varg_string){.len=5,.args={tos3("cmd"), tos3("v"), tos3("internal"), tos3("help"), _STR("%.*s.txt", topic.len, topic.str)}});
	/*assign_stmt*/Option_string content = os__read_file(target_topic);
	if (!content.ok) {
...
bool array_v__table__Type_contains(array_v__table__Type types, v__table__Type typ) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < types.len; tmp1++) {
		v__table__Type t = ((v__table__Type*)types.data)[tmp1];
		if (((int)(typ)) == ((int)(t))) {
			return true;
		}
	}
...
//[inline]
bool v__table__type_is_ptr(v__table__Type t) { 
	return v__table__type_nr_muls(t) > 0;
}
...
v__table__Type v__table__type_set_nr_muls(v__table__Type t, int nr_muls) { 
	...
	return (((int)(v__table__type_extra(t))) << 24) | (nr_muls << 16) | ((u16)(v__table__type_idx(t)));
}

//[inline]
v__table__Type v__table__type_to_ptr(v__table__Type t) { 
	/*assign_stmt*/int nr_muls = v__table__type_nr_muls(t);
	if (nr_muls == 255) {
		v_panic(tos3("type_to_pre: nr_muls is already at max of 255"));
	}
	return (((int)(v__table__type_extra(t))) << 24) | ((nr_muls + 1) << 16) | ((u16)(v__table__type_idx(t)));
}
...
//[inline]
v__table__Type v__table__type_clear_extra(v__table__Type t) { 
	return v__table__type_set_extra(t, v__table__TypeExtra_unset);
}
...
//[inline]
v__table__Type v__table__type_set_extra(v__table__Type t, v__table__TypeExtra extra) { 
	return (((int)(extra)) << 24) | (v__table__type_nr_muls(t) << 16) | ((u16)(v__table__type_idx(t)));
}

//[inline]
bool v__table__type_is_optional(v__table__Type t) { 
	return v__table__type_extra(t) == v__table__TypeExtra_optional;
}

//[inline]
v__table__Type v__table__type_to_optional(v__table__Type t) { 
	return v__table__type_set_extra(t, v__table__TypeExtra_optional);
}

//[inline]
bool v__table__type_is_variadic(v__table__Type t) { 
	return v__table__type_extra(t) == v__table__TypeExtra_variadic;
}

//[inline]
v__table__Type v__table__type_to_variadic(v__table__Type t) { 
	return v__table__type_set_extra(t, v__table__TypeExtra_variadic);
}
...
//[inline]
v__table__Enum v__table__TypeSymbol_enum_info(v__table__TypeSymbol* t) { 
	if (t->info.typ == 103 /* v.table.Enum */) {
...
//[inline]
v__table__MultiReturn v__table__TypeSymbol_mr_info(v__table__TypeSymbol* t) { 
	if (t->info.typ == 101 /* v.table.MultiReturn */) {
...
//[inline]
v__table__Array v__table__TypeSymbol_array_info(v__table__TypeSymbol* t) { 
	if (t->info.typ == 97 /* v.table.Array */) {
...
//[inline]
v__table__ArrayFixed v__table__TypeSymbol_array_fixed_info(v__table__TypeSymbol* t) { 
	if (t->info.typ == 98 /* v.table.ArrayFixed */) {
...
void v__table__Table_register_builtin_type_symbols(v__table__Table* t) { 
	...
	/*assign_stmt*/int map_string_string_idx = v__table__Table_find_or_register_map(t, _const_v__table__string_type, _const_v__table__string_type);
	/*assign_stmt*/int map_string_int_idx = v__table__Table_find_or_register_map(t, _const_v__table__string_type, _const_v__table__int_type);
	v__table__Table_register_type_symbol(t, (v__table__TypeSymbol){
...
string v__table__Table_type_to_str(v__table__Table* table, v__table__Type t) { 
	/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(table, t);
	if (sym->kind == v__table__Kind_multi_return) {
		/*assign_stmt*/string res = tos3("(");
		/*assign_stmt*/v__table__MultiReturn mr_info = /* as */ *(v__table__MultiReturn*)sym->info.obj;
		// FOR IN
		for (int i = 0; i < mr_info.types.len; i++) {
			v__table__Type typ = ((v__table__Type*)mr_info.types.data)[i];
	...
	/*assign_stmt*/string res = sym->name;
...
v__table__Table* v__table__new_table() { 
	/*assign_stmt*/v__table__Table* t = (v__table__Table*)memdup(&(v__table__Table){	.types = new_array(0, 1, sizeof(v__table__TypeSymbol)),
		.type_idxs = new_map(1, sizeof(int)),
		.fns = new_map(1, sizeof(v__table__Fn)),
		.consts = new_map(1, sizeof(v__table__Var)),
...
void v__table__Table_register_const(v__table__Table* t, v__table__Var v) { 
	map_set(&t->consts, v.name, &(v__table__Var[]) { v });
}

void v__table__Table_register_global(v__table__Table* t, string name, v__table__Type typ) { 
	map_set(&t->consts, name, &(v__table__Var[]) { (v__table__Var){
		.name = name,
		.typ = typ,
		.is_const = true,
		.is_global = true,
...
string v__table__Fn_signature(v__table__Fn* f) { 
	/*assign_stmt*/string sig = tos3("");
	// FOR IN
	for (int i = 0; i < f->args.len; i++) {
		v__table__Arg arg = ((v__table__Arg*)f->args.data)[i];
		/*assign_stmt*/v__table__Type typ = v__table__type_set_nr_muls(arg.typ, 0);
...
Option_v__table__Fn v__table__Table_find_fn(v__table__Table* t, string name) { 
	/*assign_stmt*/v__table__Fn f = (*(v__table__Fn*)map_get3(t->fns, name, &(v__table__Fn[]){ {0} }));
	if (f.name.str != 0) {
...
Option_v__table__Var v__table__Table_find_const(v__table__Table* t, string name) { 
	/*assign_stmt*/v__table__Var f = (*(v__table__Var*)map_get3(t->consts, name, &(v__table__Var[]){ {0} }));
	if (f.name.str != 0) {
		return opt_ok(& (v__table__Var []) { f }, sizeof(v__table__Var));
	}
	return opt_none();
}
...
Option_v__table__Fn v__table__TypeSymbol_find_method(v__table__TypeSymbol* t, string name) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < t->methods.len; tmp1++) {
		v__table__Fn method = ((v__table__Fn*)t->methods.data)[tmp1];
...
Option_v__table__Field v__table__TypeSymbol_find_field(v__table__TypeSymbol* s, string name) { 
	if (s->info.typ == 100 /* v.table.Struct */) {
		v__table__Struct* it = (v__table__Struct*)s->info.obj; // ST it
		// FOR IN
		for (int tmp2 = 0; tmp2 < it->fields.len; tmp2++) {
			v__table__Field field = ((v__table__Field*)it->fields.data)[tmp2];
...
Option_v__table__Fn v__table__Table_type_find_method(v__table__Table* t, v__table__TypeSymbol* s, string name) { 
	/*assign_stmt*/v__table__TypeSymbol* ts = s;
	while (1) {
		bool tmp1;
...
//[inline]
Option_v__table__TypeSymbol v__table__Table_find_type(v__table__Table* t, string name) { 
	/*assign_stmt*/int idx = (*(int*)map_get3(t->type_idxs, name, &(int[]){ 0 }));
	if (idx > 0) {
...
//[inline]
v__table__TypeSymbol* v__table__Table_get_type_symbol(v__table__Table* t, v__table__Type typ) { 
	/*assign_stmt*/int idx = v__table__type_idx(typ);
	if (idx > 0) {
...
//[inline]
int v__table__Table_register_builtin_type_symbol(v__table__Table* t, v__table__TypeSymbol typ) { 
	/*assign_stmt*/int existing_idx = (*(int*)map_get3(t->type_idxs, typ.name, &(int[]){ 0 }));
	if (existing_idx > 0) {
		if (existing_idx >= _const_v__table__string_type_idx) {
			if (existing_idx == _const_v__table__string_type_idx) {
				/*assign_stmt*/v__table__TypeSymbol existing_type = (*(v__table__TypeSymbol*)array_get(t->types, existing_idx));
...
int v__table__Table_register_type_symbol(v__table__Table* t, v__table__TypeSymbol typ) { 
	/*assign_stmt*/int existing_idx = (*(int*)map_get3(t->type_idxs, typ.name, &(int[]){ 0 }));
	if (existing_idx > 0) {
		/*assign_stmt*/v__table__TypeSymbol ex_type = (*(v__table__TypeSymbol*)array_get(t->types, existing_idx));
	...
	/*assign_stmt*/int typ_idx = t->types.len;
...
//[inline]
string v__table__Table_array_name(v__table__Table* t, v__table__Type elem_type, int nr_dims) { 
	/*assign_stmt*/v__table__TypeSymbol* elem_type_sym = v__table__Table_get_type_symbol(t, elem_type);
...
//[inline]
string v__table__Table_map_name(v__table__Table* t, v__table__Type key_type, v__table__Type value_type) { 
	/*assign_stmt*/v__table__TypeSymbol* key_type_sym = v__table__Table_get_type_symbol(t, key_type);
	/*assign_stmt*/v__table__TypeSymbol* value_type_sym = v__table__Table_get_type_symbol(t, value_type);
	/*assign_stmt*/string suffix = (v__table__type_is_ptr(value_type) ? tos3("_ptr") : tos3(""));
...
int v__table__Table_find_or_register_map(v__table__Table* t, v__table__Type key_type, v__table__Type value_type) { 
	/*assign_stmt*/string name = v__table__Table_map_name(t, key_type, value_type);
	/*assign_stmt*/int existing_idx = (*(int*)map_get3(t->type_idxs, name, &(int[]){ 0 }));
	if (existing_idx > 0) {
		return existing_idx;
	}
	/*assign_stmt*/v__table__TypeSymbol map_typ = (v__table__TypeSymbol){
	...
	}}, sizeof(v__table__Map)), .typ = 99 /* v.table.Map */},
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	};
...
int v__table__Table_find_or_register_array(v__table__Table* t, v__table__Type elem_type, int nr_dims) { 
	/*assign_stmt*/string name = v__table__Table_array_name(t, elem_type, nr_dims);
	/*assign_stmt*/int existing_idx = (*(int*)map_get3(t->type_idxs, name, &(int[]){ 0 }));
	if (existing_idx > 0) {
		return existing_idx;
	}
	/*assign_stmt*/v__table__TypeSymbol array_type = (v__table__TypeSymbol){
		...
		.elem_type = elem_type,
		.nr_dims = nr_dims,
	}}, sizeof(v__table__Array)), .typ = 97 /* v.table.Array */},
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	};
...
int v__table__Table_find_or_register_array_fixed(v__table__Table* t, v__table__Type elem_type, int size, int nr_dims) { 
	/*assign_stmt*/string name = v__table__Table_array_fixed_name(t, elem_type, size, nr_dims);
	/*assign_stmt*/int existing_idx = (*(int*)map_get3(t->type_idxs, name, &(int[]){ 0 }));
	if (existing_idx > 0) {
		return existing_idx;
	}
	/*assign_stmt*/v__table__TypeSymbol array_fixed_type = (v__table__TypeSymbol){
		...
		.size = size,
		.nr_dims = nr_dims,
	}}, sizeof(v__table__ArrayFixed)), .typ = 98 /* v.table.ArrayFixed */},
		.parent_idx = 0,
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	};
...
int v__table__Table_find_or_register_multi_return(v__table__Table* t, array_v__table__Type mr_typs) { 
	/*assign_stmt*/string name = tos3("multi_return");
	// FOR IN
	for (int tmp1 = 0; tmp1 < mr_typs.len; tmp1++) {
		v__table__Type mr_typ = ((v__table__Type*)mr_typs.data)[tmp1];
		/*assign_stmt*/v__table__TypeSymbol* mr_type_sym = v__table__Table_get_type_symbol(t, mr_typ);
	...
	/*assign_stmt*/v__table__TypeSymbol mr_type = (v__table__TypeSymbol){
		...
		.types = mr_typs,
		.name = tos3(""),
	}}, sizeof(v__table__MultiReturn)), .typ = 101 /* v.table.MultiReturn */},
		.parent_idx = 0,
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	};
...
int v__table__Table_find_or_register_fn_type(v__table__Table* t, v__table__Fn f, bool has_decl) { 
	/*assign_stmt*/bool is_anon = f.name.len == 0;
	/*assign_stmt*/string name = (is_anon ? _STR("anon_fn_%.*s", v__table__Fn_signature(&f).len, v__table__Fn_signature(&f).str) : f.name);
	return v__table__Table_register_type_symbol(t, (v__table__TypeSymbol){
		...
		.has_decl = has_decl,
		.func = f,
	}}, sizeof(v__table__FnType)), .typ = 105 /* v.table.FnType */},
		.parent_idx = 0,
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	});
}
...
int v__table__Table_add_placeholder_type(v__table__Table* t, string name) { 
	/*assign_stmt*/v__table__TypeSymbol ph_type = (v__table__TypeSymbol){
		.kind = v__table__Kind_placeholder,
		.name = name,
		.parent_idx = 0,
		.info = {0},
...
//[inline]
v__table__Type v__table__Table_value_type(v__table__Table* t, v__table__Type typ) { 
	/*assign_stmt*/v__table__TypeSymbol* typ_sym = v__table__Table_get_type_symbol(t, typ);
	if (v__table__type_is_variadic(typ)) {
		return v__table__type_clear_extra(typ);
	} else if (typ_sym->kind == v__table__Kind_array) {
		/*assign_stmt*/v__table__Array info = /* as */ *(v__table__Array*)typ_sym->info.obj;
		return info.elem_type;
	} else if (typ_sym->kind == v__table__Kind_array_fixed) {
		/*assign_stmt*/v__table__ArrayFixed info = /* as */ *(v__table__ArrayFixed*)typ_sym->info.obj;
		return info.elem_type;
	} else if (typ_sym->kind == v__table__Kind_map) {
		/*assign_stmt*/v__table__Map info = /* as */ *(v__table__Map*)typ_sym->info.obj;
...
bool v__table__Table_check(v__table__Table* t, v__table__Type got, v__table__Type expected) { 
	/*assign_stmt*/int got_idx = v__table__type_idx(got);
	/*assign_stmt*/int exp_idx = v__table__type_idx(expected);
	/*assign_stmt*/bool exp_is_ptr = v__table__type_is_ptr(expected);
	...
	/*assign_stmt*/v__table__TypeSymbol* got_type_sym = v__table__Table_get_type_symbol(t, got);
	/*assign_stmt*/v__table__TypeSymbol* exp_type_sym = v__table__Table_get_type_symbol(t, expected);
	...
	if (got_type_sym->kind == v__table__Kind_array_fixed && exp_type_sym->kind == v__table__Kind_byteptr) {
		/*assign_stmt*/v__table__ArrayFixed info = /* as */ *(v__table__ArrayFixed*)got_type_sym->info.obj;
	...
	if (got_type_sym->kind == v__table__Kind_sum_type) {
		/*assign_stmt*/v__table__SumType sum_info = /* as */ *(v__table__SumType*)got_type_sym->info.obj;
		if (_IN(v__table__Type, expected, sum_info.variants)) {
			return true;
		}
	}
	if (exp_type_sym->kind == v__table__Kind_sum_type) {
		/*assign_stmt*/v__table__SumType sum_info = /* as */ *(v__table__SumType*)exp_type_sym->info.obj;
	...
	if (got_type_sym->kind == v__table__Kind_function && exp_type_sym->kind == v__table__Kind_function) {
		/*assign_stmt*/v__table__FnType got_info = /* as */ *(v__table__FnType*)got_type_sym->info.obj;
		/*assign_stmt*/v__table__FnType exp_info = /* as */ *(v__table__FnType*)exp_type_sym->info.obj;
...
string v__table__Table_qualify_module(v__table__Table* table, string mod, string file_path) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < table->imports.len; tmp1++) {
		string m = ((string*)table->imports.data)[tmp1];
		if (string_contains(m, tos3(".")) && string_contains(m, mod)) {
			/*assign_stmt*/array_string m_parts = string_split(m, tos3("."));
			/*assign_stmt*/string m_path = array_string_join(m_parts, _const_os__path_separator);
...
// TypeDecl
string v__doc__doc(string mod, v__table__Table* table) { 
	/*assign_stmt*/v__doc__Doc d = (v__doc__Doc){
		.out = strings__new_builder(1000),
		.table = table,
		.mod = mod,
		.stmts = new_array(0, 1, sizeof(v__ast__Stmt)),
	};
	/*assign_stmt*/string vlib_path = string_add(os__dir(v__pref__vexe_path()), tos3("/vlib"));
	/*assign_stmt*/string mod_path = string_replace(mod, tos3("."), _const_os__path_separator);
	/*assign_stmt*/string path = os__join_path(vlib_path, (varg_string){.len=1,.args={mod_path}});
	if (!os__exists(path)) {
	...
	for (int tmp2 = 0; tmp2 < /*opt*/(*(array_string*)files.data).len; tmp2++) {
		...
		/*assign_stmt*/v__ast__File file_ast = v__parser__parse_file(os__join_path(path, (varg_string){.len=1,.args={file}}), table, v__scanner__CommentsMode_skip_comments, (v__pref__Preferences*)memdup(&(v__pref__Preferences){	.os = {0},
			.backend = {0},
			.build_mode = {0},
			.verbosity = {0},
			.is_test = 0,
...
void v__doc__Doc_print_fns(v__doc__Doc* d) { 
	/*assign_stmt*/array_string fn_signatures = v__doc__Doc_get_fn_signatures(/*rec*/*d, v__doc__is_pub_function);
	v__doc__Doc_write_fn_signatures(d, fn_signatures);
}

void v__doc__Doc_print_methods(v__doc__Doc* d) { 
	/*assign_stmt*/array_string fn_signatures = v__doc__Doc_get_fn_signatures(/*rec*/*d, v__doc__is_pub_method);
	v__doc__Doc_write_fn_signatures(d, fn_signatures);
}
...
void v__doc__Doc_write_fn_signatures(v__doc__Doc* d, array_string fn_signatures) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < fn_signatures.len; tmp1++) {
		string s = ((string*)fn_signatures.data)[tmp1];
		strings__Builder_writeln(&d->out, s);
	}
}

array_string v__doc__Doc_get_fn_signatures(v__doc__Doc d, v__doc__FilterFn filter_fn) { 
	/*assign_stmt*/array_string fn_signatures = new_array(0, 0, sizeof(string));
	// FOR IN
	for (int tmp1 = 0; tmp1 < d.stmts.len; tmp1++) {
		v__ast__Stmt stmt = ((v__ast__Stmt*)d.stmts.data)[tmp1];
		if (stmt.typ == 126 /* v.ast.FnDecl */) {
...
void v__doc__Doc_print_enums(v__doc__Doc* d) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < d->table->types.len; tmp1++) {
		v__table__TypeSymbol typ = ((v__table__TypeSymbol*)d->table->types.data)[tmp1];
		if (typ.kind != v__table__Kind_enum_) {
			continue;
		}
		strings__Builder_writeln(&d->out, _STR("enum %.*s {", typ.name.len, typ.name.str));
		/*assign_stmt*/v__table__Enum info = /* as */ *(v__table__Enum*)typ.info.obj;
		// FOR IN
		for (int tmp3 = 0; tmp3 < info.vals.len; tmp3++) {
			string val = ((string*)info.vals.data)[tmp3];
			strings__Builder_writeln(&d->out, _STR("\t%.*s", val.len, val.str));
		}
		strings__Builder_writeln(&d->out, tos3("}"));
	}
}
...
void v__doc__Doc_print_structs(v__doc__Doc* d) { 
	...
	for (int tmp1 = 0; tmp1 < d->table->types.len; tmp1++) {
		...
		/*assign_stmt*/string name = string_after(typ.name, tos3("."));
		strings__Builder_writeln(&d->out, _STR("struct %.*s {", name.len, name.str));
		/*assign_stmt*/v__table__Struct info = /* as */ *(v__table__Struct*)typ.info.obj;
		// FOR IN
		for (int tmp3 = 0; tmp3 < info.fields.len; tmp3++) {
			v__table__Field field = ((v__table__Field*)info.fields.data)[tmp3];
			/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(d->table, field.typ);
...
f64 math__inf(int sign) { 
	/*assign_stmt*/u64 v = (sign >= 0 ? _const_math__uvinf : _const_math__uvneginf);
...
array_int math__digits(int _n, int base) { 
	...
	/*assign_stmt*/int n = _n;
	/*assign_stmt*/int sign = 1;
	if (n < 0) {
		sign = -1;
		n = -n;
	}
	/*assign_stmt*/array_int res = new_array(0, 0, sizeof(int));
	while (n != 0) {
...
i64 math__gcd(i64 a_, i64 b_) { 
	/*assign_stmt*/i64 a = a_;
	/*assign_stmt*/i64 b = b_;
	if (a < 0) {
		a = -a;
	}
	if (b < 0) {
...
i64 math__lcm(i64 a, i64 b) { 
	...
	/*assign_stmt*/i64 res = a * (b / math__gcd(b, a));
	if (res < 0) {
		return -res;
	}
	return res;
...
f64 math__aprox_sin(f64 a) { 
	/*assign_stmt*/f64 a0 = 1.91059300966915117e-31;
	/*assign_stmt*/f64 a1 = 1.00086760103908896;
	/*assign_stmt*/f64 a2 = -1.21276126894734565e-2;
	/*assign_stmt*/f64 a3 = -1.38078780785773762e-1;
	/*assign_stmt*/f64 a4 = -2.67353392911981221e-2;
	/*assign_stmt*/f64 a5 = 2.08026600266304389e-2;
	/*assign_stmt*/f64 a6 = -3.03996055049204407e-3;
	/*assign_stmt*/f64 a7 = 1.38235642404333740e-4;
	return a0 + a * (a1 + a * (a2 + a * (a3 + a * (a4 + a * (a5 + a * (a6 + a * a7))))));
}

f64 math__aprox_cos(f64 a) { 
	/*assign_stmt*/f64 a0 = 9.9995999154986614e-1;
	/*assign_stmt*/f64 a1 = 1.2548995793001028e-3;
	/*assign_stmt*/f64 a2 = -5.0648546280678015e-1;
	/*assign_stmt*/f64 a3 = 1.2942246466519995e-2;
	/*assign_stmt*/f64 a4 = 2.8668384702547972e-2;
	/*assign_stmt*/f64 a5 = 7.3726485210586547e-3;
	/*assign_stmt*/f64 a6 = -3.8510875386947414e-3;
	/*assign_stmt*/f64 a7 = 4.7196604604366623e-4;
	/*assign_stmt*/f64 a8 = -1.8776444013090451e-5;
...
u32 math__f32_bits(f32 f) { 
	/*assign_stmt*/u32* p = ((u32*)(&f));
	return *p;
}

f32 math__f32_from_bits(u32 b) { 
	/*assign_stmt*/f32* p = ((f32*)(&b));
	return *p;
}

u64 math__f64_bits(f64 f) { 
	/*assign_stmt*/u64* p = ((u64*)(&f));
	return *p;
}

f64 math__f64_from_bits(u64 b) { 
	/*assign_stmt*/f64* p = ((f64*)(&b));
	return *p;
}
...
int math__bits__ones_count_64(u64 x) { 
	/*assign_stmt*/u64 y = ((x >> ((u64)(1)) & ((_const_math__bits__m0 & _const_math__bits__max_u64)))) + ((x & ((_const_math__bits__m0 & _const_math__bits__max_u64))));
...
//[inline]
byte math__bits__rotate_left_8(byte x, int k) { 
	/*assign_stmt*/byte n = ((byte)(8));
	/*assign_stmt*/byte s = (((byte)(k)) & (n - ((byte)(1))));
	return ((x << s) | (x >> (n - s)));
}

//[inline]
u16 math__bits__rotate_left_16(u16 x, int k) { 
	/*assign_stmt*/u16 n = ((u16)(16));
	/*assign_stmt*/u16 s = (((u16)(k)) & (n - ((u16)(1))));
	return ((x << s) | (x >> (n - s)));
}

//[inline]
u32 math__bits__rotate_left_32(u32 x, int k) { 
	/*assign_stmt*/u32 n = ((u32)(32));
	/*assign_stmt*/u32 s = (((u32)(k)) & (n - ((u32)(1))));
	return ((x << s) | (x >> (n - s)));
}

//[inline]
u64 math__bits__rotate_left_64(u64 x, int k) { 
	/*assign_stmt*/u64 n = ((u64)(64));
	/*assign_stmt*/u64 s = (((u64)(k)) & (n - ((u64)(1))));
	return ((x << s) | (x >> (n - s)));
}
...
//[inline]
u32 math__bits__reverse_32(u32 x) { 
	/*assign_stmt*/u32 y = (((x >> ((u32)(1)) & ((_const_math__bits__m0 & _const_math__bits__max_u32)))) | (((x & ((_const_math__bits__m0 & _const_math__bits__max_u32)))) << 1));
...
//[inline]
u64 math__bits__reverse_64(u64 x) { 
	/*assign_stmt*/u64 y = (((x >> ((u64)(1)) & ((_const_math__bits__m0 & _const_math__bits__max_u64)))) | (((x & ((_const_math__bits__m0 & _const_math__bits__max_u64)))) << 1));
...
//[inline]
u32 math__bits__reverse_bytes_32(u32 x) { 
	/*assign_stmt*/u32 y = (((x >> ((u32)(8)) & ((_const_math__bits__m3 & _const_math__bits__max_u32)))) | (((x & ((_const_math__bits__m3 & _const_math__bits__max_u32)))) << ((u32)(8))));
	return (y >> 16) | (y << 16);
}

//[inline]
u64 math__bits__reverse_bytes_64(u64 x) { 
	/*assign_stmt*/u64 y = (((x >> ((u64)(8)) & ((_const_math__bits__m3 & _const_math__bits__max_u64)))) | (((x & ((_const_math__bits__m3 & _const_math__bits__max_u64)))) << ((u64)(8))));
...
multi_return_u32_u32 math__bits__add_32(u32 x, u32 y, u32 carry) { 
	/*assign_stmt*/u64 sum64 = ((u64)(x)) + ((u64)(y)) + ((u64)(carry));
	/*assign_stmt*/u32 sum = ((u32)(sum64));
	/*assign_stmt*/u32 carry_out = ((u32)(sum64 >> 32));
	return (multi_return_u32_u32){.arg0=sum,.arg1=carry_out};
}

multi_return_u64_u64 math__bits__add_64(u64 x, u64 y, u64 carry) { 
	/*assign_stmt*/u64 sum = x + y + carry;
	/*assign_stmt*/u64 carry_out = (((x & y)) | (((x | y) & ~sum))) >> 63;
	return (multi_return_u64_u64){.arg0=sum,.arg1=carry_out};
}

multi_return_u32_u32 math__bits__sub_32(u32 x, u32 y, u32 borrow) { 
	/*assign_stmt*/u32 diff = x - y - borrow;
	/*assign_stmt*/u32 borrow_out = ((~(x & y)) | (~((x ^ y) & diff))) >> 31;
	return (multi_return_u32_u32){.arg0=diff,.arg1=borrow_out};
}

multi_return_u64_u64 math__bits__sub_64(u64 x, u64 y, u64 borrow) { 
	/*assign_stmt*/u64 diff = x - y - borrow;
	/*assign_stmt*/u64 borrow_out = ((~(x & y)) | (~((x ^ y) & diff))) >> 63;
	return (multi_return_u64_u64){.arg0=diff,.arg1=borrow_out};
}

multi_return_u32_u32 math__bits__mul_32(u32 x, u32 y) { 
	/*assign_stmt*/u64 tmp = ((u64)(x)) * ((u64)(y));
	/*assign_stmt*/u32 hi = ((u32)(tmp >> 32));
	/*assign_stmt*/u32 lo = ((u32)(tmp));
	return (multi_return_u32_u32){.arg0=hi,.arg1=lo};
}

multi_return_u64_u64 math__bits__mul_64(u64 x, u64 y) { 
	/*assign_stmt*/u64 x0 = (x & _const_math__bits__mask32);
	/*assign_stmt*/u64 x1 = x >> 32;
	/*assign_stmt*/u64 y0 = (y & _const_math__bits__mask32);
	/*assign_stmt*/u64 y1 = y >> 32;
	/*assign_stmt*/u64 w0 = x0 * y0;
	/*assign_stmt*/u64 t = x1 * y0 + (w0 >> 32);
	/*assign_stmt*/u64 w1 = (t & _const_math__bits__mask32);
	/*assign_stmt*/u64 w2 = t >> 32;
	w1 += x0 * y1;
	/*assign_stmt*/u64 hi = x1 * y1 + w2 + (w1 >> 32);
	/*assign_stmt*/u64 lo = x * y;
...
multi_return_u32_u32 math__bits__div_32(u32 hi, u32 lo, u32 y) { 
	...
	/*assign_stmt*/u64 z = (((u64)(hi)) << 32) | ((u64)(lo));
	/*assign_stmt*/u32 quo = ((u32)(z / ((u64)(y))));
	/*assign_stmt*/u32 rem = ((u32)(z % ((u64)(y))));
	return (multi_return_u32_u32){.arg0=quo,.arg1=rem};
}

multi_return_u64_u64 math__bits__div_64(u64 hi, u64 lo, u64 y1) { 
	/*assign_stmt*/u64 y = y1;
	if (y == 0) {
		v_panic(_const_math__bits__overflow_error);
	}
	if (y <= hi) {
	...
	/*assign_stmt*/u32 s = ((u32)(math__bits__leading_zeros_64(y)));
	y <<= s;
	/*assign_stmt*/u64 yn1 = y >> 32;
	/*assign_stmt*/u64 yn0 = (y & _const_math__bits__mask32);
	/*assign_stmt*/u64 un32 = (hi << s) | (lo >> (64 - s));
	/*assign_stmt*/u64 un10 = lo << s;
	/*assign_stmt*/u64 un1 = un10 >> 32;
	/*assign_stmt*/u64 un0 = (un10 & _const_math__bits__mask32);
	/*assign_stmt*/u64 q1 = un32 / yn1;
	/*assign_stmt*/u64 rhat = un32 - q1 * yn1;
	...
	/*assign_stmt*/u64 un21 = un32 * _const_math__bits__two32 + un1 - q1 * y;
	/*assign_stmt*/u64 q0 = un21 / yn1;
	rhat = un21 - q0 * yn1;
...
string time__Time_clean(time__Time t) { 
	/*assign_stmt*/time__Time now = time__now();
...
string time__Time_get_fmt_time_str(time__Time t, time__FormatTime fmt_time) { 
	...
	/*assign_stmt*/string tp = (t.hour > 11 ? tos3("p.m.") : tos3("a.m."));
	/*assign_stmt*/int hour = (t.hour > 12 ? t.hour - 12 : t.hour == 0 ? 12 : t.hour);
...
Option_time__Time time__parse(string s) { 
	/*assign_stmt*/Option_int pos = string_index(s, tos3(" "));
	if (!pos.ok) {
	string err = pos.v_error;
	int errcode = pos.ecode;
		return v_error(_STR("Invalid time format: %.*s", s.len, s.str));
	};
	/*assign_stmt*/string symd = string_substr(s, 0, /*opt*/(*(int*)pos.data));
	/*assign_stmt*/array_string ymd = string_split(symd, tos3("-"));
	if (ymd.len != 3) {
		return v_error(_STR("Invalid time format: %.*s", s.len, s.str));
	}
	/*assign_stmt*/string shms = string_substr(s, /*opt*/(*(int*)pos.data), s.len);
	/*assign_stmt*/array_string hms = string_split(shms, tos3(":"));
	/*assign_stmt*/string hour = string_substr((*(string*)array_get(hms, 0)), 1, (*(string*)array_get(hms, 0)).len);
	/*assign_stmt*/string minute = (*(string*)array_get(hms, 1));
	/*assign_stmt*/string second = (*(string*)array_get(hms, 2));
	/*assign_stmt*/time__Time res = time__new_time((time__Time){
...
Option_time__Time time__parse_rfc2822(string s) { 
	/*assign_stmt*/array_string fields = string_split(s, tos3(" "));
	if (fields.len < 5) {
		return v_error(_STR("Invalid time format: %.*s", s.len, s.str));
	}
	/*assign_stmt*/Option_int pos = string_index(_const_time__months_string, (*(string*)array_get(fields, 2)));
	if (!pos.ok) {
	string err = pos.v_error;
	int errcode = pos.ecode;
		return v_error(_STR("Invalid time format: %.*s", s.len, s.str));
	};
	/*assign_stmt*/int mm = /*opt*/(*(int*)pos.data) / 3 + 1;
	/*assign_stmt*/byteptr tmstr = ((byteptr)(0));
		tmstr = v_malloc(s.len * 2);
	/*assign_stmt*/int count = snprintf(((charptr)(tmstr)), (s.len * 2), "%s-%02d-%s %s", (*(string*)array_get(fields, 3)).str, mm, (*(string*)array_get(fields, 1)).str, (*(string*)array_get(fields, 4)).str);
	/*assign_stmt*/Option_time__Time t = time__parse(tos(tmstr, count));
	if (!t.ok) {
...
time__Time time__now() { 
	/*assign_stmt*/time__time_t t = time(0);
	/*assign_stmt*/struct tm* now = ((struct tm*)(0));
	now = localtime(&t);
	return time__convert_ctime(*/*d*/now);
}

string time__Time_smonth(time__Time t) { 
	/*assign_stmt*/int i = t.month - 1;
...
int time__Time_unix_time(time__Time* t) { 
	...
	/*assign_stmt*/struct tm tt = (struct tm){
		.tm_sec = t->second,
		.tm_min = t->minute,
		.tm_hour = t->hour,
		.tm_mday = t->day,
...
string time__Time_relative(time__Time t) { 
	/*assign_stmt*/time__Time now = time__now();
	/*assign_stmt*/int secs = now.v_unix - t.v_unix;
	if (secs <= 30) {
		return tos3("now");
	}
	if (secs < 60) {
...
int time__day_of_week(int y, int m, int d) { 
	/*assign_stmt*/array_int t = new_array_from_c_array(12, 12, sizeof(int), (int[12]){	
	0, 3, 2, 5, 0, 3, 5, 1, 4, 6, 2, 4, 
});
	/*assign_stmt*/int sy = y;
	if (m < 3) {
		sy = sy - 1;
	}
...
string time__Time_weekday_str(time__Time t) { 
	/*assign_stmt*/int i = time__Time_day_of_week(t) - 1;
...
i64 time__ticks() { 
	...
	// #if windows
		return GetTickCount();
	#else
		/*assign_stmt*/struct timeval ts = (struct timeval){
			.tv_sec = 0,
			.tv_usec = 0,
		};
		gettimeofday(&ts, 0);
...
#ifdef _WIN32
	// #if windows
		/*assign_stmt*/int milliseconds = microseconds / 1000;
		Sleep(milliseconds);
	#else
		usleep(microseconds);
	#endif
...
Option_int time__days_in_month(int month, int year) { 
	...
	/*assign_stmt*/int extra = (month == 2 && time__is_leap_year(year) ? 1 : 0);
	/*assign_stmt*/int res = (*(int*)array_get(_const_time__month_days, month - 1)) + extra;
...
time__Time time__unix(int abs) { 
	/*assign_stmt*/int day_offset = abs / _const_time__seconds_per_day;
...
//[inline]
multi_return_int_int_int time__calculate_date_from_offset(int day_offset_) { 
	/*assign_stmt*/int day_offset = day_offset_;
	/*assign_stmt*/int year = 2001;
	day_offset -= 31 * 365 + 8;
	...
	/*assign_stmt*/int estimated_month = day_offset / 31;
...
//[inline]
multi_return_int_int_int time__calculate_time_from_offset(int second_offset_) { 
	/*assign_stmt*/int second_offset = second_offset_;
	if (second_offset < 0) {
		second_offset += _const_time__seconds_per_day;
	}
	/*assign_stmt*/int hour = second_offset / _const_time__seconds_per_hour;
	second_offset %= _const_time__seconds_per_hour;
	/*assign_stmt*/int min = second_offset / _const_time__seconds_per_minute;
...
string term__h_divider(string divider) { 
	...
	/*assign_stmt*/string result = (divider.len > 0 ? string_repeat(divider, 1 + (cols / divider.len)) : string_repeat(tos3(" "), 1 + cols));
...
string term__header(string text, string divider) { 
	...
	/*assign_stmt*/int tlimit = (cols > text.len + 2 + 2 * divider.len ? text.len : cols - 3 - 2 * divider.len);
	/*assign_stmt*/int tlimit_alligned = ((tlimit % 2) != (cols % 2) ? tlimit + 1 : tlimit);
	/*assign_stmt*/int tstart = (cols - tlimit_alligned) / 2;
	/*assign_stmt*/string ln = (divider.len > 0 ? string_substr(string_repeat(divider, 1 + cols / divider.len), 0, cols) : string_repeat(tos3(" "), 1 + cols));
...
multi_return_int_int term__get_terminal_size() { 
	...
	/*assign_stmt*/struct winsize w = (struct winsize){
		.ws_row = 0,
		.ws_col = 0,
		.ws_xpixel = 0,
		.ws_ypixel = 0,
...
benchmark__Benchmark benchmark__start() { 
	/*assign_stmt*/benchmark__Benchmark b = benchmark__new_benchmark();
...
i64 benchmark__Benchmark_measure(benchmark__Benchmark* b, string label) { 
	...
	/*assign_stmt*/i64 res = b->step_end_time - b->step_start_time;
...
string benchmark__Benchmark_step_message_with_label(benchmark__Benchmark* b, string label, string msg) { 
	/*assign_stmt*/string timed_line = tos3("");
	if (b->nexpected_steps > 0) {
		/*assign_stmt*/string sprogress = tos3("");
...
string benchmark__Benchmark_tdiff_in_ms(benchmark__Benchmark* b, string s, i64 sticks, i64 eticks) { 
	if (b->verbose) {
		/*assign_stmt*/i64 tdiff = (eticks - sticks);
...
v__builder__Builder v__builder__new_builder(v__pref__Preferences* pref) { 
	...
	return (v__builder__Builder){
		...
		.pref = pref,
		.table = table,
		.checker = v__checker__new_checker(table),
		.os = {0},
		.compiled_dir = tos3(""),
		.module_path = tos3(""),
...
string v__builder__Builder_gen_c(v__builder__Builder* b, array_string v_files) { 
	/*assign_stmt*/i64 t0 = time__ticks();
	b->parsed_files = v__parser__parse_files(v_files, b->table, b->pref);
	v__builder__Builder_parse_imports(b);
	/*assign_stmt*/i64 t1 = time__ticks();
	/*assign_stmt*/i64 parse_time = t1 - t0;
	v__builder__Builder_info(b, _STR("PARSE: %dms", parse_time));
	v__checker__Checker_check_files(&b->checker, b->parsed_files);
	/*assign_stmt*/i64 t2 = time__ticks();
	/*assign_stmt*/i64 check_time = t2 - t1;
	v__builder__Builder_info(b, _STR("CHECK: %dms", check_time));
	if (b->checker.nr_errors > 0) {
		v_exit(1);
	}
	/*assign_stmt*/string res = v__gen__cgen(b->parsed_files, b->table, b->pref);
	/*assign_stmt*/i64 t3 = time__ticks();
	/*assign_stmt*/i64 gen_time = t3 - t2;
...
void v__builder__Builder_build_c(v__builder__Builder* b, array_string v_files, string out_file) { 
	...
	/*assign_stmt*/Option_os__File f = os__create(out_file);
	if (!f.ok) {
	string err = f.v_error;
	int errcode = f.ecode;
		v_panic(err);
...
void v__builder__Builder_parse_imports(v__builder__Builder* b) { 
	/*assign_stmt*/array_string done_imports = new_array(0, 0, sizeof(string));
	for (int tmp1 = 0; tmp1 < b->parsed_files.len; tmp1++) { 
		int i = tmp1;
		/*assign_stmt*/v__ast__File ast_file = (*(v__ast__File*)array_get(b->parsed_files, i));
		// FOR IN
		for (int _ = 0; _ < ast_file.imports.len; _++) {
			v__ast__Import imp = ((v__ast__Import*)ast_file.imports.data)[_];
			/*assign_stmt*/string mod = imp.mod;
			if (_IN(string, mod, done_imports)) {
				continue;
			}
			/*assign_stmt*/Option_string import_path = v__builder__Builder_find_module_path(b, mod);
			if (!import_path.ok) {
			string err = import_path.v_error;
			int errcode = import_path.ecode;
				v_panic(_STR("cannot import module \"%.*s\" (not found)", mod.len, mod.str));
			};
			/*assign_stmt*/array_string v_files = v__builder__Builder_v_files_from_dir(b, /*opt*/(*(string*)import_path.data));
			if (v_files.len == 0) {
			...
			/*assign_stmt*/array_v__ast__File parsed_files = v__parser__parse_files(v_files, b->table, b->pref);
			// FOR IN
			for (int tmp4 = 0; tmp4 < parsed_files.len; tmp4++) {
				v__ast__File file = ((v__ast__File*)parsed_files.data)[tmp4];
...
array_string v__builder__Builder_v_files_from_dir(v__builder__Builder* b, string dir) { 
	...
	for (int tmp4 = 0; tmp4 < /*opt*/(*(array_string*)files.data).len; tmp4++) {
		...
		if (b->pref->compile_defines_all.len > 0 && string_contains(file, tos3("_d_"))) {
			/*assign_stmt*/bool allowed = false;
			// FOR IN
			for (int tmp17 = 0; tmp17 < b->pref->compile_defines.len; tmp17++) {
				string cdefine = ((string*)b->pref->compile_defines.data)[tmp17];
				/*assign_stmt*/string file_postfix = _STR("_d_%.*s.v", cdefine.len, cdefine.str);
				if (string_ends_with(file, file_postfix)) {
					allowed = true;
					break;
...
Option_string v__builder__Builder_find_module_path(v__builder__Builder* b, string mod) { 
	/*assign_stmt*/string mod_path = v__builder__module_path(mod);
	// FOR IN
	for (int tmp1 = 0; tmp1 < b->module_search_paths.len; tmp1++) {
		string search_path = ((string*)b->module_search_paths.data)[tmp1];
		/*assign_stmt*/string try_path = os__join_path(search_path, (varg_string){.len=1,.args={mod_path}});
...
v__builder__ModFileAndFolder v__builder__ModFileCacher_get(v__builder__ModFileCacher* mcache, string mfolder) { 
	...
	// FOR IN
	for (int tmp2 = 0; tmp2 < traversed_folders.len; tmp2++) {
		string tfolder = ((string*)traversed_folders.data)[tmp2];
		v__builder__ModFileCacher_add(mcache, tfolder, res);
	}
	return res;
}
...
multi_return_array_string_v__builder__ModFileAndFolder v__builder__ModFileCacher_traverse(v__builder__ModFileCacher* mcache, string mfolder) { 
	/*assign_stmt*/string cfolder = mfolder;
	/*assign_stmt*/array_string folders_so_far = new_array_from_c_array(1, 1, sizeof(string), (string[1]){	
	cfolder, 
});
	/*assign_stmt*/int levels = 0;
	while (1) {
		if (levels > 255) {
			break;
		}
		...
		if (_IN_MAP(cfolder, mcache->cache)) {
			/*assign_stmt*/v__builder__ModFileAndFolder res = (*(v__builder__ModFileAndFolder*)map_get3(mcache->cache, cfolder, &(v__builder__ModFileAndFolder[]){ {0} }));
		...
		/*assign_stmt*/array_string files = v__builder__ModFileCacher_get_files(mcache, cfolder);
		if (_IN(string, tos3("v.mod"), files)) {
			/*assign_stmt*/v__builder__ModFileAndFolder res = (v__builder__ModFileAndFolder){
...
void v__builder__ModFileCacher_mark_folders_with_vmod(v__builder__ModFileCacher* mcache, array_string folders_so_far, v__builder__ModFileAndFolder vmod) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < folders_so_far.len; tmp1++) {
		string f = ((string*)folders_so_far.data)[tmp1];
		v__builder__ModFileCacher_add(mcache, f, vmod);
	}
}
...
void v__builder__ModFileCacher_mark_folders_as_vmod_free(v__builder__ModFileCacher* mcache, array_string folders_so_far) { 
	...
	for (int tmp1 = 0; tmp1 < folders_so_far.len; tmp1++) {
		string f = ((string*)folders_so_far.data)[tmp1];
		v__builder__ModFileCacher_add(mcache, f, (v__builder__ModFileAndFolder){
			.vmod_file = tos3(""),
			.vmod_folder = f,
		});
	}
...
bool v__builder__ModFileCacher_check_for_stop(v__builder__ModFileCacher* mcache, string cfolder, array_string files) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < _const_v__builder__MOD_FILE_STOP_PATHS.len; tmp1++) {
		string i = ((string*)_const_v__builder__MOD_FILE_STOP_PATHS.data)[tmp1];
...
array_string v__builder__ModFileCacher_get_files(v__builder__ModFileCacher* mcache, string cfolder) { 
	...
	/*assign_stmt*/Option_array_string files = os__ls(cfolder);
	if (!files.ok) {
	string err = files.v_error;
	int errcode = files.ecode;
		return new_array(0, 0, sizeof(string));
...
array_string os__cmdline__options(array_string args, string param) { 
	/*assign_stmt*/array_string flags = new_array(0, 0, sizeof(string));
	// FOR IN
...
array_string os__cmdline__options_before(array_string args, array_string what) { 
	/*assign_stmt*/bool found = false;
	/*assign_stmt*/array_string args_before = new_array(0, 0, sizeof(string));
	// FOR IN
	for (int tmp1 = 0; tmp1 < args.len; tmp1++) {
...
array_string os__cmdline__options_after(array_string args, array_string what) { 
	/*assign_stmt*/bool found = false;
	/*assign_stmt*/array_string args_after = new_array(0, 0, sizeof(string));
	// FOR IN
	for (int tmp1 = 0; tmp1 < args.len; tmp1++) {
		string a = ((string*)args.data)[tmp1];
		if (_IN(string, a, what)) {
...
v__ast__CompIf v__parser__Parser_comp_if(v__parser__Parser* p) { 
	/*assign_stmt*/v__token__Position pos = v__token__Token_position(&p->tok);
	v__parser__Parser_next(p);
	v__parser__Parser_check(p, v__token__Kind_key_if);
	/*assign_stmt*/bool is_not = p->tok.kind == v__token__Kind_not;
	if (is_not) {
		v__parser__Parser_next(p);
	}
	/*assign_stmt*/string val = v__parser__Parser_check_name(p);
	/*assign_stmt*/array_v__ast__Stmt stmts = new_array(0, 0, sizeof(v__ast__Stmt));
	/*assign_stmt*/bool skip_os = false;
	if (_IN(string, val, _const_v__parser__supported_platforms)) {
		/*assign_stmt*/v__pref__OS os = v__parser__os_from_string(val);
		if (false && ((!is_not && os != p->pref->os) || (is_not && os == p->pref->os)) && !p->pref->output_cross_c) {
			skip_os = true;
			v__parser__Parser_check(p, v__token__Kind_lcbr);
			/*assign_stmt*/int stack = 1;
			while (1) {
	...
	/*assign_stmt*/v__ast__CompIf node = (v__ast__CompIf){
		.is_not = is_not,
		.pos = pos,
		.val = val,
		.stmts = stmts,
...
v__ast__CallExpr v__parser__Parser_call_expr(v__parser__Parser* p, bool is_c, string mod) { 
	/*assign_stmt*/v__token__Token tok = p->tok;
	/*assign_stmt*/string name = v__parser__Parser_check_name(p);
	/*assign_stmt*/string fn_name = (is_c ? _STR("C.%.*s", name.len, name.str) : mod.len > 0 ? _STR("%.*s.%.*s", mod.len, mod.str, name.len, name.str) : name);
	v__parser__Parser_check(p, v__token__Kind_lpar);
	/*assign_stmt*/array_v__ast__CallArg args = v__parser__Parser_call_args(p);
	/*assign_stmt*/array_v__ast__Stmt or_stmts = new_array(0, 0, sizeof(v__ast__Stmt));
	if (p->tok.kind == v__token__Kind_key_orelse) {
		v__parser__Parser_next(p);
		v__parser__Parser_open_scope(p);
		v__ast__Scope_register_var(p->scope, (v__ast__Var){
			.name = tos3("err"),
	...
	/*assign_stmt*/v__ast__CallExpr node = (v__ast__CallExpr){
		.name = fn_name,
		.args = args,
		...
		.left = {0},
		.is_method = 0,
		.exp_arg_types = new_array(0, 1, sizeof(v__table__Type)),
		.left_type = {0},
		.receiver_type = {0},
		.return_type = {0},
	};
...
array_v__ast__CallArg v__parser__Parser_call_args(v__parser__Parser* p) { 
	/*assign_stmt*/array_v__ast__CallArg args = new_array(0, 0, sizeof(v__ast__CallArg));
	while (p->tok.kind != v__token__Kind_rpar) {
		/*assign_stmt*/bool is_mut = false;
		if (p->tok.kind == v__token__Kind_key_mut) {
			v__parser__Parser_check(p, v__token__Kind_key_mut);
			is_mut = true;
		}
		/*assign_stmt*/v__ast__Expr e = v__parser__Parser_expr(p, 0);
...
v__ast__FnDecl v__parser__Parser_fn_decl(v__parser__Parser* p) { 
	v__parser__Parser_open_scope(p);
	/*assign_stmt*/bool is_deprecated = string_eq(p->attr, tos3("deprecated"));
	/*assign_stmt*/bool is_pub = p->tok.kind == v__token__Kind_key_pub;
	if (is_pub) {
		v__parser__Parser_next(p);
	}
	v__parser__Parser_check(p, v__token__Kind_key_fn);
	/*assign_stmt*/bool is_c = p->tok.kind == v__token__Kind_name && string_eq(p->tok.lit, tos3("C"));
	if (is_c) {
		v__parser__Parser_next(p);
		v__parser__Parser_check(p, v__token__Kind_dot);
	}
	/*assign_stmt*/string rec_name = tos3("");
	/*assign_stmt*/bool is_method = false;
	/*assign_stmt*/v__table__Type rec_type = _const_v__table__void_type;
	/*assign_stmt*/bool rec_mut = false;
	/*assign_stmt*/array_v__table__Arg args = new_array(0, 0, sizeof(v__table__Arg));
	...
	multi_return_array_v__table__Arg_bool mr_2395 = v__parser__Parser_fn_args(p);
	array_v__table__Arg args2 = mr_2395.arg0;
	bool is_variadic = mr_2395.arg1;
	...
	/*assign_stmt*/v__table__Type return_type = _const_v__table__void_type;
	if (v__token__Kind_is_start_of_type(p->tok.kind)) {
		return_type = v__parser__Parser_parse_type(p);
	}
	if (is_method) {
		/*assign_stmt*/v__table__TypeSymbol* type_sym = v__table__Table_get_type_symbol(p->table, rec_type);
	...
	/*assign_stmt*/array_v__ast__Stmt stmts = new_array(0, 0, sizeof(v__ast__Stmt));
	/*assign_stmt*/bool no_body = p->tok.kind != v__token__Kind_lcbr;
	if (p->tok.kind == v__token__Kind_lcbr) {
		stmts = v__parser__Parser_parse_block(p);
	}
	v__parser__Parser_close_scope(p);
...
multi_return_array_v__table__Arg_bool v__parser__Parser_fn_args(v__parser__Parser* p) { 
	v__parser__Parser_check(p, v__token__Kind_lpar);
	/*assign_stmt*/array_v__table__Arg args = new_array(0, 0, sizeof(v__table__Arg));
	/*assign_stmt*/bool is_variadic = false;
	/*assign_stmt*/bool types_only = (p->tok.kind == v__token__Kind_amp || p->tok.kind == v__token__Kind_and) || (p->peek_tok.kind == v__token__Kind_comma && v__table__Table_known_type(p->table, p->tok.lit)) || p->peek_tok.kind == v__token__Kind_rpar;
	if (types_only) {
		/*assign_stmt*/int arg_no = 1;
		while (p->tok.kind != v__token__Kind_rpar) {
			/*assign_stmt*/string arg_name = _STR("arg_%d", arg_no);
			/*assign_stmt*/bool is_mut = p->tok.kind == v__token__Kind_key_mut;
			if (is_mut) {
				v__parser__Parser_check(p, v__token__Kind_key_mut);
			}
			...
			/*assign_stmt*/v__table__Type arg_type = v__parser__Parser_parse_type(p);
			if (is_variadic) {
				arg_type = v__table__type_to_variadic(arg_type);
			}
		...
		while (p->tok.kind != v__token__Kind_rpar) {
			/*assign_stmt*/array_string arg_names = new_array_from_c_array(1, 1, sizeof(string), (string[1]){	
			...
			/*assign_stmt*/v__table__Type typ = v__parser__Parser_parse_type(p);
			if (is_variadic) {
				typ = v__table__type_to_variadic(typ);
			}
			// FOR IN
			for (int tmp11 = 0; tmp11 < arg_names.len; tmp11++) {
				string arg_name = ((string*)arg_names.data)[tmp11];
				_PUSH(&args, ((v__table__Arg){
					.name = arg_name,
					.is_mut = is_mut,
					.typ = typ,
...
v__table__Type v__parser__Parser_parse_array_type(v__parser__Parser* p) { 
	...
	if (p->tok.kind == v__token__Kind_number) {
		/*assign_stmt*/int size = string_int(p->tok.lit);
		v__parser__Parser_next(p);
		v__parser__Parser_check(p, v__token__Kind_rsbr);
		/*assign_stmt*/v__table__Type elem_type = v__parser__Parser_parse_type(p);
		/*assign_stmt*/int idx = v__table__Table_find_or_register_array_fixed(p->table, elem_type, size, 1);
		return v__table__new_type(idx);
	}
	v__parser__Parser_check(p, v__token__Kind_rsbr);
	/*assign_stmt*/v__table__Type elem_type = v__parser__Parser_parse_type(p);
	/*assign_stmt*/int nr_dims = 1;
	while (p->tok.kind == v__token__Kind_lsbr) {
		v__parser__Parser_check(p, v__token__Kind_lsbr);
		v__parser__Parser_check(p, v__token__Kind_rsbr);
		nr_dims++;
	}
	/*assign_stmt*/int idx = v__table__Table_find_or_register_array(p->table, elem_type, nr_dims);
	return v__table__new_type(idx);
}
...
v__table__Type v__parser__Parser_parse_map_type(v__parser__Parser* p) { 
	...
	v__parser__Parser_check(p, v__token__Kind_lsbr);
	/*assign_stmt*/v__table__Type key_type = v__parser__Parser_parse_type(p);
	...
	v__parser__Parser_check(p, v__token__Kind_rsbr);
	/*assign_stmt*/v__table__Type value_type = v__parser__Parser_parse_type(p);
	/*assign_stmt*/int idx = v__table__Table_find_or_register_map(p->table, key_type, value_type);
	return v__table__new_type(idx);
}

v__table__Type v__parser__Parser_parse_multi_return_type(v__parser__Parser* p) { 
	v__parser__Parser_check(p, v__token__Kind_lpar);
	/*assign_stmt*/array_v__table__Type mr_types = new_array(0, 0, sizeof(v__table__Type));
	while (1) {
		/*assign_stmt*/v__table__Type mr_type = v__parser__Parser_parse_type(p);
	...
	v__parser__Parser_check(p, v__token__Kind_rpar);
	/*assign_stmt*/int idx = v__table__Table_find_or_register_multi_return(p->table, mr_types);
	return v__table__new_type(idx);
}

v__table__Type v__parser__Parser_parse_fn_type(v__parser__Parser* p, string name) { 
	v__parser__Parser_check(p, v__token__Kind_key_fn);
	/*assign_stmt*/int line_nr = p->tok.line_nr;
	...
	/*assign_stmt*/v__table__Fn func = (v__table__Fn){
		.name = name,
		.args = args,
		.is_variadic = is_variadic,
		.return_type = return_type,
	...
	/*assign_stmt*/int idx = v__table__Table_find_or_register_fn_type(p->table, func, false);
	return v__table__new_type(idx);
}

v__table__Type v__parser__Parser_parse_type(v__parser__Parser* p) { 
	/*assign_stmt*/bool is_optional = false;
	if (p->tok.kind == v__token__Kind_question) {
		v__parser__Parser_next(p);
		is_optional = true;
	}
	/*assign_stmt*/int nr_muls = 0;
	...
	/*assign_stmt*/bool is_c = string_eq(p->tok.lit, tos3("C"));
	if (is_c) {
		v__parser__Parser_next(p);
		v__parser__Parser_check(p, v__token__Kind_dot);
	}
	/*assign_stmt*/v__table__Type typ = v__parser__Parser_parse_any_type(p, is_c, nr_muls > 0);
	if (is_optional) {
		typ = v__table__type_to_optional(typ);
	}
	if (nr_muls > 0) {
...
v__table__Type v__parser__Parser_parse_any_type(v__parser__Parser* p, bool is_c, bool is_ptr) { 
	/*assign_stmt*/string name = p->tok.lit;
	if (is_c) {
		name = _STR("C.%.*s", name.len, name.str);
	...
	if (p->tok.kind == v__token__Kind_key_fn) {
		...
		if (string_eq(name, tos3("voidptr"))) {
			...
			/*assign_stmt*/int idx = v__table__Table_find_type_idx(p->table, name);
			if (idx > 0) {
				// defer
					v__parser__Parser_next(p);
				return v__table__new_type(idx);
...
v__ast__Stmt v__parser__parse_stmt(string text, v__table__Table* table, v__ast__Scope* scope) { 
	/*assign_stmt*/v__scanner__Scanner* s = v__scanner__new_scanner(text, v__scanner__CommentsMode_skip_comments);
	/*assign_stmt*/v__parser__Parser p = (v__parser__Parser){
		.scanner = s,
		.table = table,
...
v__ast__File v__parser__parse_file(string path, v__table__Table* table, v__scanner__CommentsMode comments_mode, v__pref__Preferences* pref) { 
	...
	/*assign_stmt*/v__parser__Parser p = (v__parser__Parser){
		...
		.end_pos = 0,
		.vars = new_map(1, sizeof(v__ast__Var)),
	...
	v__parser__Parser_read_first_token(&p);
	/*assign_stmt*/v__ast__Module module_decl = (p.tok.kind == v__token__Kind_key_module ? v__parser__Parser_module_decl(&p) : (v__ast__Module){
			.name = tos3("main"),
			.path = tos3(""),
			.expr = {0},
		});
...
array_v__ast__File v__parser__parse_files(array_string paths, v__table__Table* table, v__pref__Preferences* pref) { 
	/*assign_stmt*/array_v__ast__File files = new_array(0, 0, sizeof(v__ast__File));
	// FOR IN
	for (int tmp1 = 0; tmp1 < paths.len; tmp1++) {
		string path = ((string*)paths.data)[tmp1];
		_PUSH(&files, (v__parser__parse_file(path, table, v__scanner__CommentsMode_skip_comments, pref)), tmp2, v__ast__File);
	}
	return files;
}
...
array_v__ast__Stmt v__parser__Parser_parse_block(v__parser__Parser* p) { 
	v__parser__Parser_open_scope(p);
	/*assign_stmt*/array_v__ast__Stmt stmts = v__parser__Parser_parse_block_no_scope(p);
	v__parser__Parser_close_scope(p);
	return stmts;
}
...
void v__parser__Parser_check(v__parser__Parser* p, v__token__Kind expected) { 
	if (p->tok.kind != expected) {
		/*assign_stmt*/string s = _STR("syntax error: unexpected `%.*s`, expecting `%.*s`", v__token__Kind_str(p->tok.kind).len, v__token__Kind_str(p->tok.kind).str, v__token__Kind_str(expected).len, v__token__Kind_str(expected).str);
...
v__ast__Stmt v__parser__Parser_top_stmt(v__parser__Parser* p) { 
	if (p->tok.kind == v__token__Kind_key_pub) {
		if (p->peek_tok.kind == v__token__Kind_key_const) {
			return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ConstDecl[]) {v__parser__Parser_const_decl(p)}, sizeof(v__ast__ConstDecl)), .typ = 211 /* v.ast.ConstDecl */};
		}
		...
		else if (p->peek_tok.kind == v__token__Kind_key_struct || p->peek_tok.kind == v__token__Kind_key_union || p->peek_tok.kind == v__token__Kind_key_interface) {
			return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__StructDecl[]) {v__parser__Parser_struct_decl(p)}, sizeof(v__ast__StructDecl)), .typ = 213 /* v.ast.StructDecl */};
		}
		else if (p->peek_tok.kind == v__token__Kind_key_enum) {
			return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__EnumDecl[]) {v__parser__Parser_enum_decl(p)}, sizeof(v__ast__EnumDecl)), .typ = 224 /* v.ast.EnumDecl */};
		}
		else if (p->peek_tok.kind == v__token__Kind_key_type) {
			return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__TypeDecl[]) {v__parser__Parser_type_decl(p)}, sizeof(v__ast__TypeDecl)), .typ = 225 /* v.ast.TypeDecl */};
		}
		else {
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__InterfaceDecl[]) {v__parser__Parser_interface_decl(p)}, sizeof(v__ast__InterfaceDecl)), .typ = 214 /* v.ast.InterfaceDecl */};
	}
	else if (p->tok.kind == v__token__Kind_key_module) {
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__Module[]) {v__parser__Parser_module_decl(p)}, sizeof(v__ast__Module)), .typ = 163 /* v.ast.Module */};
	}
	else if (p->tok.kind == v__token__Kind_key_import) {
		/*assign_stmt*/array_v__ast__Import node = v__parser__Parser_import_stmt(p);
		_PUSH_MANY(&p->ast_imports, (node), tmp3, array_v__ast__Import);
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__Import[]) {(*(v__ast__Import*)array_get(node, 0))}, sizeof(v__ast__Import)), .typ = 160 /* v.ast.Import */};
	}
	else if (p->tok.kind == v__token__Kind_key_global) {
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__GlobalDecl[]) {v__parser__Parser_global_decl(p)}, sizeof(v__ast__GlobalDecl)), .typ = 219 /* v.ast.GlobalDecl */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__CompIf[]) {v__parser__Parser_comp_if(p)}, sizeof(v__ast__CompIf)), .typ = 149 /* v.ast.CompIf */};
	}
	else if (p->tok.kind == v__token__Kind_hash) {
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__HashStmt[]) {v__parser__Parser_hash(p)}, sizeof(v__ast__HashStmt)), .typ = 218 /* v.ast.HashStmt */};
	}
	...
	else if (p->tok.kind == v__token__Kind_line_comment) {
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__LineComment[]) {v__parser__Parser_line_comment(p)}, sizeof(v__ast__LineComment)), .typ = 166 /* v.ast.LineComment */};
	}
	else if (p->tok.kind == v__token__Kind_mline_comment) {
		/*assign_stmt*/string comment = p->tok.lit;
		v__parser__Parser_next(p);
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__MultiLineComment[]) {(v__ast__MultiLineComment){
			.text = comment,
		}}, sizeof(v__ast__MultiLineComment)), .typ = 165 /* v.ast.MultiLineComment */};
	}
	else {
		v__parser__Parser_error(p, string_add(tos3("parser: bad top level statement "), v__token__Token_str(p->tok)));
		return (v__ast__Stmt){
		0};
	}
	;
...
v__ast__LineComment v__parser__Parser_line_comment(v__parser__Parser* p) { 
	/*assign_stmt*/string text = p->tok.lit;
	v__parser__Parser_next(p);
	return (v__ast__LineComment){
		.text = text,
	};
}
...
v__ast__Stmt v__parser__Parser_stmt(v__parser__Parser* p) { 
	if (p->tok.kind == v__token__Kind_lcbr) {
		/*assign_stmt*/array_v__ast__Stmt stmts = v__parser__Parser_parse_block(p);
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__Block[]) {(v__ast__Block){
			.stmts = stmts,
		}}, sizeof(v__ast__Block)), .typ = 167 /* v.ast.Block */};
	}
	else if (p->tok.kind == v__token__Kind_key_assert) {
		v__parser__Parser_next(p);
		/*assign_stmt*/v__ast__Expr expr = v__parser__Parser_expr(p, 0);
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__AssertStmt[]) {(v__ast__AssertStmt){
			.expr = expr,
			.pos = v__token__Token_position(&p->tok),
		}}, sizeof(v__ast__AssertStmt)), .typ = 168 /* v.ast.AssertStmt */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__Return[]) {v__parser__Parser_return_stmt(p)}, sizeof(v__ast__Return)), .typ = 215 /* v.ast.Return */};
	}
	else if (p->tok.kind == v__token__Kind_dollar) {
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__CompIf[]) {v__parser__Parser_comp_if(p)}, sizeof(v__ast__CompIf)), .typ = 149 /* v.ast.CompIf */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__BranchStmt[]) {(v__ast__BranchStmt){
			.tok = tok,
		}}, sizeof(v__ast__BranchStmt)), .typ = 169 /* v.ast.BranchStmt */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__UnsafeStmt[]) {(v__ast__UnsafeStmt){
			.stmts = stmts,
		}}, sizeof(v__ast__UnsafeStmt)), .typ = 170 /* v.ast.UnsafeStmt */};
	}
	else if (p->tok.kind == v__token__Kind_hash) {
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__HashStmt[]) {v__parser__Parser_hash(p)}, sizeof(v__ast__HashStmt)), .typ = 218 /* v.ast.HashStmt */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__DeferStmt[]) {(v__ast__DeferStmt){
			.stmts = stmts,
			.ifdef = tos3(""),
		}}, sizeof(v__ast__DeferStmt)), .typ = 171 /* v.ast.DeferStmt */};
	}
		...
		}}, sizeof(v__ast__GoStmt)), .typ = 172 /* v.ast.GoStmt */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__GotoStmt[]) {(v__ast__GotoStmt){
			.name = name,
		}}, sizeof(v__ast__GotoStmt)), .typ = 173 /* v.ast.GotoStmt */};
	}
	else {
		if (p->tok.kind == v__token__Kind_name && (p->peek_tok.kind == v__token__Kind_decl_assign || p->peek_tok.kind == v__token__Kind_comma)) {
			...
			return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__GotoLabel[]) {(v__ast__GotoLabel){
				.name = name,
			}}, sizeof(v__ast__GotoLabel)), .typ = 174 /* v.ast.GotoLabel */};
		}
		/*assign_stmt*/v__ast__Expr expr = v__parser__Parser_expr(p, 0);
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ExprStmt[]) {(v__ast__ExprStmt){
			.expr = expr,
			.typ = {0},
		}}, sizeof(v__ast__ExprStmt)), .typ = 175 /* v.ast.ExprStmt */};
	}
	;
}

v__ast__AssignExpr v__parser__Parser_assign_expr(v__parser__Parser* p, v__ast__Expr left) { 
	/*assign_stmt*/v__token__Kind op = p->tok.kind;
	v__parser__Parser_next(p);
	/*assign_stmt*/v__ast__Expr val = v__parser__Parser_expr(p, 0);
	/*assign_stmt*/v__ast__AssignExpr node = (v__ast__AssignExpr){
		.left = left,
		.val = val,
		.op = op,
		.pos = v__token__Token_position(&p->tok),
...
void v__parser__Parser_error(v__parser__Parser* p, string s) { 
	print_backtrace();
	/*assign_stmt*/string path = p->file_name;
	/*assign_stmt*/string workdir = string_add(os__getwd(), _const_os__path_separator);
	if (string_starts_with(path, workdir)) {
		path = string_replace(path, workdir, tos3(""));
	}
	/*assign_stmt*/string final_msg_line = _STR("%.*s:%d: error: %.*s", path.len, path.str, p->tok.line_nr, s.len, s.str);
	if (_const_v__parser__colored_output) {
...
void v__parser__Parser_error_at_line(v__parser__Parser* p, string s, int line_nr) { 
	/*assign_stmt*/string final_msg_line = _STR("%.*s:%d: error: %.*s", p->file_name.len, p->file_name.str, line_nr, s.len, s.str);
	if (_const_v__parser__colored_output) {
		eprintln(term__bold(term__red(final_msg_line)));
	} else {
		eprintln(final_msg_line);
...
void v__parser__Parser_warn(v__parser__Parser* p, string s) { 
	/*assign_stmt*/string final_msg_line = _STR("%.*s:%d: warning: %.*s", p->file_name.len, p->file_name.str, p->tok.line_nr, s.len, s.str);
	if (_const_v__parser__colored_output) {
...
v__ast__Ident v__parser__Parser_parse_ident(v__parser__Parser* p, bool is_c) { 
	...
	/*assign_stmt*/v__ast__Ident ident = (v__ast__Ident){
	...
	if (p->expr_mod.len == 0) {
		bool tmp4;
		{ /* if guard */ Option_v__ast__Var var = v__ast__Scope_find_var(p->scope, name);
		if ((tmp4 = var.ok)) {
			...
			ident.info = /* sum type cast */ (v__ast__IdentInfo) {.obj = memdup(&(v__ast__IdentVar[]) {(v__ast__IdentVar){
				...
				.is_static = 0,
				.is_optional = 0,
			}}, sizeof(v__ast__IdentVar)), .typ = 180 /* v.ast.IdentVar */};
		}}
	}
	return ident;
}
...
v__ast__StructInit v__parser__Parser_struct_init(v__parser__Parser* p, bool short_syntax) { 
	/*assign_stmt*/v__table__Type typ = (short_syntax ? _const_v__table__void_type : v__parser__Parser_parse_type(p));
	p->expr_mod = tos3("");
	if (!short_syntax) {
		v__parser__Parser_check(p, v__token__Kind_lcbr);
	}
	/*assign_stmt*/array_string field_names = new_array(0, 0, sizeof(string));
	/*assign_stmt*/array_v__ast__Expr exprs = new_array(0, 0, sizeof(v__ast__Expr));
	/*assign_stmt*/int i = 0;
	/*assign_stmt*/bool is_short_syntax = !(p->peek_tok.kind == v__token__Kind_colon || p->tok.kind == v__token__Kind_rcbr);
	while (p->tok.kind != v__token__Kind_rcbr) {
		/*assign_stmt*/string field_name = tos3("");
		if (is_short_syntax) {
			/*assign_stmt*/v__ast__Expr expr = v__parser__Parser_expr(p, 0);
	...
	/*assign_stmt*/v__ast__StructInit node = (v__ast__StructInit){
		.typ = typ,
		.exprs = exprs,
		.fields = field_names,
		.pos = v__token__Token_position(&p->tok),
...
v__ast__Expr v__parser__Parser_name_expr(v__parser__Parser* p) { 
	/*assign_stmt*/v__ast__Expr node = (v__ast__Expr){
	0};
	/*assign_stmt*/bool is_c = string_eq(p->tok.lit, tos3("C"));
	/*assign_stmt*/string mod = tos3("");
	p->expr_mod = tos3("");
	if (string_eq(p->tok.lit, tos3("map")) && p->peek_tok.kind == v__token__Kind_lsbr) {
		/*assign_stmt*/v__table__Type map_type = v__parser__Parser_parse_map_type(p);
		return /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__MapInit[]) {(v__ast__MapInit){
			...
			.key_type = {0},
			.value_type = {0},
		}}, sizeof(v__ast__MapInit)), .typ = 183 /* v.ast.MapInit */};
	}
	...
	/*assign_stmt*/bool known_var = v__ast__Scope_known_var(p->scope, p->tok.lit);
	...
	if (p->peek_tok.kind == v__token__Kind_lpar) {
		...
		/*assign_stmt*/string name_w_mod = v__parser__Parser_prepend_mod(p, name);
		if ((_IN_MAP(name, p->table->type_idxs) || _IN_MAP(name_w_mod, p->table->type_idxs)) && !((string_eq(name, tos3("C.stat")) || string_eq(name, tos3("C.sigaction"))))) {
			/*assign_stmt*/v__table__Type to_typ = v__parser__Parser_parse_type(p);
			if (p->is_amp) {
				to_typ = v__table__type_to_ptr(to_typ);
			}
			v__parser__Parser_check(p, v__token__Kind_lpar);
			/*assign_stmt*/v__ast__Expr expr = (v__ast__Expr){
			0};
			/*assign_stmt*/v__ast__Expr arg = (v__ast__Expr){
			0};
			/*assign_stmt*/bool has_arg = false;
			expr = v__parser__Parser_expr(p, 0);
			...
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__CastExpr[]) {(v__ast__CastExpr){
				...
				.has_arg = has_arg,
				.expr_type = {0},
			}}, sizeof(v__ast__CastExpr)), .typ = 184 /* v.ast.CastExpr */};
			p->expr_mod = tos3("");
			return node;
		} else {
			/*assign_stmt*/v__ast__CallExpr x = v__parser__Parser_call_expr(p, is_c, mod);
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__CallExpr[]) {x}, sizeof(v__ast__CallExpr)), .typ = 150 /* v.ast.CallExpr */};
		}
	} else if (p->peek_tok.kind == v__token__Kind_lcbr && (byte_is_capital(string_at(p->tok.lit, 0)) || is_c || (p->builtin_mod && _IN(string, p->tok.lit, _const_v__table__builtin_type_names))) && (p->tok.lit.len == 1 || !byte_is_capital(string_at(p->tok.lit, p->tok.lit.len - 1)))) {
		return /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__StructInit[]) {v__parser__Parser_struct_init(p, false)}, sizeof(v__ast__StructInit)), .typ = 181 /* v.ast.StructInit */};
	} else if (p->peek_tok.kind == v__token__Kind_dot && (byte_is_capital(string_at(p->tok.lit, 0)) && !known_var)) {
		/*assign_stmt*/string enum_name = v__parser__Parser_check_name(p);
		...
		return /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__EnumVal[]) {(v__ast__EnumVal){
			...
			.mod = mod,
			.typ = {0},
		}}, sizeof(v__ast__EnumVal)), .typ = 185 /* v.ast.EnumVal */};
	} else {
		/*assign_stmt*/v__ast__Ident ident = (v__ast__Ident){
			.value = tos3(""),
			.is_c = 0,
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Ident[]) {ident}, sizeof(v__ast__Ident)), .typ = 179 /* v.ast.Ident */};
	}
	p->expr_mod = tos3("");
	return node;
}
...
v__ast__Expr v__parser__Parser_expr(v__parser__Parser* p, int precedence) { 
	/*assign_stmt*/v__table__Type typ = _const_v__table__void_type;
	/*assign_stmt*/v__ast__Expr node = (v__ast__Expr){
	0};
	if (p->tok.kind == v__token__Kind_name) {
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__EnumVal[]) {v__parser__Parser_enum_val(p)}, sizeof(v__ast__EnumVal)), .typ = 185 /* v.ast.EnumVal */};
	}
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__CharLiteral[]) {(v__ast__CharLiteral){
			.val = p->tok.lit,
		}}, sizeof(v__ast__CharLiteral)), .typ = 186 /* v.ast.CharLiteral */};
		v__parser__Parser_next(p);
	}
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__PrefixExpr[]) {v__parser__Parser_prefix_expr(p)}, sizeof(v__ast__PrefixExpr)), .typ = 195 /* v.ast.PrefixExpr */};
	}
		...
		}}, sizeof(v__ast__BoolLiteral)), .typ = 187 /* v.ast.BoolLiteral */};
		v__parser__Parser_next(p);
	}
	else if (p->tok.kind == v__token__Kind_key_match) {
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__MatchExpr[]) {v__parser__Parser_match_expr(p)}, sizeof(v__ast__MatchExpr)), .typ = 220 /* v.ast.MatchExpr */};
	}
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__ParExpr[]) {(v__ast__ParExpr){
			.expr = node,
		}}, sizeof(v__ast__ParExpr)), .typ = 188 /* v.ast.ParExpr */};
	}
	else if (p->tok.kind == v__token__Kind_key_if) {
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__IfExpr[]) {v__parser__Parser_if_expr(p)}, sizeof(v__ast__IfExpr)), .typ = 202 /* v.ast.IfExpr */};
	}
	else if (p->tok.kind == v__token__Kind_lsbr) {
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__ArrayInit[]) {v__parser__Parser_array_init(p)}, sizeof(v__ast__ArrayInit)), .typ = 208 /* v.ast.ArrayInit */};
	}
	else if (p->tok.kind == v__token__Kind_key_none) {
		v__parser__Parser_next(p);
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__None[]) {(v__ast__None){
			.foo = 0,
		}}, sizeof(v__ast__None)), .typ = 189 /* v.ast.None */};
	}
		...
		/*assign_stmt*/v__table__Type sizeof_type = v__parser__Parser_parse_type(p);
		v__parser__Parser_check(p, v__token__Kind_rpar);
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__SizeOf[]) {(v__ast__SizeOf){
			.typ = sizeof_type,
			.type_name = tos3(""),
		}}, sizeof(v__ast__SizeOf)), .typ = 190 /* v.ast.SizeOf */};
	}
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__TypeOf[]) {(v__ast__TypeOf){
			.expr = expr,
			.expr_type = {0},
		}}, sizeof(v__ast__TypeOf)), .typ = 191 /* v.ast.TypeOf */};
	}
	else if (p->tok.kind == v__token__Kind_lcbr) {
		v__parser__Parser_next(p);
		if (p->tok.kind == v__token__Kind_string) {
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__MapInit[]) {v__parser__Parser_map_init(p)}, sizeof(v__ast__MapInit)), .typ = 183 /* v.ast.MapInit */};
		} else {
			if (p->peek_tok.kind == v__token__Kind_pipe) {
				node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Assoc[]) {v__parser__Parser_assoc(p)}, sizeof(v__ast__Assoc)), .typ = 229 /* v.ast.Assoc */};
			} else if (p->peek_tok.kind == v__token__Kind_colon || p->tok.kind == v__token__Kind_rcbr) {
				node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__StructInit[]) {v__parser__Parser_struct_init(p, true)}, sizeof(v__ast__StructInit)), .typ = 181 /* v.ast.StructInit */};
			} else {
		...
		v__parser__Parser_error(p, _STR("parser: expr(): bad token `%.*s`", v__token__Token_str(p->tok).len, v__token__Token_str(p->tok).str));
	}
	;
	while (precedence < v__token__Token_precedence(p->tok)) {
		if (v__token__Kind_is_assign(p->tok.kind)) {
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__AssignExpr[]) {v__parser__Parser_assign_expr(p, node)}, sizeof(v__ast__AssignExpr)), .typ = 177 /* v.ast.AssignExpr */};
		} else if (p->tok.kind == v__token__Kind_dot) {
			node = v__parser__Parser_dot_expr(p, node);
		} else if (p->tok.kind == v__token__Kind_lsbr) {
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__IndexExpr[]) {v__parser__Parser_index_expr(p, node)}, sizeof(v__ast__IndexExpr)), .typ = 196 /* v.ast.IndexExpr */};
			...
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__AsCast[]) {(v__ast__AsCast){
				...
				.pos = pos,
				.expr_type = {0},
			}}, sizeof(v__ast__AsCast)), .typ = 192 /* v.ast.AsCast */};
		} else if (p->tok.kind == v__token__Kind_left_shift) {
			/*assign_stmt*/v__token__Token tok = p->tok;
			v__parser__Parser_next(p);
			/*assign_stmt*/v__ast__Expr right = v__parser__Parser_expr(p, precedence - 1);
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__InfixExpr[]) {(v__ast__InfixExpr){
				...
				.left_type = {0},
				.right_type = {0},
			}}, sizeof(v__ast__InfixExpr)), .typ = 193 /* v.ast.InfixExpr */};
			...
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__PostfixExpr[]) {(v__ast__PostfixExpr){
				...
				.expr = node,
				.pos = v__token__Token_position(&p->tok),
			}}, sizeof(v__ast__PostfixExpr)), .typ = 194 /* v.ast.PostfixExpr */};
			v__parser__Parser_next(p);
		} else {
			return node;
		}
...
v__ast__PrefixExpr v__parser__Parser_prefix_expr(v__parser__Parser* p) { 
	...
	v__parser__Parser_next(p);
	/*assign_stmt*/v__ast__Expr right = v__parser__Parser_expr(p, 1);
	p->is_amp = false;
...
v__ast__IndexExpr v__parser__Parser_index_expr(v__parser__Parser* p, v__ast__Expr left) { 
	v__parser__Parser_next(p);
	/*assign_stmt*/bool has_low = true;
	if (p->tok.kind == v__token__Kind_dotdot) {
		has_low = false;
		v__parser__Parser_next(p);
		/*assign_stmt*/v__ast__Expr high = v__parser__Parser_expr(p, 0);
		v__parser__Parser_check(p, v__token__Kind_rsbr);
		...
		0},
			...
			.has_high = true,
			.has_low = 0,
		}}, sizeof(v__ast__RangeExpr)), .typ = 197 /* v.ast.RangeExpr */},
			.container_type = {0},
		};
	}
	/*assign_stmt*/v__ast__Expr expr = v__parser__Parser_expr(p, 0);
	/*assign_stmt*/bool has_high = false;
	if (p->tok.kind == v__token__Kind_dotdot) {
		v__parser__Parser_check(p, v__token__Kind_dotdot);
		/*assign_stmt*/v__ast__Expr high = (v__ast__Expr){
		0};
...
v__ast__Expr v__parser__Parser_dot_expr(v__parser__Parser* p, v__ast__Expr left) { 
	v__parser__Parser_next(p);
	/*assign_stmt*/string field_name = v__parser__Parser_check_name(p);
	/*assign_stmt*/bool is_filter = (string_eq(field_name, tos3("filter")) || string_eq(field_name, tos3("map")));
	if (is_filter) {
		v__parser__Parser_open_scope(p);
	...
	if (p->tok.kind == v__token__Kind_lpar) {
		...
		/*assign_stmt*/v__ast__CallExpr mcall_expr = (v__ast__CallExpr){
			.left = left,
			.name = field_name,
			.args = args,
			.pos = pos,
		...
		/*assign_stmt*/v__ast__Expr node = (v__ast__Expr){
		0};
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__CallExpr[]) {mcall_expr}, sizeof(v__ast__CallExpr)), .typ = 150 /* v.ast.CallExpr */};
		if (is_filter) {
			v__parser__Parser_close_scope(p);
		}
		return node;
	}
	/*assign_stmt*/v__ast__SelectorExpr sel_expr = (v__ast__SelectorExpr){
		.expr = left,
		.field = field_name,
		.pos = v__token__Token_position(&p->tok),
		.expr_type = {0},
	...
	/*assign_stmt*/v__ast__Expr node = (v__ast__Expr){
	0};
	node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__SelectorExpr[]) {sel_expr}, sizeof(v__ast__SelectorExpr)), .typ = 198 /* v.ast.SelectorExpr */};
	if (is_filter) {
		v__parser__Parser_close_scope(p);
	}
	return node;
...
v__ast__Expr v__parser__Parser_infix_expr(v__parser__Parser* p, v__ast__Expr left) { 
	/*assign_stmt*/v__token__Kind op = p->tok.kind;
	/*assign_stmt*/int precedence = v__token__Token_precedence(p->tok);
	/*assign_stmt*/v__token__Position pos = v__token__Token_position(&p->tok);
	v__parser__Parser_next(p);
	/*assign_stmt*/v__ast__Expr right = (v__ast__Expr){
	0};
...
v__ast__Stmt v__parser__Parser_for_statement(v__parser__Parser* p) { 
	...
	if (p->tok.kind == v__token__Kind_lcbr) {
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ForStmt[]) {(v__ast__ForStmt){
			...
			.is_inf = true,
			.cond = {0},
		}}, sizeof(v__ast__ForStmt)), .typ = 199 /* v.ast.ForStmt */};
		...
		/*assign_stmt*/v__ast__Stmt init = (v__ast__Stmt){
		0};
		/*assign_stmt*/v__ast__Expr cond = v__parser__Parser_new_true_expr(p);
		/*assign_stmt*/v__ast__Expr inc = (v__ast__Expr){
		0};
		/*assign_stmt*/bool has_init = false;
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ForCStmt[]) {(v__ast__ForCStmt){
			...
			.inc = inc,
			.pos = pos,
		}}, sizeof(v__ast__ForCStmt)), .typ = 200 /* v.ast.ForCStmt */};
	} else if ((p->peek_tok.kind == v__token__Kind_key_in || p->peek_tok.kind == v__token__Kind_comma)) {
		/*assign_stmt*/string key_var_name = tos3("");
		/*assign_stmt*/string val_var_name = v__parser__Parser_check_name(p);
		if (p->tok.kind == v__token__Kind_comma) {
			v__parser__Parser_check(p, v__token__Kind_comma);
		...
		/*assign_stmt*/v__ast__Expr cond = v__parser__Parser_expr(p, 0);
		/*assign_stmt*/v__ast__Expr high_expr = (v__ast__Expr){
		0};
		/*assign_stmt*/bool is_range = false;
		if (p->tok.kind == v__token__Kind_dotdot) {
			is_range = true;
			v__parser__Parser_check(p, v__token__Kind_dotdot);
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ForInStmt[]) {(v__ast__ForInStmt){
			...
			.cond_type = {0},
			.kind = {0},
		}}, sizeof(v__ast__ForInStmt)), .typ = 201 /* v.ast.ForInStmt */};
	}
	/*assign_stmt*/v__ast__Expr cond = v__parser__Parser_expr(p, 0);
	/*assign_stmt*/array_v__ast__Stmt stmts = v__parser__Parser_parse_block(p);
	v__parser__Parser_close_scope(p);
...
v__ast__IfExpr v__parser__Parser_if_expr(v__parser__Parser* p) { 
	p->inside_if = true;
	/*assign_stmt*/v__token__Position pos = v__token__Token_position(&p->tok);
	/*assign_stmt*/array_v__ast__IfBranch branches = new_array(0, 0, sizeof(v__ast__IfBranch));
	/*assign_stmt*/bool has_else = false;
	while ((p->tok.kind == v__token__Kind_key_if || p->tok.kind == v__token__Kind_key_else)) {
		/*assign_stmt*/v__token__Position branch_pos = v__token__Token_position(&p->tok);
		if (p->tok.kind == v__token__Kind_key_if) {
			v__parser__Parser_check(p, v__token__Kind_key_if);
		} else {
			v__parser__Parser_check(p, v__token__Kind_key_else);
		...
		/*assign_stmt*/v__ast__Expr cond = (v__ast__Expr){
		0};
		/*assign_stmt*/bool is_or = false;
		if (p->peek_tok.kind == v__token__Kind_decl_assign) {
			is_or = true;
			v__parser__Parser_open_scope(p);
			/*assign_stmt*/string var_name = v__parser__Parser_check_name(p);
			...
			cond = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__IfGuardExpr[]) {(v__ast__IfGuardExpr){
				...
				.expr = expr,
				.expr_type = {0},
			}}, sizeof(v__ast__IfGuardExpr)), .typ = 205 /* v.ast.IfGuardExpr */};
		} else {
			cond = v__parser__Parser_expr(p, 0);
		}
		p->inside_if = false;
...
v__ast__Expr v__parser__Parser_string_expr(v__parser__Parser* p) { 
	/*assign_stmt*/bool is_raw = p->tok.kind == v__token__Kind_name && string_eq(p->tok.lit, tos3("r"));
	/*assign_stmt*/bool is_cstr = p->tok.kind == v__token__Kind_name && string_eq(p->tok.lit, tos3("c"));
	if (is_raw || is_cstr) {
		v__parser__Parser_next(p);
	}
	/*assign_stmt*/v__ast__Expr node = (v__ast__Expr){
	0};
	/*assign_stmt*/string val = p->tok.lit;
	node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__StringLiteral[]) {(v__ast__StringLiteral){
		.val = val,
		.is_raw = is_raw,
		.is_c = is_cstr,
	}}, sizeof(v__ast__StringLiteral)), .typ = 206 /* v.ast.StringLiteral */};
	if (p->peek_tok.kind != v__token__Kind_str_dollar) {
		v__parser__Parser_next(p);
		return node;
	}
	/*assign_stmt*/array_v__ast__Expr exprs = new_array(0, 0, sizeof(v__ast__Expr));
	/*assign_stmt*/array_string vals = new_array(0, 0, sizeof(string));
	/*assign_stmt*/array_string efmts = new_array(0, 0, sizeof(string));
	while (p->tok.kind == v__token__Kind_string) {
		...
		/*assign_stmt*/array_string efmt = new_array(0, 0, sizeof(string));
	...
	node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__StringInterLiteral[]) {(v__ast__StringInterLiteral){
		...
		.expr_fmts = efmts,
		.expr_types = new_array(0, 1, sizeof(v__table__Type)),
	}}, sizeof(v__ast__StringInterLiteral)), .typ = 207 /* v.ast.StringInterLiteral */};
	return node;
}

v__ast__ArrayInit v__parser__Parser_array_init(v__parser__Parser* p) { 
	v__parser__Parser_check(p, v__token__Kind_lsbr);
	/*assign_stmt*/v__table__Type array_type = _const_v__table__void_type;
	/*assign_stmt*/v__table__Type elem_type = _const_v__table__void_type;
	/*assign_stmt*/array_v__ast__Expr exprs = new_array(0, 0, sizeof(v__ast__Expr));
	if (p->tok.kind == v__token__Kind_rsbr) {
		/*assign_stmt*/int line_nr = p->tok.line_nr;
		v__parser__Parser_check(p, v__token__Kind_rsbr);
		if ((p->tok.kind == v__token__Kind_name || p->tok.kind == v__token__Kind_amp) && p->tok.line_nr == line_nr) {
			...
			/*assign_stmt*/int idx = v__table__Table_find_or_register_array(p->table, elem_type, 1);
...
v__ast__MapInit v__parser__Parser_map_init(v__parser__Parser* p) { 
	/*assign_stmt*/v__token__Position pos = v__token__Token_position(&p->tok);
	/*assign_stmt*/array_v__ast__Expr keys = new_array(0, 0, sizeof(v__ast__Expr));
	/*assign_stmt*/array_v__ast__Expr vals = new_array(0, 0, sizeof(v__ast__Expr));
	while (p->tok.kind != v__token__Kind_rcbr && p->tok.kind != v__token__Kind_eof) {
		/*assign_stmt*/v__ast__Expr key = v__parser__Parser_expr(p, 0);
...
v__ast__Module v__parser__Parser_module_decl(v__parser__Parser* p) { 
	...
	/*assign_stmt*/string mod = v__parser__Parser_check_name(p);
	/*assign_stmt*/string full_mod = v__table__Table_qualify_module(p->table, mod, p->file_name);
	p->mod = full_mod;
...
v__ast__Import v__parser__Parser_parse_import(v__parser__Parser* p) { 
	/*assign_stmt*/v__token__Position pos = v__token__Token_position(&p->tok);
	/*assign_stmt*/string mod_name = v__parser__Parser_check_name(p);
	/*assign_stmt*/string mod_alias = mod_name;
	while (p->tok.kind == v__token__Kind_dot) {
		v__parser__Parser_check(p, v__token__Kind_dot);
		/*assign_stmt*/string submod_name = v__parser__Parser_check_name(p);
...
array_v__ast__Import v__parser__Parser_import_stmt(v__parser__Parser* p) { 
	...
	/*assign_stmt*/array_v__ast__Import imports = new_array(0, 0, sizeof(v__ast__Import));
	if (p->tok.kind == v__token__Kind_lpar) {
		v__parser__Parser_check(p, v__token__Kind_lpar);
		while (p->tok.kind != v__token__Kind_rpar) {
		...
		_PUSH(&imports, (v__parser__Parser_parse_import(p)), tmp3, v__ast__Import);
	}
	return imports;
}
...
v__ast__ConstDecl v__parser__Parser_const_decl(v__parser__Parser* p) { 
	...
	v__parser__Parser_check(p, v__token__Kind_lpar);
	/*assign_stmt*/array_v__ast__Field fields = new_array(0, 0, sizeof(v__ast__Field));
	/*assign_stmt*/array_v__ast__Expr exprs = new_array(0, 0, sizeof(v__ast__Expr));
	while (p->tok.kind != v__token__Kind_rpar) {
		/*assign_stmt*/string name = v__parser__Parser_prepend_mod(p, v__parser__Parser_check_name(p));
		v__parser__Parser_check(p, v__token__Kind_assign);
		/*assign_stmt*/v__ast__Expr expr = v__parser__Parser_expr(p, 0);
		_PUSH(&fields, ((v__ast__Field){
			.name = name,
			.typ = {0},
		}), tmp2, v__ast__Field);
		_PUSH(&exprs, (expr), tmp3, v__ast__Expr);
...
v__ast__StructDecl v__parser__Parser_struct_decl(v__parser__Parser* p) { 
	...
	/*assign_stmt*/bool is_c = string_eq(p->tok.lit, tos3("C")) && p->peek_tok.kind == v__token__Kind_dot;
	if (is_c) {
		v__parser__Parser_next(p);
		v__parser__Parser_next(p);
	}
	/*assign_stmt*/string name = v__parser__Parser_check_name(p);
	/*assign_stmt*/array_v__ast__Expr default_exprs = new_array(0, 0, sizeof(v__ast__Expr));
	v__parser__Parser_check(p, v__token__Kind_lcbr);
	/*assign_stmt*/array_v__ast__Field ast_fields = new_array(0, 0, sizeof(v__ast__Field));
	/*assign_stmt*/array_v__table__Field fields = new_array(0, 0, sizeof(v__table__Field));
	/*assign_stmt*/int mut_pos = -1;
	/*assign_stmt*/int pub_pos = -1;
	/*assign_stmt*/int pub_mut_pos = -1;
	while (p->tok.kind != v__token__Kind_rcbr) {
		if (p->tok.kind == v__token__Kind_key_pub) {
		...
		if (p->tok.kind == v__token__Kind_assign) {
			v__parser__Parser_next(p);
			_PUSH(&default_exprs, (v__parser__Parser_expr(p, 0)), tmp7, v__ast__Expr);
		}
		_PUSH(&ast_fields, ((v__ast__Field){
			.name = field_name,
			.typ = typ,
		}), tmp8, v__ast__Field);
	...
	/*assign_stmt*/v__table__TypeSymbol t = (v__table__TypeSymbol){
...
v__ast__InterfaceDecl v__parser__Parser_interface_decl(v__parser__Parser* p) { 
	...
	v__parser__Parser_next(p);
	/*assign_stmt*/string interface_name = v__parser__Parser_check_name(p);
	v__parser__Parser_check(p, v__token__Kind_lcbr);
	/*assign_stmt*/array_string field_names = new_array(0, 0, sizeof(string));
	while (p->tok.kind != v__token__Kind_rcbr && p->tok.kind != v__token__Kind_eof) {
		/*assign_stmt*/int line_nr = p->tok.line_nr;
...
v__ast__Return v__parser__Parser_return_stmt(v__parser__Parser* p) { 
	...
	/*assign_stmt*/v__ast__Return stmt = (v__ast__Return){
		.exprs = exprs,
		.pos = v__token__Token_position(&p->tok),
		.types = new_array(0, 1, sizeof(v__table__Type)),
	};
...
array_v__ast__Ident v__parser__Parser_parse_assign_lhs(v__parser__Parser* p) { 
	/*assign_stmt*/array_v__ast__Ident idents = new_array(0, 0, sizeof(v__ast__Ident));
	while (1) {
		/*assign_stmt*/bool is_mut = p->tok.kind == v__token__Kind_key_mut;
		if (is_mut) {
			v__parser__Parser_check(p, v__token__Kind_key_mut);
		}
		/*assign_stmt*/bool is_static = p->tok.kind == v__token__Kind_key_static;
		if (is_static) {
			v__parser__Parser_check(p, v__token__Kind_key_static);
		}
		/*assign_stmt*/v__ast__Ident ident = v__parser__Parser_parse_ident(p, false);
		ident.info = /* sum type cast */ (v__ast__IdentInfo) {.obj = memdup(&(v__ast__IdentVar[]) {(v__ast__IdentVar){
			.is_mut = is_mut,
			.is_static = is_static,
			.typ = {0},
...
v__ast__Stmt v__parser__Parser_assign_stmt(v__parser__Parser* p) { 
	...
	/*assign_stmt*/array_v__ast__Ident idents = v__parser__Parser_parse_assign_lhs(p);
	/*assign_stmt*/v__token__Position pos = v__token__Token_position(&p->tok);
	/*assign_stmt*/v__token__Kind op = p->tok.kind;
	v__parser__Parser_next(p);
	/*assign_stmt*/array_v__ast__Expr exprs = v__parser__Parser_parse_assign_rhs(p);
	/*assign_stmt*/bool is_decl = op == v__token__Kind_decl_assign;
	// FOR IN
	for (int i = 0; i < idents.len; i++) {
		v__ast__Ident ident = ((v__ast__Ident*)idents.data)[i];
		/*assign_stmt*/bool known_var = v__ast__Scope_known_var(p->scope, ident.name);
	...
	}}, sizeof(v__ast__AssignStmt)), .typ = 217 /* v.ast.AssignStmt */};
}
...
v__ast__GlobalDecl v__parser__Parser_global_decl(v__parser__Parser* p) { 
	...
	v__table__Table_register_global(p->table, name, typ);
	return (v__ast__GlobalDecl){
		.name = name,
		.typ = typ,
		.expr = {0},
	};
...
v__ast__MatchExpr v__parser__Parser_match_expr(v__parser__Parser* p) { 
	...
	/*assign_stmt*/v__token__Position pos = v__token__Token_position(&p->tok);
	/*assign_stmt*/bool is_mut = p->tok.kind == v__token__Kind_key_mut;
	/*assign_stmt*/bool is_sum_type = false;
	if (is_mut) {
		v__parser__Parser_next(p);
	}
	/*assign_stmt*/v__ast__Expr cond = v__parser__Parser_expr(p, 0);
	v__parser__Parser_check(p, v__token__Kind_lcbr);
	/*assign_stmt*/array_v__ast__MatchBranch branches = new_array(0, 0, sizeof(v__ast__MatchBranch));
	while (1) {
		/*assign_stmt*/array_v__ast__Expr exprs = new_array(0, 0, sizeof(v__ast__Expr));
		/*assign_stmt*/v__token__Position branch_pos = v__token__Token_position(&p->tok);
		v__parser__Parser_open_scope(p);
		if (p->tok.kind == v__token__Kind_key_else) {
			...
			/*assign_stmt*/v__table__Type typ = v__parser__Parser_parse_type(p);
			/*assign_stmt*/v__ast__Type x = (v__ast__Type){
				.typ = typ,
			};
			/*assign_stmt*/v__ast__Expr expr = (v__ast__Expr){
			0};
			expr = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Type[]) {x}, sizeof(v__ast__Type)), .typ = 223 /* v.ast.Type */};
			_PUSH(&exprs, (expr), tmp3, v__ast__Expr);
			v__ast__Scope_register_var(p->scope, (v__ast__Var){
				.name = tos3("it"),
...
v__ast__EnumDecl v__parser__Parser_enum_decl(v__parser__Parser* p) { 
	...
	v__table__Table_register_type_symbol(p->table, (v__table__TypeSymbol){
		...
		.vals = vals,
	}}, sizeof(v__table__Enum)), .typ = 103 /* v.table.Enum */},
		.parent_idx = 0,
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	});
...
v__ast__TypeDecl v__parser__Parser_type_decl(v__parser__Parser* p) { 
	...
	/*assign_stmt*/string name = v__parser__Parser_check_name(p);
	/*assign_stmt*/array_v__table__Type sum_variants = new_array(0, 0, sizeof(v__table__Type));
	if (p->tok.kind == v__token__Kind_assign) {
		v__parser__Parser_next(p);
		while (1) {
			/*assign_stmt*/v__table__Type variant_type = v__parser__Parser_parse_type(p);
		...
		}}, sizeof(v__table__SumType)), .typ = 104 /* v.table.SumType */},
			.parent_idx = 0,
			.methods = new_array(0, 1, sizeof(v__table__Fn)),
		});
		...
		}}, sizeof(v__ast__SumTypeDecl)), .typ = 226 /* v.ast.SumTypeDecl */};
	}
	if (p->tok.kind == v__token__Kind_key_fn) {
		/*assign_stmt*/string fn_name = v__parser__Parser_prepend_mod(p, name);
		/*assign_stmt*/v__table__Type fn_type = v__parser__Parser_parse_fn_type(p, fn_name);
		return /* sum type cast */ (v__ast__TypeDecl) {.obj = memdup(&(v__ast__FnTypeDecl[]) {(v__ast__FnTypeDecl){
			.name = fn_name,
			.is_pub = is_pub,
			.typ = fn_type,
		}}, sizeof(v__ast__FnTypeDecl)), .typ = 227 /* v.ast.FnTypeDecl */};
	}
	/*assign_stmt*/v__table__Type parent_type = v__parser__Parser_parse_type(p);
	/*assign_stmt*/int pid = v__table__type_idx(parent_type);
	v__table__Table_register_type_symbol(p->table, (v__table__TypeSymbol){
		.kind = v__table__Kind_alias,
		.name = v__parser__Parser_prepend_mod(p, name),
		.parent_idx = pid,
		...
		.foo = tos3(""),
	}}, sizeof(v__table__Alias)), .typ = 102 /* v.table.Alias */},
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	});
	...
	}}, sizeof(v__ast__AliasTypeDecl)), .typ = 228 /* v.ast.AliasTypeDecl */};
}

v__ast__Assoc v__parser__Parser_assoc(v__parser__Parser* p) { 
	/*assign_stmt*/string var_name = v__parser__Parser_check_name(p);
	/*assign_stmt*/v__token__Position pos = v__token__Token_position(&p->tok);
	/*assign_stmt*/Option_v__ast__Var var = v__ast__Scope_find_var(p->scope, var_name);
	if (!var.ok) {
	...
	/*assign_stmt*/array_string fields = new_array(0, 0, sizeof(string));
	/*assign_stmt*/array_v__ast__Expr vals = new_array(0, 0, sizeof(v__ast__Expr));
	v__parser__Parser_check(p, v__token__Kind_pipe);
	while (1) {
...
// TypeDecl
v__ast__IdentVar v__ast__Ident_var_info(v__ast__Ident* i) { 
	if (i->info.typ == 180 /* v.ast.IdentVar */) {
...
//[inline]
bool v__ast__expr_is_call(v__ast__Expr expr) { 
	return (expr.typ == 150 /* v.ast.CallExpr */) ? true : false;
}
...
Option_multi_return_v__ast__Scope_v__ast__Var v__ast__Scope_find_scope_and_var(v__ast__Scope* s, string name) { 
	if (_IN_MAP(name, s->vars)) {
		return opt_ok(& (multi_return_v__ast__Scope_v__ast__Var []) { (multi_return_v__ast__Scope_v__ast__Var){.arg0=s,.arg1=(*(v__ast__Var*)map_get3(s->vars, name, &(v__ast__Var[]){ {0} }))} }, sizeof(multi_return_v__ast__Scope_v__ast__Var));
	}
	for (/*assign_stmt*/v__ast__Scope* sc = s;
	!isnil(sc->parent); sc = sc->parent) {
		if (_IN_MAP(name, sc->vars)) {
			return opt_ok(& (multi_return_v__ast__Scope_v__ast__Var []) { (multi_return_v__ast__Scope_v__ast__Var){.arg0=sc,.arg1=(*(v__ast__Var*)map_get3(sc->vars, name, &(v__ast__Var[]){ {0} }))} }, sizeof(multi_return_v__ast__Scope_v__ast__Var));
		}
	}
	return opt_none();
}
...
Option_v__ast__Var v__ast__Scope_find_var(v__ast__Scope* s, string name) { 
	if (_IN_MAP(name, s->vars)) {
		return opt_ok(& (v__ast__Var []) { (*(v__ast__Var*)map_get3(s->vars, name, &(v__ast__Var[]){ {0} })) }, sizeof(v__ast__Var));
	}
	for (/*assign_stmt*/v__ast__Scope* sc = s;
	!isnil(sc->parent); sc = sc->parent) {
		if (_IN_MAP(name, sc->vars)) {
			return opt_ok(& (v__ast__Var []) { (*(v__ast__Var*)map_get3(sc->vars, name, &(v__ast__Var[]){ {0} })) }, sizeof(v__ast__Var));
		}
	}
	return opt_none();
}
...
void v__ast__Scope_register_var(v__ast__Scope* s, v__ast__Var var) { 
	bool tmp1;
	{ /* if guard */ Option_v__ast__Var x = v__ast__Scope_find_var(s, var.name);
	if ((tmp1 = x.ok)) {
		return;
	}}
	map_set(&s->vars, var.name, &(v__ast__Var[]) { var });
}
...
void v__ast__Scope_update_var_type(v__ast__Scope* s, string name, v__table__Type typ) { 
	/*assign_stmt*/v__ast__Var x = (*(v__ast__Var*)map_get3(s->vars, name, &(v__ast__Var[]){ {0} }));
	if (x.typ == typ) {
		return;
	}
	x.typ = typ;
	map_set(&s->vars, name, &(v__ast__Var[]) { x });
}

v__ast__Scope* v__ast__Scope_outermost(v__ast__Scope* s) { 
	/*assign_stmt*/v__ast__Scope* sc = s;
...
v__ast__Scope* v__ast__Scope_innermost(v__ast__Scope* s, int pos) { 
	if (v__ast__Scope_contains(s, pos)) {
		/*assign_stmt*/int first = 0;
		/*assign_stmt*/int last = s->children.len - 1;
		/*assign_stmt*/int middle = last / 2;
		while (first <= last) {
			/*assign_stmt*/v__ast__Scope* s1 = (*(v__ast__Scope**)array_get(s->children, middle));
			if (s1->end_pos < pos) {
				first = middle + 1;
...
string v__ast__Scope_show(v__ast__Scope* sc, int level) { 
	/*assign_stmt*/string out = tos3("");
	/*assign_stmt*/string indent = tos3("");
	for (int tmp1 = 0; tmp1 < level * 4; tmp1++) { 
		int _ = tmp1;
		indent = string_add(indent, tos3(" "));
	}
	out = string_add(out, _STR("%.*s# %d - %d\n", indent.len, indent.str, sc->start_pos, sc->end_pos));
	// FOR IN
	array_string keys_tmp2 = map_keys(&sc->vars);
	for (int tmp3 = 0; tmp3 < keys_tmp2.len; tmp3++) {
		string _ = ((string*)keys_tmp2.data)[tmp3];
		v__ast__Var var = (*(v__ast__Var*)map_get3(sc->vars, _, &(v__ast__Var[]){ {0} }));
		out = string_add(out, _STR("%.*s  * %.*s - %d\n", indent.len, indent.str, var.name.len, var.name.str, var.typ));
	}
	// FOR IN
	for (int tmp4 = 0; tmp4 < sc->children.len; tmp4++) {
		v__ast__Scope* child = ((v__ast__Scope**)sc->children.data)[tmp4];
		out = string_add(out, v__ast__Scope_show(child, level + 1));
	}
	return out;
}

string v__ast__Scope_str(v__ast__Scope* sc) { 
	return v__ast__Scope_show(sc, 0);
}

string v__ast__FnDecl_str(v__ast__FnDecl* node, v__table__Table* t) { 
	/*assign_stmt*/strings__Builder f = strings__new_builder(30);
	if (node->is_pub) {
		strings__Builder_write(&f, tos3("pub "));
	}
	/*assign_stmt*/string receiver = tos3("");
	if (node->is_method) {
		/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(t, node->receiver.typ);
		/*assign_stmt*/string name = string_after(sym->name, tos3("."));
		/*assign_stmt*/string m = (node->rec_mut ? tos3("mut ") : tos3(""));
		receiver = _STR("(%.*s %.*s%.*s) ", node->receiver.name.len, node->receiver.name.str, m.len, m.str, name.len, name.str);
	}
	/*assign_stmt*/string name = string_after(node->name, tos3("."));
	strings__Builder_write(&f, _STR("fn %.*s%.*s(", receiver.len, receiver.str, name.len, name.str));
	// FOR IN
	for (int i = 0; i < node->args.len; i++) {
		v__table__Arg arg = ((v__table__Arg*)node->args.data)[i];
		if (node->is_method && i == 0) {
			continue;
		}
		/*assign_stmt*/bool is_last_arg = i == node->args.len - 1;
		/*assign_stmt*/bool should_add_type = is_last_arg || (*(v__table__Arg*)array_get(node->args, i + 1)).typ != arg.typ || (node->is_variadic && i == node->args.len - 2);
...
string v__ast__Expr_str(v__ast__Expr x) { 
	if (x.typ == 179 /* v.ast.Ident */) {
		v__ast__Ident* it = (v__ast__Ident*)x.obj; // ST it
		return it->name;
	}
	else if (x.typ == 193 /* v.ast.InfixExpr */) {
	...
	else if (x.typ == 210 /* v.ast.IntegerLiteral */) {
		v__ast__IntegerLiteral* it = (v__ast__IntegerLiteral*)x.obj; // ST it
		return it->val;
	}
	else if (x.typ == 206 /* v.ast.StringLiteral */) {
...
string v__ast__Stmt_str(v__ast__Stmt node) { 
	if (node.typ == 217 /* v.ast.AssignStmt */) {
		v__ast__AssignStmt* it = (v__ast__AssignStmt*)node.obj; // ST it
		/*assign_stmt*/string out = tos3("");
		// FOR IN
		for (int i = 0; i < it->left.len; i++) {
			v__ast__Ident ident = ((v__ast__Ident*)it->left.data)[i];
			/*assign_stmt*/v__ast__IdentVar var_info = v__ast__Ident_var_info(&ident);
			if (var_info.is_mut) {
		...
		// FOR IN
		for (int i = 0; i < it->right.len; i++) {
			v__ast__Expr val = ((v__ast__Expr*)it->right.data)[i];
	...
	else if (node.typ == 175 /* v.ast.ExprStmt */) {
...
void v__checker__Checker_check(v__checker__Checker* c, v__ast__File ast_file) { 
	c->file = ast_file;
	// FOR IN
	for (int tmp1 = 0; tmp1 < ast_file.stmts.len; tmp1++) {
		v__ast__Stmt stmt = ((v__ast__Stmt*)ast_file.stmts.data)[tmp1];
...
void v__checker__Checker_check_files(v__checker__Checker* c, array_v__ast__File ast_files) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < ast_files.len; tmp1++) {
		v__ast__File file = ((v__ast__File*)ast_files.data)[tmp1];
		c->file = file;
		// FOR IN
		for (int tmp2 = 0; tmp2 < file.stmts.len; tmp2++) {
			v__ast__Stmt stmt = ((v__ast__Stmt*)file.stmts.data)[tmp2];
			if (stmt.typ == 211 /* v.ast.ConstDecl */) {
				v__ast__ConstDecl* it = (v__ast__ConstDecl*)stmt.obj; // ST it
				v__checker__Checker_stmt(c, /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ConstDecl[]) {*it}, sizeof(v__ast__ConstDecl)), .typ = 211 /* v.ast.ConstDecl */});
			}
			else {
			}
			;
	...
	// FOR IN
	for (int tmp4 = 0; tmp4 < ast_files.len; tmp4++) {
		v__ast__File file = ((v__ast__File*)ast_files.data)[tmp4];
...
v__table__Type v__checker__Checker_struct_init(v__checker__Checker* c, v__ast__StructInit* struct_init) { 
	...
	/*assign_stmt*/v__table__TypeSymbol* typ_sym = v__table__Table_get_type_symbol(c->table, struct_init->typ);
	if (typ_sym->kind == v__table__Kind_placeholder) {
		...
		/*assign_stmt*/v__table__Struct info = /* as */ *(v__table__Struct*)typ_sym->info.obj;
		/*assign_stmt*/bool is_short_syntax = struct_init->fields.len == 0;
		if (struct_init->exprs.len > info.fields.len) {
			v__checker__Checker_error(c, tos3("too many fields"), struct_init->pos);
		}
		// FOR IN
		for (int i = 0; i < struct_init->exprs.len; i++) {
			v__ast__Expr expr = ((v__ast__Expr*)struct_init->exprs.data)[i];
			/*assign_stmt*/string field_name = (is_short_syntax ? (*(v__table__Field*)array_get(info.fields, i)).name : (*(string*)array_get(struct_init->fields, i)));
			/*assign_stmt*/v__table__Field field = (*(v__table__Field*)array_get(info.fields, i));
			/*assign_stmt*/bool found_field = false;
			// FOR IN
			for (int tmp6 = 0; tmp6 < info.fields.len; tmp6++) {
				v__table__Field f = ((v__table__Field*)info.fields.data)[tmp6];
			...
			/*assign_stmt*/v__table__Type expr_type = v__checker__Checker_expr(c, expr);
			/*assign_stmt*/v__table__TypeSymbol* expr_type_sym = v__table__Table_get_type_symbol(c->table, expr_type);
			/*assign_stmt*/v__table__TypeSymbol* field_type_sym = v__table__Table_get_type_symbol(c->table, field.typ);
			...
			_PUSH(&struct_init->expr_types, (expr_type), tmp10, v__table__Type);
			_PUSH(&struct_init->expected_types, (field.typ), tmp11, v__table__Type);
		}
	}
	else {
	}
...
v__table__Type v__checker__Checker_infix_expr(v__checker__Checker* c, v__ast__InfixExpr* infix_expr) { 
	/*assign_stmt*/v__table__Type left_type = v__checker__Checker_expr(c, infix_expr->left);
	infix_expr->left_type = left_type;
	c->expected_type = left_type;
	/*assign_stmt*/v__table__Type right_type = v__checker__Checker_expr(c, infix_expr->right);
	infix_expr->right_type = right_type;
	/*assign_stmt*/v__table__TypeSymbol* right = v__table__Table_get_type_symbol(c->table, right_type);
	...
	if (!v__table__Table_check(c->table, right_type, left_type)) {
		/*assign_stmt*/v__table__TypeSymbol* left = v__table__Table_get_type_symbol(c->table, left_type);
...
void v__checker__Checker_assign_expr(v__checker__Checker* c, v__ast__AssignExpr* assign_expr) { 
	/*assign_stmt*/v__table__Type left_type = v__checker__Checker_expr(c, assign_expr->left);
	c->expected_type = left_type;
	assign_expr->left_type = left_type;
	/*assign_stmt*/v__table__Type right_type = v__checker__Checker_expr(c, assign_expr->val);
	assign_expr->right_type = right_type;
	if (v__ast__expr_is_blank_ident(assign_expr->left)) {
		return;
	}
	if (!v__table__Table_check(c->table, right_type, left_type)) {
		/*assign_stmt*/v__table__TypeSymbol* left_type_sym = v__table__Table_get_type_symbol(c->table, left_type);
		/*assign_stmt*/v__table__TypeSymbol* right_type_sym = v__table__Table_get_type_symbol(c->table, right_type);
...
v__table__Type v__checker__Checker_call_expr(v__checker__Checker* c, v__ast__CallExpr* call_expr) { 
	...
	if (call_expr->is_method) {
		/*assign_stmt*/v__table__Type left_type = v__checker__Checker_expr(c, call_expr->left);
		call_expr->left_type = left_type;
		/*assign_stmt*/v__table__TypeSymbol* left_type_sym = v__table__Table_get_type_symbol(c->table, left_type);
		/*assign_stmt*/string method_name = call_expr->name;
		if (left_type_sym->kind == v__table__Kind_array && (string_eq(method_name, tos3("filter")) || string_eq(method_name, tos3("clone")) || string_eq(method_name, tos3("repeat")) || string_eq(method_name, tos3("reverse")) || string_eq(method_name, tos3("map")) || string_eq(method_name, tos3("slice")))) {
			if ((string_eq(method_name, tos3("filter")) || string_eq(method_name, tos3("map")))) {
				/*assign_stmt*/v__table__Array array_info = /* as */ *(v__table__Array*)left_type_sym->info.obj;
				/*assign_stmt*/v__ast__Scope* scope = v__ast__Scope_innermost(c->file.scope, call_expr->pos.pos);
			...
			/*assign_stmt*/v__table__Array info = /* as */ *(v__table__Array*)left_type_sym->info.obj;
		...
		if ((tmp5 = method.ok)) {
			/*assign_stmt*/int no_args = /*opt*/(*(v__table__Fn*)method.data).args.len - 1;
			/*assign_stmt*/int min_required_args = /*opt*/(*(v__table__Fn*)method.data).args.len - (/*opt*/(*(v__table__Fn*)method.data).is_variadic && /*opt*/(*(v__table__Fn*)method.data).args.len > 1 ? 2 : 1);
			...
			if (call_expr->exp_arg_types.len == 0) {
				for (int tmp10 = 1; tmp10 < /*opt*/(*(v__table__Fn*)method.data).args.len; tmp10++) { 
					int i = tmp10;
					_PUSH(&call_expr->exp_arg_types, ((*(v__table__Arg*)array_get(/*opt*/(*(v__table__Fn*)method.data).args, i)).typ), tmp11, v__table__Type);
				}
			}
		...
		/*assign_stmt*/string fn_name = call_expr->name;
		...
		if ((string_eq(fn_name, tos3("C.calloc")) || string_eq(fn_name, tos3("C.malloc")) || string_eq(fn_name, tos3("C.exit")) || string_eq(fn_name, tos3("C.free")))) {
			// FOR IN
			for (int tmp16 = 0; tmp16 < call_expr->args.len; tmp16++) {
				v__ast__CallArg arg = ((v__ast__CallArg*)call_expr->args.data)[tmp16];
				v__checker__Checker_expr(c, arg.expr);
			}
		...
		/*assign_stmt*/v__table__Fn f = (v__table__Fn){
			.name = tos3(""),
		...
		/*assign_stmt*/bool found = false;
		if (!string_contains(fn_name, tos3(".")) && !((string_eq(c->file.mod.name, tos3("builtin")) || string_eq(c->file.mod.name, tos3("main"))))) {
			/*assign_stmt*/string name_prefixed = _STR("%.*s.%.*s", c->file.mod.name.len, c->file.mod.name.str, fn_name.len, fn_name.str);
			bool tmp19;
		...
		if (!found) {
			...
			if ((tmp23 = var.ok)) {
				if (/*opt*/(*(v__ast__Var*)var.data).typ != 0) {
					/*assign_stmt*/v__table__TypeSymbol* vts = v__table__Table_get_type_symbol(c->table, /*opt*/(*(v__ast__Var*)var.data).typ);
					if (vts->kind == v__table__Kind_function) {
						/*assign_stmt*/v__table__FnType info = /* as */ *(v__table__FnType*)vts->info.obj;
						f = info.func;
						found = true;
					}
				}
		...
		if (f.is_c || call_expr->is_c) {
			// FOR IN
			for (int tmp28 = 0; tmp28 < call_expr->args.len; tmp28++) {
				v__ast__CallArg arg = ((v__ast__CallArg*)call_expr->args.data)[tmp28];
				v__checker__Checker_expr(c, arg.expr);
			}
			return f.return_type;
		}
		/*assign_stmt*/int min_required_args = (f.is_variadic ? f.args.len - 1 : f.args.len);
		if (call_expr->args.len < min_required_args) {
		...
		if (call_expr->exp_arg_types.len == 0) {
			// FOR IN
			for (int tmp33 = 0; tmp33 < f.args.len; tmp33++) {
				v__table__Arg arg = ((v__table__Arg*)f.args.data)[tmp33];
				_PUSH(&call_expr->exp_arg_types, (arg.typ), tmp34, v__table__Type);
			}
		}
		// FOR IN
		for (int i = 0; i < call_expr->args.len; i++) {
			v__ast__CallArg call_arg = ((v__ast__CallArg*)call_expr->args.data)[i];
			/*assign_stmt*/v__table__Arg arg = (f.is_variadic && i >= f.args.len - 1 ? (*(v__table__Arg*)array_get(f.args, f.args.len - 1)) : (*(v__table__Arg*)array_get(f.args, i)));
			c->expected_type = arg.typ;
			/*assign_stmt*/v__table__Type typ = v__checker__Checker_expr(c, call_arg.expr);
			(*(v__ast__CallArg*)array_get(call_expr->args, i)).typ = typ;
			/*assign_stmt*/v__table__TypeSymbol* typ_sym = v__table__Table_get_type_symbol(c->table, typ);
			/*assign_stmt*/v__table__TypeSymbol* arg_typ_sym = v__table__Table_get_type_symbol(c->table, arg.typ);
...
v__table__Type v__checker__Checker_selector_expr(v__checker__Checker* c, v__ast__SelectorExpr* selector_expr) { 
	/*assign_stmt*/v__table__Type typ = v__checker__Checker_expr(c, selector_expr->expr);
	...
	/*assign_stmt*/v__table__TypeSymbol* typ_sym = v__table__Table_get_type_symbol(c->table, typ);
	/*assign_stmt*/string field_name = selector_expr->field;
	if (v__table__type_is_variadic(typ)) {
...
void v__checker__Checker_return_stmt(v__checker__Checker* c, v__ast__Return* return_stmt) { 
	...
	/*assign_stmt*/v__table__Type expected_type = c->fn_return_type;
	/*assign_stmt*/v__table__TypeSymbol* expected_type_sym = v__table__Table_get_type_symbol(c->table, expected_type);
	/*assign_stmt*/bool exp_is_optional = v__table__type_is_optional(expected_type);
	/*assign_stmt*/array_v__table__Type expected_types = new_array_from_c_array(1, 1, sizeof(v__table__Type), (v__table__Type[1]){	
	expected_type, 
});
	if (expected_type_sym->kind == v__table__Kind_multi_return) {
		/*assign_stmt*/v__table__MultiReturn mr_info = /* as */ *(v__table__MultiReturn*)expected_type_sym->info.obj;
		expected_types = mr_info.types;
	}
	/*assign_stmt*/array_v__table__Type got_types = new_array(0, 0, sizeof(v__table__Type));
	// FOR IN
	for (int tmp4 = 0; tmp4 < return_stmt->exprs.len; tmp4++) {
		v__ast__Expr expr = ((v__ast__Expr*)return_stmt->exprs.data)[tmp4];
		/*assign_stmt*/v__table__Type typ = v__checker__Checker_expr(c, expr);
	...
	for (int i = 0; i < expected_types.len; i++) {
		v__table__Type exp_typ = ((v__table__Type*)expected_types.data)[i];
		/*assign_stmt*/v__table__Type got_typ = (*(v__table__Type*)array_get(got_types, i));
		if (!v__table__Table_check(c->table, got_typ, exp_typ)) {
			/*assign_stmt*/v__table__TypeSymbol* got_typ_sym = v__table__Table_get_type_symbol(c->table, got_typ);
			/*assign_stmt*/v__table__TypeSymbol* exp_typ_sym = v__table__Table_get_type_symbol(c->table, exp_typ);
...
void v__checker__Checker_assign_stmt(v__checker__Checker* c, v__ast__AssignStmt* assign_stmt) { 
	...
	if (assign_stmt->left.len > assign_stmt->right.len) {
		if ((*(v__ast__Expr*)array_get(assign_stmt->right, 0)).typ == 150 /* v.ast.CallExpr */) {
		...
		;
		/*assign_stmt*/v__table__Type right_type = v__checker__Checker_expr(c, (*(v__ast__Expr*)array_get(assign_stmt->right, 0)));
		/*assign_stmt*/v__table__TypeSymbol* right_type_sym = v__table__Table_get_type_symbol(c->table, right_type);
		/*assign_stmt*/v__table__MultiReturn mr_info = v__table__TypeSymbol_mr_info(right_type_sym);
		if (right_type_sym->kind != v__table__Kind_multi_return) {
			v__checker__Checker_error(c, tos3("wrong number of vars"), assign_stmt->pos);
		}
		/*assign_stmt*/v__ast__Scope* scope = v__ast__Scope_innermost(c->file.scope, assign_stmt->pos.pos);
		// FOR IN
		for (int i = 0; i < assign_stmt->left.len; i++) {
			v__ast__Ident _ = ((v__ast__Ident*)assign_stmt->left.data)[i];
			/*assign_stmt*/v__ast__Ident ident = (*(v__ast__Ident*)array_get(assign_stmt->left, i));
			/*assign_stmt*/v__ast__IdentVar ident_var_info = v__ast__Ident_var_info(&ident);
			/*assign_stmt*/v__table__Type val_type = (*(v__table__Type*)array_get(mr_info.types, i));
			if (assign_stmt->op == v__token__Kind_assign) {
				/*assign_stmt*/v__table__Type var_type = v__checker__Checker_expr(c, /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Ident[]) {ident}, sizeof(v__ast__Ident)), .typ = 179 /* v.ast.Ident */});
				_PUSH(&assign_stmt->left_types, (var_type), tmp5, v__table__Type);
				if (!v__table__Table_check(c->table, val_type, var_type)) {
					/*assign_stmt*/v__table__TypeSymbol* val_type_sym = v__table__Table_get_type_symbol(c->table, val_type);
					/*assign_stmt*/v__table__TypeSymbol* var_type_sym = v__table__Table_get_type_symbol(c->table, var_type);
			...
			ident.info = /* sum type cast */ (v__ast__IdentInfo) {.obj = memdup(&(v__ast__IdentVar[]) {ident_var_info}, sizeof(v__ast__IdentVar)), .typ = 180 /* v.ast.IdentVar */};
		...
		for (int i = 0; i < assign_stmt->left.len; i++) {
			...
			/*assign_stmt*/v__ast__Ident ident = (*(v__ast__Ident*)array_get(assign_stmt->left, i));
			/*assign_stmt*/v__ast__IdentVar ident_var_info = v__ast__Ident_var_info(&ident);
			/*assign_stmt*/v__table__Type val_type = v__checker__Checker_expr(c, (*(v__ast__Expr*)array_get(assign_stmt->right, i)));
			if (assign_stmt->op == v__token__Kind_assign) {
				/*assign_stmt*/v__table__Type var_type = v__checker__Checker_expr(c, /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Ident[]) {ident}, sizeof(v__ast__Ident)), .typ = 179 /* v.ast.Ident */});
...
v__table__Type v__checker__Checker_array_init(v__checker__Checker* c, v__ast__ArrayInit* array_init) { 
	...
	if (array_init->exprs.len == 0) {
		/*assign_stmt*/v__table__TypeSymbol* type_sym = v__table__Table_get_type_symbol(c->table, c->expected_type);
		/*assign_stmt*/v__table__Array array_info = v__table__TypeSymbol_array_info(type_sym);
	...
	if (array_init->exprs.len > 0 && array_init->elem_type == _const_v__table__void_type) {
		...
		for (int i = 0; i < array_init->exprs.len; i++) {
			...
			if (!v__table__Table_check(c->table, elem_type, typ)) {
				/*assign_stmt*/v__table__TypeSymbol* elem_type_sym = v__table__Table_get_type_symbol(c->table, elem_type);
		...
		/*assign_stmt*/int idx = v__table__Table_find_or_register_array(c->table, elem_type, 1);
		...
		/*assign_stmt*/int fixed_size = 1;
		if ((*(v__ast__Expr*)array_get(array_init->exprs, 0)).typ == 210 /* v.ast.IntegerLiteral */) {
		...
		;
		/*assign_stmt*/int idx = v__table__Table_find_or_register_array_fixed(c->table, array_init->elem_type, fixed_size, 1);
		/*assign_stmt*/v__table__Type array_type = v__table__new_type(idx);
...
void v__checker__Checker_stmt(v__checker__Checker* c, v__ast__Stmt node) { 
	...
	else if (node.typ == 171 /* v.ast.DeferStmt */) {
		v__ast__DeferStmt* it = (v__ast__DeferStmt*)node.obj; // ST it
		v__checker__Checker_stmts(c, it->stmts);
	}
	else if (node.typ == 211 /* v.ast.ConstDecl */) {
		v__ast__ConstDecl* it = (v__ast__ConstDecl*)node.obj; // ST it
		// FOR IN
		for (int i = 0; i < it->exprs.len; i++) {
			v__ast__Expr expr = ((v__ast__Expr*)it->exprs.data)[i];
			/*assign_stmt*/v__ast__Field field = (*(v__ast__Field*)array_get(it->fields, i));
			/*assign_stmt*/v__table__Type typ = v__checker__Checker_expr(c, expr);
			v__table__Table_register_const(c->table, (v__table__Var){
				.name = field.name,
				.typ = typ,
				.is_mut = 0,
				.is_const = 0,
			...
			field.typ = typ;
			(*(v__ast__Field*)array_get(it->fields, i)) = field;
		}
	}
	else if (node.typ == 175 /* v.ast.ExprStmt */) {
		v__ast__ExprStmt* it = (v__ast__ExprStmt*)node.obj; // ST it
	...
	else if (node.typ == 199 /* v.ast.ForStmt */) {
		v__ast__ForStmt* it = (v__ast__ForStmt*)node.obj; // ST it
		/*assign_stmt*/v__table__Type typ = v__checker__Checker_expr(c, it->cond);
	...
	else if (node.typ == 200 /* v.ast.ForCStmt */) {
	...
	else if (node.typ == 201 /* v.ast.ForInStmt */) {
		v__ast__ForInStmt* it = (v__ast__ForInStmt*)node.obj; // ST it
		/*assign_stmt*/v__table__Type typ = v__checker__Checker_expr(c, it->cond);
		if (it->is_range) {
			v__checker__Checker_expr(c, it->high);
		} else {
			/*assign_stmt*/v__ast__Scope* scope = v__ast__Scope_innermost(c->file.scope, it->pos.pos);
			/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(c->table, typ);
			if (it->key_var.len > 0) {
				/*assign_stmt*/v__table__Type key_type = (sym->kind == v__table__Kind_map) ? v__table__TypeSymbol_map_info(sym).key_type : _const_v__table__int_type;
				it->key_type = key_type;
				v__ast__Scope_update_var_type(scope, it->key_var, key_type);
			}
			/*assign_stmt*/v__table__Type value_type = v__table__Table_value_type(c->table, typ);
...
void v__checker__Checker_stmts(v__checker__Checker* c, array_v__ast__Stmt stmts) { 
	c->expected_type = _const_v__table__void_type;
	// FOR IN
	for (int tmp1 = 0; tmp1 < stmts.len; tmp1++) {
		v__ast__Stmt stmt = ((v__ast__Stmt*)stmts.data)[tmp1];
		v__checker__Checker_stmt(c, stmt);
	}
	c->expected_type = _const_v__table__void_type;
}
...
v__table__Type v__checker__Checker_expr(v__checker__Checker* c, v__ast__Expr node) { 
	if (node.typ == 208 /* v.ast.ArrayInit */) {
		v__ast__ArrayInit* it = (v__ast__ArrayInit*)node.obj; // ST it
		return v__checker__Checker_array_init(c, it);
	}
	else if (node.typ == 192 /* v.ast.AsCast */) {
		v__ast__AsCast* it = (v__ast__AsCast*)node.obj; // ST it
		it->expr_type = v__checker__Checker_expr(c, it->expr);
		/*assign_stmt*/v__table__TypeSymbol* expr_type_sym = v__table__Table_get_type_symbol(c->table, it->expr_type);
		/*assign_stmt*/v__table__TypeSymbol* type_sym = v__table__Table_get_type_symbol(c->table, it->typ);
		if (expr_type_sym->kind == v__table__Kind_sum_type) {
			/*assign_stmt*/v__table__SumType info = /* as */ *(v__table__SumType*)expr_type_sym->info.obj;
	...
	else if (node.typ == 177 /* v.ast.AssignExpr */) {
		v__ast__AssignExpr* it = (v__ast__AssignExpr*)node.obj; // ST it
		v__checker__Checker_assign_expr(c, it);
	}
	else if (node.typ == 229 /* v.ast.Assoc */) {
		v__ast__Assoc* it = (v__ast__Assoc*)node.obj; // ST it
		/*assign_stmt*/v__ast__Scope* scope = v__ast__Scope_innermost(c->file.scope, it->pos.pos);
		/*assign_stmt*/Option_v__ast__Var var = v__ast__Scope_find_var(scope, it->var_name);
		if (!var.ok) {
		string err = var.v_error;
		int errcode = var.ecode;
			v_panic(err);
		...
		for (int i = 0; i < it->fields.len; i++) {
			string _ = ((string*)it->fields.data)[i];
	...
	else if (node.typ == 187 /* v.ast.BoolLiteral */) {
		v__ast__BoolLiteral* it = (v__ast__BoolLiteral*)node.obj; // ST it
		return _const_v__table__bool_type;
	}
	else if (node.typ == 184 /* v.ast.CastExpr */) {
	...
	else if (node.typ == 207 /* v.ast.StringInterLiteral */) {
		v__ast__StringInterLiteral* it = (v__ast__StringInterLiteral*)node.obj; // ST it
		// FOR IN
		for (int tmp9 = 0; tmp9 < it->exprs.len; tmp9++) {
			v__ast__Expr expr = ((v__ast__Expr*)it->exprs.data)[tmp9];
			_PUSH(&it->expr_types, (v__checker__Checker_expr(c, expr)), tmp10, v__table__Type);
		}
		return _const_v__table__string_type;
	}
	else if (node.typ == 181 /* v.ast.StructInit */) {
		v__ast__StructInit* it = (v__ast__StructInit*)node.obj; // ST it
		return v__checker__Checker_struct_init(c, it);
	}
	else if (node.typ == 223 /* v.ast.Type */) {
		v__ast__Type* it = (v__ast__Type*)node.obj; // ST it
		return it->typ;
	}
	else if (node.typ == 191 /* v.ast.TypeOf */) {
...
v__table__Type v__checker__Checker_ident(v__checker__Checker* c, v__ast__Ident* ident) { 
	if (ident->kind == v__ast__IdentKind_variable) {
		/*assign_stmt*/v__ast__IdentVar info = /* as */ *(v__ast__IdentVar*)ident->info.obj;
		if (info.typ != 0) {
			return info.typ;
		}
		/*assign_stmt*/v__ast__Scope* start_scope = v__ast__Scope_innermost(c->file.scope, ident->pos.pos);
		/*assign_stmt*/bool found = true;
		Option_multi_return_v__ast__Scope_v__ast__Var mr_23641 = v__ast__Scope_find_scope_and_var(start_scope, ident->name);
		if (!mr_23641.ok) {
		string err = mr_23641.v_error;
		int errcode = mr_23641.ecode;
			found = false;
			v__checker__Checker_error(c, _STR("not found: %.*s - POS: %d", ident->name.len, ident->name.str, ident->pos.pos), ident->pos);
			v_panic(tos3(""));
		};
		v__ast__Scope* var_scope = (*(multi_return_v__ast__Scope_v__ast__Var*)mr_23641.data).arg0;
		v__ast__Var var = (*(multi_return_v__ast__Scope_v__ast__Var*)mr_23641.data).arg1;
		if (found) {
			/*assign_stmt*/v__table__Type typ = var.typ;
			if (typ == 0) {
				typ = v__checker__Checker_expr(c, var.expr);
				v__ast__Scope_update_var_type(var_scope, var.name, typ);
			}
			ident->kind = v__ast__IdentKind_variable;
			ident->info = /* sum type cast */ (v__ast__IdentInfo) {.obj = memdup(&(v__ast__IdentVar[]) {(v__ast__IdentVar){
				.typ = typ,
				.is_optional = v__table__type_is_optional(typ),
				.is_mut = 0,
				.is_static = 0,
			}}, sizeof(v__ast__IdentVar)), .typ = 180 /* v.ast.IdentVar */};
			if (v__table__type_is_optional(typ)) {
				return v__table__type_clear_extra(typ);
			}
			return typ;
		}
		...
		/*assign_stmt*/v__ast__IdentFn info = /* as */ *(v__ast__IdentFn*)ident->info.obj;
		return info.typ;
	} else if (ident->kind == v__ast__IdentKind_unresolved) {
		/*assign_stmt*/string name = ident->name;
		if (!string_contains(name, tos3(".")) && !((string_eq(c->file.mod.name, tos3("builtin")) || string_eq(c->file.mod.name, tos3("main"))))) {
			name = _STR("%.*s.%.*s", c->file.mod.name.len, c->file.mod.name.str, ident->name.len, ident->name.str);
		}
		if (string_eq(ident->name, tos3("v_modules_path"))) {
			ident->name = name;
		...
		bool tmp8;
		{ /* if guard */ Option_v__table__Var constant = v__table__Table_find_const(c->table, name);
		if ((tmp8 = constant.ok)) {
			ident->name = name;
			ident->kind = v__ast__IdentKind_constant;
			ident->info = /* sum type cast */ (v__ast__IdentInfo) {.obj = memdup(&(v__ast__IdentVar[]) {(v__ast__IdentVar){
				.typ = /*opt*/(*(v__table__Var*)constant.data).typ,
				.is_mut = 0,
				.is_static = 0,
				.is_optional = 0,
			}}, sizeof(v__ast__IdentVar)), .typ = 180 /* v.ast.IdentVar */};
			return /*opt*/(*(v__table__Var*)constant.data).typ;
		}}
		bool tmp9;
		{ /* if guard */ Option_v__table__Fn func = v__table__Table_find_fn(c->table, name);
		if ((tmp9 = func.ok)) {
			/*assign_stmt*/v__table__Type fn_type = v__table__new_type(v__table__Table_find_or_register_fn_type(c->table, /*opt*/(*(v__table__Fn*)func.data), true));
			ident->name = name;
			...
			ident->info = /* sum type cast */ (v__ast__IdentInfo) {.obj = memdup(&(v__ast__IdentFn[]) {(v__ast__IdentFn){
				.typ = fn_type,
			}}, sizeof(v__ast__IdentFn)), .typ = 232 /* v.ast.IdentFn */};
			return fn_type;
		}}
	}
	if (ident->is_c) {
...
v__table__Type v__checker__Checker_match_expr(v__checker__Checker* c, v__ast__MatchExpr* node) { 
	...
	/*assign_stmt*/v__table__Type cond_type = v__checker__Checker_expr(c, node->cond);
	if (cond_type == 0) {
		v__checker__Checker_error(c, tos3("match 0 cond type"), node->pos);
	}
	c->expected_type = cond_type;
	/*assign_stmt*/v__table__Type ret_type = _const_v__table__void_type;
	// FOR IN
	for (int tmp2 = 0; tmp2 < node->branches.len; tmp2++) {
		v__ast__MatchBranch branch = ((v__ast__MatchBranch*)node->branches.data)[tmp2];
		// FOR IN
		...
		if (branch.stmts.len > 0) {
			if ((*(v__ast__Stmt*)array_get(branch.stmts, branch.stmts.len - 1)).typ == 175 /* v.ast.ExprStmt */) {
...
v__table__Type v__checker__Checker_if_expr(v__checker__Checker* c, v__ast__IfExpr* node) { 
	...
	for (int i = 0; i < node->branches.len; i++) {
		...
		if (branch.cond.typ == 188 /* v.ast.ParExpr */) {
		...
		;
		/*assign_stmt*/v__table__Type typ = v__checker__Checker_expr(c, branch.cond);
	...
	if (node->has_else && node->is_expr) {
		/*assign_stmt*/v__ast__IfBranch last_branch = (*(v__ast__IfBranch*)array_get(node->branches, node->branches.len - 1));
		if (last_branch.stmts.len > 0) {
			if ((*(v__ast__Stmt*)array_get(last_branch.stmts, last_branch.stmts.len - 1)).typ == 175 /* v.ast.ExprStmt */) {
				v__ast__ExprStmt* it = (v__ast__ExprStmt*)(*(v__ast__Stmt*)array_get(last_branch.stmts, last_branch.stmts.len - 1)).obj; // ST it
				/*assign_stmt*/v__table__Type t = v__checker__Checker_expr(c, it->expr);
				node->typ = t;
				return t;
			}
			else {
...
v__table__Type v__checker__Checker_postfix_expr(v__checker__Checker* c, v__ast__PostfixExpr node) { 
	/*assign_stmt*/v__table__Type typ = v__checker__Checker_expr(c, node.expr);
	/*assign_stmt*/v__table__TypeSymbol* typ_sym = v__table__Table_get_type_symbol(c->table, typ);
...
v__table__Type v__checker__Checker_index_expr(v__checker__Checker* c, v__ast__IndexExpr* node) { 
	/*assign_stmt*/v__table__Type typ = v__checker__Checker_expr(c, node->left);
	/*assign_stmt*/bool is_range = false;
	if (node->index.typ == 197 /* v.ast.RangeExpr */) {
	...
	/*assign_stmt*/v__table__TypeSymbol* typ_sym = v__table__Table_get_type_symbol(c->table, typ);
	if (!is_range) {
		/*assign_stmt*/v__table__Type index_type = v__checker__Checker_expr(c, node->index);
		/*assign_stmt*/v__table__TypeSymbol* index_type_sym = v__table__Table_get_type_symbol(c->table, index_type);
		...
		if (typ_sym->kind == v__table__Kind_array_fixed) {
			/*assign_stmt*/v__table__Type elem_type = v__table__Table_value_type(c->table, typ);
			/*assign_stmt*/int idx = v__table__Table_find_or_register_array(c->table, elem_type, 1);
			return v__table__new_type(idx);
		}
	}
...
v__table__Type v__checker__Checker_enum_val(v__checker__Checker* c, v__ast__EnumVal* node) { 
	/*assign_stmt*/int typ_idx = (string_eq(node->enum_name, tos3("")) ? v__table__type_idx(c->expected_type) : v__table__Table_find_type_idx(c->table, node->enum_name));
	if (typ_idx == 0) {
		v__checker__Checker_error(c, _STR("not an enum (name=%.*s) (type_idx=0)", node->enum_name.len, node->enum_name.str), node->pos);
	}
	/*assign_stmt*/v__table__Type typ = v__table__new_type(typ_idx);
	/*assign_stmt*/v__table__TypeSymbol* typ_sym = v__table__Table_get_type_symbol(c->table, typ);
	if (typ_sym->kind != v__table__Kind_enum_) {
		v__checker__Checker_error(c, tos3("not an enum"), node->pos);
	}
	/*assign_stmt*/v__table__Enum info = v__table__TypeSymbol_enum_info(typ_sym);
...
v__table__Type v__checker__Checker_map_init(v__checker__Checker* c, v__ast__MapInit* node) { 
	if (node->typ != 0) {
		/*assign_stmt*/v__table__Map info = v__table__TypeSymbol_map_info(v__table__Table_get_type_symbol(c->table, node->typ));
		node->key_type = info.key_type;
		node->value_type = info.value_type;
		return node->typ;
	}
	/*assign_stmt*/v__table__Type key0_type = v__checker__Checker_expr(c, (*(v__ast__Expr*)array_get(node->keys, 0)));
	/*assign_stmt*/v__table__Type val0_type = v__checker__Checker_expr(c, (*(v__ast__Expr*)array_get(node->vals, 0)));
	// FOR IN
	for (int i = 0; i < node->keys.len; i++) {
		...
		/*assign_stmt*/v__ast__Expr val = (*(v__ast__Expr*)array_get(node->vals, i));
		/*assign_stmt*/v__table__Type key_type = v__checker__Checker_expr(c, key);
		/*assign_stmt*/v__table__Type val_type = v__checker__Checker_expr(c, val);
		if (!v__table__Table_check(c->table, key_type, key0_type)) {
			/*assign_stmt*/v__table__TypeSymbol* key0_type_sym = v__table__Table_get_type_symbol(c->table, key0_type);
			/*assign_stmt*/v__table__TypeSymbol* key_type_sym = v__table__Table_get_type_symbol(c->table, key_type);
		...
		if (!v__table__Table_check(c->table, val_type, val0_type)) {
			/*assign_stmt*/v__table__TypeSymbol* val0_type_sym = v__table__Table_get_type_symbol(c->table, val0_type);
			/*assign_stmt*/v__table__TypeSymbol* val_type_sym = v__table__Table_get_type_symbol(c->table, val_type);
	...
	/*assign_stmt*/v__table__Type map_type = v__table__new_type(v__table__Table_find_or_register_map(c->table, key0_type, val0_type));
	node->typ = map_type;
...
void v__checker__Checker_error(v__checker__Checker* c, string s, v__token__Position pos) { 
	c->nr_errors++;
	print_backtrace();
	/*assign_stmt*/string path = c->file.path;
	/*assign_stmt*/string workdir = string_add(os__getwd(), _const_os__path_separator);
	if (string_starts_with(path, workdir)) {
		path = string_replace(path, workdir, tos3(""));
	}
	/*assign_stmt*/string final_msg_line = _STR("%.*s:%d: checker error #%d: %.*s", path.len, path.str, pos.line_nr, c->nr_errors, s.len, s.str);
	_PUSH(&c->errors, (final_msg_line), tmp2, string);
	eprintln(final_msg_line);
	println(tos3("\n\n"));
...
string v__gen__cgen(array_v__ast__File files, v__table__Table* table, v__pref__Preferences* pref) { 
	/*assign_stmt*/v__gen__Gen g = (v__gen__Gen){
		...
		.defer_ifdef = tos3(""),
		.str_types = new_array(0, 1, sizeof(int)),
	};
	v__gen__Gen_init(&g);
	/*assign_stmt*/bool autofree_used = false;
	// FOR IN
	for (int tmp1 = 0; tmp1 < files.len; tmp1++) {
		v__ast__File file = ((v__ast__File*)files.data)[tmp1];
		g.file = file;
		/*assign_stmt*/bool building_v = true && (string_contains(g.file.path, tos3("/vlib/")) || string_contains(g.file.path, tos3("cmd/v")));
		/*assign_stmt*/bool is_test = string_ends_with(g.file.path, tos3(".vv")) || string_ends_with(g.file.path, tos3("_test.v"));
	...
	return string_add(string_add(strings__Builder_str(&g.typedefs), strings__Builder_str(&g.definitions)), strings__Builder_str(&g.out));
}
...
void v__gen__Gen_write_typeof_functions(v__gen__Gen* g) { 
	...
	// FOR IN
	for (int tmp1 = 0; tmp1 < g->table->types.len; tmp1++) {
		v__table__TypeSymbol typ = ((v__table__TypeSymbol*)g->table->types.data)[tmp1];
		if (typ.kind == v__table__Kind_sum_type) {
			/*assign_stmt*/v__table__SumType sum_info = /* as */ *(v__table__SumType*)typ.info.obj;
			/*assign_stmt*/int tidx = v__table__Table_find_type_idx(g->table, typ.name);
			...
			// FOR IN
			for (int tmp3 = 0; tmp3 < sum_info.variants.len; tmp3++) {
				v__table__Type v = ((v__table__Type*)sum_info.variants.data)[tmp3];
				/*assign_stmt*/v__table__TypeSymbol* subtype = v__table__Table_get_type_symbol(g->table, v);
...
string v__gen__Gen_typ(v__gen__Gen* g, v__table__Type t) { 
	/*assign_stmt*/int nr_muls = v__table__type_nr_muls(t);
	/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, t);
	/*assign_stmt*/string styp = string_replace(sym->name, tos3("."), tos3("__"));
	if (nr_muls > 0) {
...
void v__gen__Gen_write_typedef_types(v__gen__Gen* g) { 
	...
	for (int tmp1 = 0; tmp1 < g->table->types.len; tmp1++) {
		...
		if (typ.kind == v__table__Kind_alias) {
			/*assign_stmt*/v__table__TypeSymbol* parent = &(*(v__table__TypeSymbol*)array_get(g->table->types, typ.parent_idx));
			/*assign_stmt*/string styp = string_replace(typ.name, tos3("."), tos3("__"));
			/*assign_stmt*/string parent_styp = string_replace(parent->name, tos3("."), tos3("__"));
			...
			/*assign_stmt*/v__table__FnType info = /* as */ *(v__table__FnType*)typ.info.obj;
			/*assign_stmt*/v__table__Fn func = info.func;
			if (!info.has_decl && !info.is_anon) {
				/*assign_stmt*/string fn_name = (func.is_c ? string_replace(func.name, tos3("."), tos3("__")) : v__gen__c_name(func.name));
				...
				for (int i = 0; i < func.args.len; i++) {
					v__table__Arg arg = ((v__table__Arg*)func.args.data)[i];
...
void v__gen__Gen_write_multi_return_types(v__gen__Gen* g) { 
	...
	for (int tmp1 = 0; tmp1 < g->table->types.len; tmp1++) {
		...
		/*assign_stmt*/string name = string_replace(typ.name, tos3("."), tos3("__"));
		/*assign_stmt*/v__table__MultiReturn info = /* as */ *(v__table__MultiReturn*)typ.info.obj;
		strings__Builder_writeln(&g->definitions, tos3("typedef struct {"));
		// FOR IN
		for (int i = 0; i < info.types.len; i++) {
			v__table__Type mr_typ = ((v__table__Type*)info.types.data)[i];
			/*assign_stmt*/string type_name = v__gen__Gen_typ(g, mr_typ);
...
void v__gen__Gen_write_variadic_types(v__gen__Gen* g) { 
	...
	for (int tmp3 = 0; tmp3 < keys_tmp2.len; tmp3++) {
		...
		/*assign_stmt*/v__table__Type typ = ((v__table__Type)(string_int(type_str)));
		/*assign_stmt*/string type_name = v__gen__Gen_typ(g, typ);
		/*assign_stmt*/string struct_name = string_add(tos3("varg_"), string_replace(type_name, tos3("*"), tos3("_ptr")));
...
void v__gen__Gen_stmt(v__gen__Gen* g, v__ast__Stmt node) { 
	...
	if (node.typ == 168 /* v.ast.AssertStmt */) {
	...
	else if (node.typ == 169 /* v.ast.BranchStmt */) {
		...
		/*assign_stmt*/v__ast__Expr expr = it->expr;
		if (expr.typ == 202 /* v.ast.IfExpr */) {
	...
	else if (node.typ == 214 /* v.ast.InterfaceDecl */) {
	...
	else if (node.typ == 213 /* v.ast.StructDecl */) {
		v__ast__StructDecl* it = (v__ast__StructDecl*)node.obj; // ST it
		/*assign_stmt*/string name = (it->is_c ? string_replace(it->name, tos3("."), tos3("__")) : v__gen__c_name(it->name));
		if (!it->is_c) {
			strings__Builder_writeln(&g->typedefs, _STR("typedef struct %.*s %.*s;", name.len, name.str, name.len, name.str));
		}
	}
	else if (node.typ == 225 /* v.ast.TypeDecl */) {
...
void v__gen__Gen_write_defer_stmts(v__gen__Gen* g) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < g->defer_stmts.len; tmp1++) {
		v__ast__DeferStmt defer_stmt = ((v__ast__DeferStmt*)g->defer_stmts.data)[tmp1];
...
void v__gen__Gen_for_in(v__gen__Gen* g, v__ast__ForInStmt it) { 
	if (it.is_range) {
		/*assign_stmt*/string i = v__gen__Gen_new_tmp_var(g);
		...
		/*assign_stmt*/string i = (string_eq(it.key_var, tos3("")) ? v__gen__Gen_new_tmp_var(g) : it.key_var);
		/*assign_stmt*/string styp = v__gen__Gen_typ(g, it.val_type);
		...
		v__gen__Gen_writeln(g, tos3("// FOR IN"));
		/*assign_stmt*/string key_styp = v__gen__Gen_typ(g, it.key_type);
		/*assign_stmt*/string val_styp = v__gen__Gen_typ(g, it.val_type);
		/*assign_stmt*/string keys_tmp = string_add(tos3("keys_"), v__gen__Gen_new_tmp_var(g));
		/*assign_stmt*/string idx = v__gen__Gen_new_tmp_var(g);
		/*assign_stmt*/string key = (string_eq(it.key_var, tos3("")) ? v__gen__Gen_new_tmp_var(g) : it.key_var);
		/*assign_stmt*/string zero = v__gen__Gen_type_default(g, it.val_type);
		...
		v__gen__Gen_stmts(g, it.stmts);
		v__gen__Gen_writeln(g, tos3("}"));
	} else if (v__table__type_is_variadic(it.cond_type)) {
		v__gen__Gen_writeln(g, tos3("// FOR IN"));
		/*assign_stmt*/string i = (string_eq(it.key_var, tos3("")) ? v__gen__Gen_new_tmp_var(g) : it.key_var);
		/*assign_stmt*/string styp = v__gen__Gen_typ(g, it.cond_type);
		v__gen__Gen_write(g, _STR("for (int %.*s = 0; %.*s < ", i.len, i.str, i.len, i.str));
		v__gen__Gen_expr(g, it.cond);
		v__gen__Gen_writeln(g, _STR(".len; %.*s++) {", i.len, i.str));
...
void v__gen__Gen_expr_with_cast(v__gen__Gen* g, v__ast__Expr expr, v__table__Type got_type, v__table__Type exp_type) { 
	if (exp_type != _const_v__table__void_type) {
		/*assign_stmt*/v__table__TypeSymbol* exp_sym = v__table__Table_get_type_symbol(g->table, exp_type);
		if (exp_sym->kind == v__table__Kind_sum_type) {
			/*assign_stmt*/v__table__SumType sum_info = /* as */ *(v__table__SumType*)exp_sym->info.obj;
			if (_IN(v__table__Type, got_type, sum_info.variants)) {
				/*assign_stmt*/v__table__TypeSymbol* got_sym = v__table__Table_get_type_symbol(g->table, got_type);
				/*assign_stmt*/string got_styp = v__gen__Gen_typ(g, got_type);
				/*assign_stmt*/string exp_styp = v__gen__Gen_typ(g, exp_type);
				/*assign_stmt*/int got_idx = v__table__type_idx(got_type);
...
void v__gen__Gen_gen_assert_stmt(v__gen__Gen* g, v__ast__AssertStmt a) { 
	...
	/*assign_stmt*/string s_assertion = string_replace(v__ast__Expr_str(a.expr), tos3("\""), tos3("\'"));
	v__gen__Gen_write(g, tos3(" )"));
	if (g->is_test) {
		v__gen__Gen_writeln(g, tos3("{"));
...
void v__gen__Gen_gen_assign_stmt(v__gen__Gen* g, v__ast__AssignStmt assign_stmt) { 
	...
	if (assign_stmt.left.len > assign_stmt.right.len) {
		...
		;
		/*assign_stmt*/bool is_optional = v__table__type_is_optional(return_type);
		/*assign_stmt*/string mr_var_name = _STR("mr_%d", assign_stmt.pos.pos);
		/*assign_stmt*/string mr_styp = v__gen__Gen_typ(g, return_type);
		...
		// FOR IN
		for (int i = 0; i < assign_stmt.left.len; i++) {
			v__ast__Ident ident = ((v__ast__Ident*)assign_stmt.left.data)[i];
			if (ident.kind == v__ast__IdentKind_blank_ident) {
				continue;
			}
			/*assign_stmt*/v__ast__IdentVar ident_var_info = v__ast__Ident_var_info(&ident);
			/*assign_stmt*/string styp = v__gen__Gen_typ(g, ident_var_info.typ);
			if (assign_stmt.op == v__token__Kind_decl_assign) {
				v__gen__Gen_write(g, _STR("%.*s ", styp.len, styp.str));
			}
			v__gen__Gen_expr(g, /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Ident[]) {ident}, sizeof(v__ast__Ident)), .typ = 179 /* v.ast.Ident */});
			if (is_optional) {
				/*assign_stmt*/string mr_styp2 = string_substr(mr_styp, 7, mr_styp.len);
		...
		for (int i = 0; i < assign_stmt.left.len; i++) {
			v__ast__Ident ident = ((v__ast__Ident*)assign_stmt.left.data)[i];
			/*assign_stmt*/v__ast__Expr val = (*(v__ast__Expr*)array_get(assign_stmt.right, i));
			/*assign_stmt*/v__ast__IdentVar ident_var_info = v__ast__Ident_var_info(&ident);
			/*assign_stmt*/string styp = v__gen__Gen_typ(g, ident_var_info.typ);
			/*assign_stmt*/bool is_call = false;
			/*assign_stmt*/array_v__ast__Stmt or_stmts = new_array(0, 0, sizeof(v__ast__Stmt));
			/*assign_stmt*/v__table__Type return_type = _const_v__table__void_type;
			if (val.typ == 150 /* v.ast.CallExpr */) {
			...
			;
			/*assign_stmt*/bool gen_or = is_call && v__table__type_is_optional(return_type);
			g->is_assign_rhs = true;
			if (ident.kind == v__ast__IdentKind_blank_ident) {
				if (is_call) {
				...
				/*assign_stmt*/v__table__TypeSymbol* right_sym = v__table__Table_get_type_symbol(g->table, (*(v__table__Type*)array_get(assign_stmt.right_types, i)));
				/*assign_stmt*/bool is_fixed_array_init = false;
				if (val.typ == 208 /* v.ast.ArrayInit */) {
				...
				;
				/*assign_stmt*/bool is_decl = assign_stmt.op == v__token__Kind_decl_assign;
				v__gen__Gen_write(g, tos3("/*assign_stmt*/"));
				if (is_decl) {
					v__gen__Gen_write(g, _STR("%.*s ", styp.len, styp.str));
				}
				v__gen__Gen_expr(g, /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Ident[]) {ident}, sizeof(v__ast__Ident)), .typ = 179 /* v.ast.Ident */});
...
bool v__gen__Gen_gen_clone_assignment(v__gen__Gen* g, v__ast__Expr val, v__table__TypeSymbol right_sym, bool add_eq) { 
	/*assign_stmt*/bool is_ident = false;
	if (val.typ == 179 /* v.ast.Ident */) {
		v__ast__Ident* it = (v__ast__Ident*)val.obj; // ST it
		is_ident = true;
	}
	else if (val.typ == 198 /* v.ast.SelectorExpr */) {
...
void v__gen__Gen_gen_fn_decl(v__gen__Gen* g, v__ast__FnDecl it) { 
	...
	/*assign_stmt*/bool is_main = string_eq(it.name, tos3("main"));
	if (is_main) {
		v__gen__Gen_write(g, _STR("int %.*s(int argc, char** argv", it.name.len, it.name.str));
	} else {
		/*assign_stmt*/string name = it.name;
		if (it.is_method) {
		...
		/*assign_stmt*/string type_name = v__gen__Gen_typ(g, it.return_type);
	...
	if (is_main) {
		...
		if (v__gen__Gen_is_importing_os(g)) {
			...
			v__gen__Gen_writeln(g, tos3("_const_os__args = os__init_os_args(argc, (byteptr*)argv);"));
		}
	}
	v__gen__Gen_stmts(g, it.stmts);
	if (g->autofree) {
...
void v__gen__Gen_free_scope_vars(v__gen__Gen* g, int pos) { 
	/*assign_stmt*/v__ast__Scope* scope = v__ast__Scope_innermost(g->file.scope, pos);
	// FOR IN
	array_string keys_tmp1 = map_keys(&scope->vars);
	for (int tmp2 = 0; tmp2 < keys_tmp1.len; tmp2++) {
		string _ = ((string*)keys_tmp1.data)[tmp2];
		v__ast__Var var = (*(v__ast__Var*)map_get3(scope->vars, _, &(v__ast__Var[]){ {0} }));
		/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, var.typ);
		if (sym->kind == v__table__Kind_array && !v__table__type_is_optional(var.typ)) {
			v__gen__Gen_writeln(g, _STR("array_free(%.*s); // autofreed", var.name.len, var.name.str));
		}
		if (sym->kind == v__table__Kind_string && !v__table__type_is_optional(var.typ)) {
			/*assign_stmt*/string t = tos3( /* v.ast.Expr */ v_typeof_sumtype_176( (var.expr).typ ));
			if (var.expr.typ == 206 /* v.ast.StringLiteral */) {
...
void v__gen__Gen_fn_args(v__gen__Gen* g, array_v__table__Arg args, bool is_variadic) { 
	/*assign_stmt*/bool no_names = args.len > 0 && string_eq((*(v__table__Arg*)array_get(args, 0)).name, tos3("arg_1"));
	// FOR IN
	for (int i = 0; i < args.len; i++) {
		v__table__Arg arg = ((v__table__Arg*)args.data)[i];
		/*assign_stmt*/v__table__TypeSymbol* arg_type_sym = v__table__Table_get_type_symbol(g->table, arg.typ);
		/*assign_stmt*/string arg_type_name = v__gen__Gen_typ(g, arg.typ);
		/*assign_stmt*/bool is_varg = i == args.len - 1 && is_variadic;
		if (is_varg) {
			/*assign_stmt*/string varg_type_str = int_str(((int)(arg.typ)));
		...
		if (arg_type_sym->kind == v__table__Kind_function) {
			/*assign_stmt*/v__table__FnType info = /* as */ *(v__table__FnType*)arg_type_sym->info.obj;
			/*assign_stmt*/v__table__Fn func = info.func;
			if (!info.is_anon) {
			...
			/*assign_stmt*/int nr_muls = v__table__type_nr_muls(arg.typ);
			/*assign_stmt*/string s = string_add(string_add(arg_type_name, tos3(" ")), arg.name);
			if (arg.is_mut) {
				nr_muls = 1;
			}
...
void v__gen__Gen_expr(v__gen__Gen* g, v__ast__Expr node) { 
	if (node.typ == 208 /* v.ast.ArrayInit */) {
		v__ast__ArrayInit* it = (v__ast__ArrayInit*)node.obj; // ST it
		/*assign_stmt*/v__table__TypeSymbol* type_sym = v__table__Table_get_type_symbol(g->table, it->typ);
		if (type_sym->kind != v__table__Kind_array_fixed) {
			/*assign_stmt*/v__table__TypeSymbol* elem_sym = v__table__Table_get_type_symbol(g->table, it->elem_type);
			/*assign_stmt*/string elem_type_str = v__gen__Gen_typ(g, it->elem_type);
			if (it->exprs.len == 0) {
				v__gen__Gen_write(g, _STR("new_array(%d, %d, sizeof(%.*s))", it->exprs.len, it->exprs.len, elem_type_str.len, elem_type_str.str));
			} else {
				/*assign_stmt*/int len = it->exprs.len;
				...
				// FOR IN
				for (int tmp4 = 0; tmp4 < it->exprs.len; tmp4++) {
					v__ast__Expr expr = ((v__ast__Expr*)it->exprs.data)[tmp4];
					v__gen__Gen_expr(g, expr);
					v__gen__Gen_write(g, tos3(", "));
				}
				v__gen__Gen_write(g, tos3("\n})"));
		...
		v__ast__AsCast* it = (v__ast__AsCast*)node.obj; // ST it
		/*assign_stmt*/string styp = v__gen__Gen_typ(g, it->typ);
		/*assign_stmt*/v__table__TypeSymbol* expr_type_sym = v__table__Table_get_type_symbol(g->table, it->expr_type);
		if (expr_type_sym->kind == v__table__Kind_sum_type) {
		...
		/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, it->typ);
		if (sym->kind == v__table__Kind_string) {
			...
			v__gen__Gen_expr(g, it->expr);
			/*assign_stmt*/v__table__TypeSymbol* expr_sym = v__table__Table_get_type_symbol(g->table, it->expr_type);
		...
		v__ast__MapInit* it = (v__ast__MapInit*)node.obj; // ST it
		/*assign_stmt*/v__table__TypeSymbol* key_typ_sym = v__table__Table_get_type_symbol(g->table, it->key_type);
		/*assign_stmt*/v__table__TypeSymbol* value_typ_sym = v__table__Table_get_type_symbol(g->table, it->value_type);
		/*assign_stmt*/string key_typ_str = string_replace(key_typ_sym->name, tos3("."), tos3("__"));
		/*assign_stmt*/string value_typ_str = string_replace(value_typ_sym->name, tos3("."), tos3("__"));
		/*assign_stmt*/int size = it->vals.len;
		if (size > 0) {
			...
			// FOR IN
			for (int tmp13 = 0; tmp13 < it->keys.len; tmp13++) {
				v__ast__Expr expr = ((v__ast__Expr*)it->keys.data)[tmp13];
				v__gen__Gen_expr(g, expr);
				v__gen__Gen_write(g, tos3(", "));
			}
			v__gen__Gen_write(g, _STR("}, (%.*s[%d]){", value_typ_str.len, value_typ_str.str, size));
			// FOR IN
			for (int tmp14 = 0; tmp14 < it->vals.len; tmp14++) {
				v__ast__Expr expr = ((v__ast__Expr*)it->vals.data)[tmp14];
				v__gen__Gen_expr(g, expr);
				v__gen__Gen_write(g, tos3(", "));
			}
			v__gen__Gen_write(g, tos3("})"));
		...
		v__ast__StringLiteral* it = (v__ast__StringLiteral*)node.obj; // ST it
		/*assign_stmt*/string escaped_val = string_replace_each(it->val, new_array_from_c_array(6, 6, sizeof(string), (string[6]){	
		tos3("\""), tos3("\\\""), tos3("\r\n"), tos3("\\n"), tos3("\n"), tos3("\\n"), 
}));
		...
		v__ast__Type* it = (v__ast__Type*)node.obj; // ST it
		/*assign_stmt*/int type_idx = v__table__type_idx(it->typ);
		/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, it->typ);
		...
		println(term__red(string_add(tos3("cgen.expr(): bad node "), tos3( /* v.ast.Expr */ v_typeof_sumtype_176( (node).typ )))));
	}
	;
}

void v__gen__Gen_typeof_expr(v__gen__Gen* g, v__ast__TypeOf node) { 
	/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, node.expr_type);
	if (sym->kind == v__table__Kind_sum_type) {
		/*assign_stmt*/int sum_type_idx = v__table__type_idx(node.expr_type);
		...
		/*assign_stmt*/v__table__ArrayFixed fixed_info = /* as */ *(v__table__ArrayFixed*)sym->info.obj;
		/*assign_stmt*/v__table__TypeSymbol* elem_sym = v__table__Table_get_type_symbol(g->table, fixed_info.elem_type);
...
void v__gen__Gen_assign_expr(v__gen__Gen* g, v__ast__AssignExpr node) { 
	...
	;
	/*assign_stmt*/bool gen_or = is_call && v__table__type_is_optional(return_type);
	/*assign_stmt*/string tmp_opt = (gen_or ? v__gen__Gen_new_tmp_var(g) : tos3(""));
	if (gen_or) {
		/*assign_stmt*/string rstyp = v__gen__Gen_typ(g, return_type);
	...
	if (v__ast__expr_is_blank_ident(node.left)) {
		...
		if (v__table__type_is_optional(node.right_type)) {
			g->right_is_opt = true;
		}
		/*assign_stmt*/bool str_add = false;
		...
		/*assign_stmt*/v__table__TypeSymbol* right_sym = v__table__Table_get_type_symbol(g->table, node.right_type);
		/*assign_stmt*/bool cloned = false;
		if (g->autofree && (right_sym->kind == v__table__Kind_array || right_sym->kind == v__table__Kind_string)) {
...
void v__gen__Gen_infix_expr(v__gen__Gen* g, v__ast__InfixExpr node) { 
	if (node.left_type == _const_v__table__string_type_idx && node.op != v__token__Kind_key_in) {
		/*assign_stmt*/string fn_name = (node.op == v__token__Kind_plus) ? tos3("string_add(") : (node.op == v__token__Kind_eq) ? tos3("string_eq(") : (node.op == v__token__Kind_ne) ? tos3("string_ne(") : (node.op == v__token__Kind_lt) ? tos3("string_lt(") : (node.op == v__token__Kind_le) ? tos3("string_le(") : (node.op == v__token__Kind_gt) ? tos3("string_gt(") : (node.op == v__token__Kind_ge) ? tos3("string_ge(") : tos3("/*node error*/");
		...
		if (right_sym->kind == v__table__Kind_array) {
			if (node.right.typ == 208 /* v.ast.ArrayInit */) {
			...
			;
			/*assign_stmt*/string styp = v__gen__Gen_typ(g, node.left_type);
		...
		/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, node.left_type);
		/*assign_stmt*/v__table__Array info = /* as */ *(v__table__Array*)sym->info.obj;
		/*assign_stmt*/v__table__TypeSymbol* right_sym = v__table__Table_get_type_symbol(g->table, node.right_type);
		if (right_sym->kind == v__table__Kind_array && info.elem_type != node.right_type) {
			...
			/*assign_stmt*/string elem_type_str = v__gen__Gen_typ(g, info.elem_type);
		...
		/*assign_stmt*/bool need_par = node.op == v__token__Kind_amp;
		if (need_par) {
			v__gen__Gen_write(g, tos3("("));
		}
		v__gen__Gen_expr(g, node.left);
...
void v__gen__Gen_match_expr(v__gen__Gen* g, v__ast__MatchExpr node) { 
	...
	/*assign_stmt*/bool is_expr = node.is_expr && node.return_type != _const_v__table__void_type;
	if (is_expr) {
		g->inside_ternary = true;
	}
	/*assign_stmt*/v__table__TypeSymbol* type_sym = v__table__Table_get_type_symbol(g->table, node.cond_type);
	/*assign_stmt*/string tmp = tos3("");
	...
	for (int j = 0; j < node.branches.len; j++) {
		...
		if (node.is_sum_type && branch.exprs.len > 0 && !node.is_expr) {
			/*assign_stmt*/v__ast__Expr first_expr = (*(v__ast__Expr*)array_get(branch.exprs, 0));
			if (first_expr.typ == 223 /* v.ast.Type */) {
				v__ast__Type* it = (v__ast__Type*)first_expr.obj; // ST it
				/*assign_stmt*/string it_type = v__gen__Gen_typ(g, it->typ);
...
void v__gen__Gen_ident(v__gen__Gen* g, v__ast__Ident node) { 
	...
	/*assign_stmt*/string name = v__gen__c_name(node.name);
	if (node.info.typ == 180 /* v.ast.IdentVar */) {
		...
		if (it->is_optional && !(g->is_assign_lhs && g->right_is_opt)) {
			...
			/*assign_stmt*/string styp = string_substr(v__gen__Gen_typ(g, it->typ), 7, v__gen__Gen_typ(g, it->typ).len);
...
void v__gen__Gen_if_expr(v__gen__Gen* g, v__ast__IfExpr node) { 
	/*assign_stmt*/v__table__TypeSymbol* type_sym = v__table__Table_get_type_symbol(g->table, node.typ);
	/*assign_stmt*/string tmp = tos3("");
	if (type_sym->kind != v__table__Kind_void) {
		tmp = v__gen__Gen_new_tmp_var(g);
	}
	if (node.is_expr && node.branches.len >= 2 && node.has_else && type_sym->kind != v__table__Kind_void) {
		...
		/*assign_stmt*/string guard_ok = v__gen__Gen_new_tmp_var(g);
		/*assign_stmt*/bool is_guard = false;
		// FOR IN
		for (int i = 0; i < node.branches.len; i++) {
			v__ast__IfBranch branch = ((v__ast__IfBranch*)node.branches.data)[i];
			if (i == 0) {
				if (branch.cond.typ == 205 /* v.ast.IfGuardExpr */) {
...
void v__gen__Gen_index_expr(v__gen__Gen* g, v__ast__IndexExpr node) { 
	...
	if (node.index.typ == 197 /* v.ast.RangeExpr */) {
		v__ast__RangeExpr* it = (v__ast__RangeExpr*)node.index.obj; // ST it
		/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, node.container_type);
		is_range = true;
		if (sym->kind == v__table__Kind_string) {
	...
	if (!is_range) {
		/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, node.container_type);
		if (v__table__type_is_variadic(node.container_type)) {
			v__gen__Gen_expr(g, node.left);
			...
			/*assign_stmt*/v__table__Array info = /* as */ *(v__table__Array*)sym->info.obj;
			/*assign_stmt*/string elem_type_str = v__gen__Gen_typ(g, info.elem_type);
			/*assign_stmt*/bool is_selector = false;
			if (node.left.typ == 198 /* v.ast.SelectorExpr */) {
			...
			if (g->is_assign_lhs && !is_selector) {
				...
				if ((g->assign_op == v__token__Kind_mult_assign)) {
					...
					v__gen__Gen_expr(g, node.index);
					v__gen__Gen_write(g, tos3(") "));
					/*assign_stmt*/string op = (g->assign_op == v__token__Kind_mult_assign) ? tos3("*") : tos3("");
			...
			/*assign_stmt*/v__table__Map info = /* as */ *(v__table__Map*)sym->info.obj;
			/*assign_stmt*/string elem_type_str = v__gen__Gen_typ(g, info.value_type);
			if (g->is_assign_lhs) {
				g->is_array_set = true;
				...
				/*assign_stmt*/string zero = v__gen__Gen_type_default(g, info.value_type);
		...
		} else if (sym->kind == v__table__Kind_string && !v__table__type_is_ptr(node.container_type)) {
...
void v__gen__Gen_return_statement(v__gen__Gen* g, v__ast__Return node) { 
	...
	/*assign_stmt*/bool fn_return_is_optional = v__table__type_is_optional(g->fn_decl->return_type);
	if (node.exprs.len > 1) {
		v__gen__Gen_write(g, tos3(" "));
		/*assign_stmt*/v__table__TypeSymbol* typ_sym = v__table__Table_get_type_symbol(g->table, g->fn_decl->return_type);
		/*assign_stmt*/v__table__MultiReturn mr_info = /* as */ *(v__table__MultiReturn*)typ_sym->info.obj;
		/*assign_stmt*/string styp = v__gen__Gen_typ(g, g->fn_decl->return_type);
		...
		for (int i = 0; i < node.exprs.len; i++) {
			...
			v__gen__Gen_write(g, _STR(".arg%d=", i));
			v__gen__Gen_expr(g, expr);
		...
		v__gen__Gen_write(g, tos3(" "));
		if (fn_return_is_optional && !v__table__type_is_optional((*(v__table__Type*)array_get(node.types, 0)))) {
			/*assign_stmt*/bool is_none = false;
			/*assign_stmt*/bool is_error = false;
			/*assign_stmt*/v__ast__Expr expr0 = (*(v__ast__Expr*)array_get(node.exprs, 0));
			if (expr0.typ == 189 /* v.ast.None */) {
				v__ast__None* it = (v__ast__None*)expr0.obj; // ST it
				is_none = true;
			}
			else if (expr0.typ == 150 /* v.ast.CallExpr */) {
			...
			;
			if (!is_none && !is_error) {
				/*assign_stmt*/string styp = string_substr(v__gen__Gen_typ(g, g->fn_decl->return_type), 7, v__gen__Gen_typ(g, g->fn_decl->return_type).len);
				v__gen__Gen_write(g, _STR("opt_ok(& (%.*s []) { ", styp.len, styp.str));
...
void v__gen__Gen_const_decl(v__gen__Gen* g, v__ast__ConstDecl node) { 
	...
	for (int i = 0; i < node.fields.len; i++) {
		v__ast__Field field = ((v__ast__Field*)node.fields.data)[i];
		/*assign_stmt*/string name = v__gen__c_name(field.name);
		/*assign_stmt*/v__ast__Expr expr = (*(v__ast__Expr*)array_get(node.exprs, i));
		/*assign_stmt*/int pos = g->out.len;
		v__gen__Gen_expr(g, expr);
		/*assign_stmt*/string val = strings__Builder_after(&g->out, pos);
		strings__Builder_go_back(&g->out, val.len);
		if (expr.typ == 186 /* v.ast.CharLiteral */) {
			...
			/*assign_stmt*/string styp = v__gen__Gen_typ(g, field.typ);
...
void v__gen__Gen_struct_init(v__gen__Gen* g, v__ast__StructInit it) { 
	/*assign_stmt*/v__table__Struct info = (v__table__Struct){
		.fields = new_array(0, 1, sizeof(v__table__Field)),
	};
	/*assign_stmt*/bool is_struct = false;
	/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, it.typ);
	if (sym->kind == v__table__Kind_struct_) {
		is_struct = true;
	...
	/*assign_stmt*/array_string fields = new_array(0, 0, sizeof(string));
	/*assign_stmt*/array_string inited_fields = new_array(0, 0, sizeof(string));
	if (it.fields.len == 0 && it.exprs.len > 0) {
		// FOR IN
		for (int tmp4 = 0; tmp4 < info.fields.len; tmp4++) {
			v__table__Field f = ((v__table__Field*)info.fields.data)[tmp4];
			_PUSH(&fields, (f.name), tmp5, string);
		}
	} else {
		fields = it.fields;
	}
	...
	for (int i = 0; i < fields.len; i++) {
		string field = ((string*)fields.data)[i];
		/*assign_stmt*/string field_name = v__gen__c_name(field);
	...
	if (is_struct) {
		// FOR IN
		for (int tmp8 = 0; tmp8 < info.fields.len; tmp8++) {
			v__table__Field field = ((v__table__Field*)info.fields.data)[tmp8];
			if (_IN(string, field.name, inited_fields)) {
				continue;
			}
			/*assign_stmt*/string field_name = v__gen__c_name(field.name);
			/*assign_stmt*/string zero = v__gen__Gen_type_default(g, field.typ);
...
void v__gen__Gen_assoc(v__gen__Gen* g, v__ast__Assoc node) { 
	...
	/*assign_stmt*/string styp = v__gen__Gen_typ(g, node.typ);
	v__gen__Gen_writeln(g, _STR("(%.*s){", styp.len, styp.str));
	// FOR IN
	for (int i = 0; i < node.fields.len; i++) {
	...
	/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, node.typ);
	/*assign_stmt*/v__table__Struct info = /* as */ *(v__table__Struct*)sym->info.obj;
	// FOR IN
	for (int tmp2 = 0; tmp2 < info.fields.len; tmp2++) {
		v__table__Field field = ((v__table__Field*)info.fields.data)[tmp2];
...
void v__gen__Gen_call_args(v__gen__Gen* g, array_v__ast__CallArg args, array_v__table__Type expected_types) { 
	/*assign_stmt*/bool is_variadic = expected_types.len > 0 && v__table__type_is_variadic((*(v__table__Type*)array_get(expected_types, expected_types.len - 1)));
	/*assign_stmt*/int arg_no = 0;
	// FOR IN
	for (int tmp1 = 0; tmp1 < args.len; tmp1++) {
		v__ast__CallArg arg = ((v__ast__CallArg*)args.data)[tmp1];
	...
	if (is_variadic) {
		/*assign_stmt*/v__table__Type varg_type = (*(v__table__Type*)array_get(expected_types, expected_types.len - 1));
		/*assign_stmt*/string struct_name = string_add(tos3("varg_"), string_replace(v__gen__Gen_typ(g, varg_type), tos3("*"), tos3("_ptr")));
		/*assign_stmt*/int len = args.len - arg_no;
		/*assign_stmt*/string varg_type_str = int_str(((int)(varg_type)));
		if (len > (*(int*)map_get3(g->variadic_args, varg_type_str, &(int[]){ 0 }))) {
			map_set(&g->variadic_args, varg_type_str, &(int[]) { len });
		}
		v__gen__Gen_write(g, _STR("(%.*s){.len=%d,.args={", struct_name.len, struct_name.str, len));
...
//[inline]
void v__gen__Gen_ref_or_deref_arg(v__gen__Gen* g, v__ast__CallArg arg, v__table__Type expected_type) { 
	/*assign_stmt*/bool arg_is_ptr = v__table__type_is_ptr(expected_type) || _IN(int, v__table__type_idx(expected_type), _const_v__table__pointer_type_idxs);
	/*assign_stmt*/bool expr_is_ptr = v__table__type_is_ptr(arg.typ) || _IN(int, v__table__type_idx(arg.typ), _const_v__table__pointer_type_idxs);
	if (arg.is_mut && !arg_is_ptr) {
		v__gen__Gen_write(g, tos3("&/*mut*/"));
	} else if (arg_is_ptr && !expr_is_ptr) {
		if (arg.is_mut) {
			/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, expected_type);
			if (sym->kind == v__table__Kind_array) {
...
void v__gen__verror(string s) { 
	println(_STR("cgen error: %.*s", s.len, s.str));
	v_exit(1);
}
...
void v__gen__Gen_write_builtin_types(v__gen__Gen* g) { 
	/*assign_stmt*/array_v__table__TypeSymbol builtin_types = new_array(0, 0, sizeof(v__table__TypeSymbol));
	// FOR IN
	for (int tmp1 = 0; tmp1 < _const_v__gen__builtins.len; tmp1++) {
		string builtin_name = ((string*)_const_v__gen__builtins.data)[tmp1];
		_PUSH(&builtin_types, ((*(v__table__TypeSymbol*)array_get(g->table->types, (*(int*)map_get3(g->table->type_idxs, builtin_name, &(int[]){ 0 }))))), tmp2, v__table__TypeSymbol);
	}
	v__gen__Gen_write_types(g, builtin_types);
}

void v__gen__Gen_write_sorted_types(v__gen__Gen* g) { 
	/*assign_stmt*/array_v__table__TypeSymbol types = new_array(0, 0, sizeof(v__table__TypeSymbol));
	// FOR IN
	for (int tmp1 = 0; tmp1 < g->table->types.len; tmp1++) {
		v__table__TypeSymbol typ = ((v__table__TypeSymbol*)g->table->types.data)[tmp1];
	...
	/*assign_stmt*/array_v__table__TypeSymbol types_sorted = v__gen__Gen_sort_structs(g, types);
...
void v__gen__Gen_write_types(v__gen__Gen* g, array_v__table__TypeSymbol types) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < types.len; tmp1++) {
		v__table__TypeSymbol typ = ((v__table__TypeSymbol*)types.data)[tmp1];
		if (string_starts_with(typ.name, tos3("C."))) {
			continue;
		}
		/*assign_stmt*/string name = string_replace(typ.name, tos3("."), tos3("__"));
		if (typ.info.typ == 100 /* v.table.Struct */) {
			...
			// FOR IN
			for (int tmp4 = 0; tmp4 < info.fields.len; tmp4++) {
				v__table__Field field = ((v__table__Field*)info.fields.data)[tmp4];
				/*assign_stmt*/string type_name = v__gen__Gen_typ(g, field.typ);
				/*assign_stmt*/string field_name = v__gen__c_name(field.name);
				strings__Builder_writeln(&g->definitions, _STR("\t%.*s %.*s;", type_name.len, type_name.str, field_name.len, field_name.str));
			}
			strings__Builder_writeln(&g->definitions, tos3("};\n"));
		}
		else if (typ.info.typ == 102 /* v.table.Alias */) {
			v__table__Alias* it = (v__table__Alias*)typ.info.obj; // ST it
		}
		else if (typ.info.typ == 104 /* v.table.SumType */) {
		...
		else if (typ.info.typ == 98 /* v.table.ArrayFixed */) {
			v__table__ArrayFixed* it = (v__table__ArrayFixed*)typ.info.obj; // ST it
			/*assign_stmt*/string styp = string_replace(typ.name, tos3("."), tos3("__"));
			/*assign_stmt*/string fixed = string_substr(styp, 12, styp.len);
			/*assign_stmt*/string len = string_after(styp, tos3("_"));
...
array_v__table__TypeSymbol v__gen__Gen_sort_structs(v__gen__Gen* g, array_v__table__TypeSymbol types) { 
	/*assign_stmt*/v__depgraph__DepGraph* dep_graph = v__depgraph__new_dep_graph();
	/*assign_stmt*/array_string type_names = new_array(0, 0, sizeof(string));
	// FOR IN
	for (int tmp1 = 0; tmp1 < types.len; tmp1++) {
		v__table__TypeSymbol typ = ((v__table__TypeSymbol*)types.data)[tmp1];
		_PUSH(&type_names, (typ.name), tmp2, string);
	}
	// FOR IN
	for (int tmp3 = 0; tmp3 < types.len; tmp3++) {
		v__table__TypeSymbol t = ((v__table__TypeSymbol*)types.data)[tmp3];
		/*assign_stmt*/array_string field_deps = new_array(0, 0, sizeof(string));
		if (t.info.typ == 98 /* v.table.ArrayFixed */) {
			v__table__ArrayFixed* it = (v__table__ArrayFixed*)t.info.obj; // ST it
			/*assign_stmt*/string dep = v__table__Table_get_type_symbol(g->table, it->elem_type)->name;
			if (_IN(string, dep, type_names)) {
				_PUSH(&field_deps, (dep), tmp6, string);
			}
		}
		else if (t.info.typ == 100 /* v.table.Struct */) {
			v__table__Struct* it = (v__table__Struct*)t.info.obj; // ST it
			/*assign_stmt*/v__table__Struct info = /* as */ *(v__table__Struct*)t.info.obj;
			// FOR IN
			for (int tmp7 = 0; tmp7 < info.fields.len; tmp7++) {
				v__table__Field field = ((v__table__Field*)info.fields.data)[tmp7];
				/*assign_stmt*/string dep = v__table__Table_get_type_symbol(g->table, field.typ)->name;
	...
	/*assign_stmt*/v__depgraph__DepGraph* dep_graph_sorted = v__depgraph__DepGraph_resolve(dep_graph);
	...
	/*assign_stmt*/array_v__table__TypeSymbol types_sorted = new_array(0, 0, sizeof(v__table__TypeSymbol));
	// FOR IN
	for (int tmp11 = 0; tmp11 < dep_graph_sorted->nodes.len; tmp11++) {
		v__depgraph__DepGraphNode node = ((v__depgraph__DepGraphNode*)dep_graph_sorted->nodes.data)[tmp11];
		_PUSH(&types_sorted, ((*(v__table__TypeSymbol*)array_get(g->table->types, (*(int*)map_get3(g->table->type_idxs, node.name, &(int[]){ 0 }))))), tmp12, v__table__TypeSymbol);
	}
	return types_sorted;
}
...
void v__gen__Gen_string_inter_literal(v__gen__Gen* g, v__ast__StringInterLiteral node) { 
	...
	for (int i = 0; i < node.vals.len; i++) {
		...
		/*assign_stmt*/string escaped_val = string_replace_each(val, new_array_from_c_array(6, 6, sizeof(string), (string[6]){	
		tos3("\""), tos3("\\\""), tos3("\r\n"), tos3("\\n"), tos3("\n"), tos3("\\n"), 
}));
		...
		/*assign_stmt*/string sfmt = (*(string*)array_get(node.expr_fmts, i));
		if (sfmt.len > 0) {
			/*assign_stmt*/byte fspec = string_at(sfmt, sfmt.len - 1);
...
void v__gen__Gen_gen_filter(v__gen__Gen* g, v__ast__CallExpr node) { 
	/*assign_stmt*/string tmp = v__gen__Gen_new_tmp_var(g);
	/*assign_stmt*/array_byte buf = array_slice(g->out.buf, g->stmt_start_pos, g->out.buf.len);
	/*assign_stmt*/string s = tos2(array_clone(&buf).data);
	strings__Builder_go_back(&g->out, s.len);
	/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, node.return_type);
	if (sym->kind != v__table__Kind_array) {
		v__gen__verror(tos3("filter() requires an array"));
	}
	/*assign_stmt*/v__table__Array info = /* as */ *(v__table__Array*)sym->info.obj;
	/*assign_stmt*/string styp = v__gen__Gen_typ(g, node.return_type);
	/*assign_stmt*/string elem_type_str = v__gen__Gen_typ(g, info.elem_type);
...
void v__gen__Gen_insert_before(v__gen__Gen* g, string s) { 
	/*assign_stmt*/string cur_line = strings__Builder_after(&g->out, g->stmt_start_pos);
...
void v__gen__Gen_call_expr(v__gen__Gen* g, v__ast__CallExpr node) { 
	/*assign_stmt*/bool gen_or = !g->is_assign_rhs && node.or_block.stmts.len > 0;
	/*assign_stmt*/string tmp_opt = (gen_or ? v__gen__Gen_new_tmp_var(g) : tos3(""));
	if (gen_or) {
		/*assign_stmt*/string styp = v__gen__Gen_typ(g, node.return_type);
...
void v__gen__Gen_method_call(v__gen__Gen* g, v__ast__CallExpr node) { 
	...
	/*assign_stmt*/v__table__TypeSymbol* typ_sym = v__table__Table_get_type_symbol(g->table, node.receiver_type);
	/*assign_stmt*/string receiver_name = typ_sym->name;
	...
	if (typ_sym->kind == v__table__Kind_array && (string_eq(node.name, tos3("repeat")) || string_eq(node.name, tos3("sort_with_compare")) || string_eq(node.name, tos3("free")) || string_eq(node.name, tos3("push_many")) || string_eq(node.name, tos3("trim")) || string_eq(node.name, tos3("first")) || string_eq(node.name, tos3("last")) || string_eq(node.name, tos3("clone")) || string_eq(node.name, tos3("reverse")) || string_eq(node.name, tos3("slice")))) {
		...
		if ((string_eq(node.name, tos3("last")) || string_eq(node.name, tos3("first")))) {
			/*assign_stmt*/string return_type_str = v__gen__Gen_typ(g, node.return_type);
			v__gen__Gen_write(g, _STR("*(%.*s*)", return_type_str.len, return_type_str.str));
		}
	}
	/*assign_stmt*/string name = string_replace(_STR("%.*s_%.*s", receiver_name.len, receiver_name.str, node.name.len, node.name.str), tos3("."), tos3("__"));
	...
	v__gen__Gen_expr(g, node.left);
	/*assign_stmt*/bool is_variadic = node.exp_arg_types.len > 0 && v__table__type_is_variadic((*(v__table__Type*)array_get(node.exp_arg_types, node.exp_arg_types.len - 1)));
	if (node.args.len > 0 || is_variadic) {
		v__gen__Gen_write(g, tos3(", "));
	}
	v__gen__Gen_call_args(g, node.args, node.exp_arg_types);
	v__gen__Gen_write(g, tos3(")"));
}
...
void v__gen__Gen_fn_call(v__gen__Gen* g, v__ast__CallExpr node) { 
	...
	if (is_print && (*(v__ast__CallArg*)array_get(node.args, 0)).typ != _const_v__table__string_type_idx) {
		/*assign_stmt*/v__table__Type typ = (*(v__ast__CallArg*)array_get(node.args, 0)).typ;
		/*assign_stmt*/string styp = v__gen__Gen_typ(g, typ);
		/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, typ);
		if (!v__table__TypeSymbol_has_method(sym, tos3("str")) && !(_IN(int, ((int)(typ)), g->str_types))) {
			if (v__table__type_is_ptr(typ)) {
				styp = string_replace(styp, tos3("*"), tos3(""));
			}
			_PUSH(&g->str_types, (typ), tmp5, int);
			strings__Builder_writeln(&g->definitions, _STR("string %.*s_str(%.*s x) { return tos3(\"TODO_str\"); }", styp.len, styp.str, styp.len, styp.str));
		}
		if (g->autofree && !v__table__type_is_optional(typ)) {
			/*assign_stmt*/string tmp = v__gen__Gen_new_tmp_var(g);
			v__gen__Gen_write(g, _STR("string %.*s = %.*s_str(", tmp.len, tmp.str, styp.len, styp.str));
			v__gen__Gen_expr(g, (*(v__ast__CallArg*)array_get(node.args, 0)).expr);
			v__gen__Gen_writeln(g, _STR("); println(%.*s); string_free(%.*s); //MEM2 %.*s", tmp.len, tmp.str, tmp.len, tmp.str, styp.len, styp.str));
...
void v__gen__Gen_in_optimization(v__gen__Gen* g, v__ast__Expr left, v__ast__ArrayInit right) { 
	/*assign_stmt*/bool is_str = right.elem_type == _const_v__table__string_type;
	// FOR IN
...
//[inline]
string v__gen__c_name(string name_) { 
	/*assign_stmt*/string name = string_replace(name_, tos3("."), tos3("__"));
...
string v__gen__Gen_type_default(v__gen__Gen* g, v__table__Type typ) { 
	/*assign_stmt*/v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, typ);
	if (sym->kind == v__table__Kind_array) {
		/*assign_stmt*/v__table__TypeSymbol* elem_sym = v__table__Table_get_type_symbol(g->table, v__table__TypeSymbol_array_info(sym).elem_type);
		/*assign_stmt*/string elem_type_str = string_replace(elem_sym->name, tos3("."), tos3("__"));
		return _STR("new_array(0, 1, sizeof(%.*s))", elem_type_str.len, elem_type_str.str);
	}
	if (sym->kind == v__table__Kind_map) {
		/*assign_stmt*/v__table__TypeSymbol* value_sym = v__table__Table_get_type_symbol(g->table, v__table__TypeSymbol_map_info(sym).value_type);
		/*assign_stmt*/string value_type_str = string_replace(value_sym->name, tos3("."), tos3("__"));
...
void v__gen__Gen_write_tests_main(v__gen__Gen* g) { 
	...
	v__gen__Gen_writeln(g, tos3("\t_vinit();"));
	v__gen__Gen_writeln(g, tos3(""));
	/*assign_stmt*/array_string all_tfuncs = v__gen__Gen_get_all_test_function_names(g);
	if (g->pref->is_stats) {
		v__gen__Gen_writeln(g, _STR("\tBenchedTests bt = start_testing(%d, tos3(\"%.*s\"));", all_tfuncs.len, g->pref->path.len, g->pref->path.str));
	}
	// FOR IN
	for (int tmp2 = 0; tmp2 < all_tfuncs.len; tmp2++) {
		string t = ((string*)all_tfuncs.data)[tmp2];
		v__gen__Gen_writeln(g, tos3(""));
		if (g->pref->is_stats) {
...
array_string v__gen__Gen_get_all_test_function_names(v__gen__Gen* g) { 
	/*assign_stmt*/array_string tfuncs = new_array(0, 0, sizeof(string));
	/*assign_stmt*/string tsuite_begin = tos3("");
	/*assign_stmt*/string tsuite_end = tos3("");
	// FOR IN
	...
	/*assign_stmt*/array_string all_tfuncs = new_array(0, 0, sizeof(string));
	...
	/*assign_stmt*/array_string all_tfuncs_c = new_array(0, 0, sizeof(string));
	// FOR IN
	for (int tmp16 = 0; tmp16 < all_tfuncs.len; tmp16++) {
		string f = ((string*)all_tfuncs.data)[tmp16];
		_PUSH(&all_tfuncs_c, (string_replace(f, tos3("."), tos3("__"))), tmp17, string);
	}
	return all_tfuncs_c;
}
...
void v__gen__Gen_comp_if(v__gen__Gen* g, v__ast__CompIf it) { 
	/*assign_stmt*/string ifdef = v__gen__comp_if_to_ifdef(it.val);
	if (it.is_not) {
...
string v__gen__jsgen(v__ast__File program, v__table__Table* table) { 
	/*assign_stmt*/v__gen__JsGen g = (v__gen__JsGen){
		.out = strings__new_builder(100),
		.table = table,
	};
	// FOR IN
	for (int tmp1 = 0; tmp1 < program.stmts.len; tmp1++) {
		v__ast__Stmt stmt = ((v__ast__Stmt*)program.stmts.data)[tmp1];
		v__gen__JsGen_stmt(&g, stmt);
...
void v__gen__JsGen_stmt(v__gen__JsGen* g, v__ast__Stmt node) { 
	if (node.typ == 126 /* v.ast.FnDecl */) {
		v__ast__FnDecl* it = (v__ast__FnDecl*)node.obj; // ST it
		/*assign_stmt*/v__table__TypeSymbol* type_sym = v__table__Table_get_type_symbol(g->table, it->return_type);
		v__gen__JsGen_write(g, _STR("/** @return { %.*s } **/\nfunction %.*s(", type_sym->name.len, type_sym->name.str, it->name.len, it->name.str));
		// FOR IN
		for (int tmp2 = 0; tmp2 < it->args.len; tmp2++) {
			v__table__Arg arg = ((v__table__Arg*)it->args.data)[tmp2];
			/*assign_stmt*/v__table__TypeSymbol* arg_type_sym = v__table__Table_get_type_symbol(g->table, arg.typ);
			v__gen__JsGen_write(g, _STR(" /** @type { %.*s } **/ %.*s", arg_type_sym->name.len, arg_type_sym->name.str, arg.name.len, arg.name.str));
		}
		v__gen__JsGen_writeln(g, tos3(") { "));
		// FOR IN
		for (int tmp3 = 0; tmp3 < it->stmts.len; tmp3++) {
			v__ast__Stmt stmt = ((v__ast__Stmt*)it->stmts.data)[tmp3];
			v__gen__JsGen_stmt(g, stmt);
		}
		v__gen__JsGen_writeln(g, tos3("}"));
	}
		...
		if (it->left.len > it->right.len) {
			...
			for (int i = 0; i < it->left.len; i++) {
				v__ast__Ident ident = ((v__ast__Ident*)it->left.data)[i];
				/*assign_stmt*/v__ast__IdentVar var_info = v__ast__Ident_var_info(&ident);
				/*assign_stmt*/v__table__TypeSymbol* var_type_sym = v__table__Table_get_type_symbol(g->table, var_info.typ);
				/*assign_stmt*/v__ast__Expr val = (*(v__ast__Expr*)array_get(it->right, i));
		...
		v__gen__JsGen_writeln(g, tos3(") {"));
		// FOR IN
		for (int tmp6 = 0; tmp6 < it->stmts.len; tmp6++) {
			v__ast__Stmt stmt = ((v__ast__Stmt*)it->stmts.data)[tmp6];
			v__gen__JsGen_stmt(g, stmt);
		}
		v__gen__JsGen_writeln(g, tos3("}"));
	}
...
void v__gen__JsGen_expr(v__gen__JsGen* g, v__ast__Expr node) { 
	if (node.typ == 210 /* v.ast.IntegerLiteral */) {
		v__ast__IntegerLiteral* it = (v__ast__IntegerLiteral*)node.obj; // ST it
		...
		// FOR IN
		for (int i = 0; i < it->fields.len; i++) {
			string field = ((string*)it->fields.data)[i];
			v__gen__JsGen_write(g, _STR("\t%.*s : ", field.len, field.str));
		...
		v__ast__IfExpr* it = (v__ast__IfExpr*)node.obj; // ST it
		// FOR IN
		for (int i = 0; i < it->branches.len; i++) {
			v__ast__IfBranch branch = ((v__ast__IfBranch*)it->branches.data)[i];
			if (i == 0) {
...
void v__gen__x64__Gen_generate_elf_header(v__gen__x64__Gen* g) { 
	...
	/*assign_stmt*/int eh_size = 0x40;
	/*assign_stmt*/int phent_size = 0x38;
...
void v__gen__x64__Gen_generate_elf_footer(v__gen__x64__Gen* g) { 
	...
	/*assign_stmt*/int file_size = g->buf.len;
	...
	/*assign_stmt*/Option_os__File f = os__create(g->out_name);
	if (!f.ok) {
	string err = f.v_error;
	int errcode = f.ecode;
		v_panic(err);
...
void v__gen__x64__gen(array_v__ast__File files, string out_name) { 
	/*assign_stmt*/v__gen__x64__Gen g = (v__gen__x64__Gen){
...
void v__gen__x64__Gen_jle(v__gen__x64__Gen* g, i64 addr) { 
	/*assign_stmt*/int offset = 0xff - ((int)(v__gen__x64__abs(addr - g->buf.len))) - 1;
...
void v__gen__x64__Gen_jmp(v__gen__x64__Gen* g, i64 addr) { 
	/*assign_stmt*/int offset = 0xff - v__gen__x64__Gen_abs_to_rel_addr(g, addr);
...
int v__gen__x64__Gen_gen_loop_start(v__gen__x64__Gen* g, int from) { 
	...
	/*assign_stmt*/int label = g->buf.len;
...
void v__gen__x64__Gen_gen_print(v__gen__x64__Gen* g, string s) { 
	...
	/*assign_stmt*/int str_pos = g->buf.len + 2;
...
void v__gen__x64__Gen_register_function_address(v__gen__x64__Gen* g, string name) { 
	/*assign_stmt*/i64 addr = v__gen__x64__Gen_pos(g);
...
void v__gen__x64__Gen_call_fn(v__gen__x64__Gen* g, string name) { 
	...
	/*assign_stmt*/i64 addr = (*(i64*)map_get3(g->fn_addr, name, &(i64[]){ 0 }));
	v__gen__x64__Gen_call(g, ((int)(addr)));
	println(_STR("call %.*s %d", name.len, name.str, addr));
}

void v__gen__x64__Gen_stmt(v__gen__x64__Gen* g, v__ast__Stmt node) { 
	if (node.typ == 211 /* v.ast.ConstDecl */) {
		v__ast__ConstDecl* it = (v__ast__ConstDecl*)node.obj; // ST it
	}
	else if (node.typ == 126 /* v.ast.FnDecl */) {
		v__ast__FnDecl* it = (v__ast__FnDecl*)node.obj; // ST it
		...
		// FOR IN
		for (int tmp3 = 0; tmp3 < it->args.len; tmp3++) {
			v__table__Arg arg = ((v__table__Arg*)it->args.data)[tmp3];
		}
		// FOR IN
		for (int tmp4 = 0; tmp4 < it->stmts.len; tmp4++) {
			v__ast__Stmt stmt = ((v__ast__Stmt*)it->stmts.data)[tmp4];
			v__gen__x64__Gen_stmt(g, stmt);
		}
		if (is_main) {
...
void v__gen__x64__Gen_expr(v__gen__x64__Gen* g, v__ast__Expr node) { 
	if (node.typ == 177 /* v.ast.AssignExpr */) {
		v__ast__AssignExpr* it = (v__ast__AssignExpr*)node.obj; // ST it
	}
	else if (node.typ == 210 /* v.ast.IntegerLiteral */) {
		v__ast__IntegerLiteral* it = (v__ast__IntegerLiteral*)node.obj; // ST it
		...
		if (string_eq(it->name, tos3("println")) || string_eq(it->name, tos3("print"))) {
			/*assign_stmt*/v__ast__Expr expr = (*(v__ast__CallArg*)array_get(it->args, 0)).expr;
...
v__scanner__Scanner* v__scanner__new_scanner_file(string file_path, v__scanner__CommentsMode comments_mode) { 
	...
	/*assign_stmt*/Option_string raw_text = os__read_file(file_path);
	if (!raw_text.ok) {
	...
	if (/*opt*/(*(string*)raw_text.data).len >= 3) {
		/*assign_stmt*/byteptr c_text = /*opt*/(*(string*)raw_text.data).str;
		if (c_text[0] == 0xEF && c_text[1] == 0xBB && c_text[2] == 0xBF) {
			/*assign_stmt*/int offset_from_begin = 3;
			/*opt*/(*(string*)raw_text.data) = tos(&/*qq*/c_text[offset_from_begin], vstrlen(c_text) - offset_from_begin);
		}
	}
	/*assign_stmt*/v__scanner__Scanner* s = v__scanner__new_scanner(/*opt*/(*(string*)raw_text.data), comments_mode);
...
string v__scanner__Scanner_ident_name(v__scanner__Scanner* s) { 
	...
	/*assign_stmt*/string name = string_substr(s->text, start, s->pos);
	s->pos--;
	return name;
}

string v__scanner__filter_num_sep(byteptr txt, int start, int end) { 
		/*assign_stmt*/byteptr b = v_malloc(end - start + 1);
		/*assign_stmt*/int i = start;
		/*assign_stmt*/int i1 = 0;
		while (i < end) {
...
string v__scanner__Scanner_ident_bin_number(v__scanner__Scanner* s) { 
	/*assign_stmt*/bool has_wrong_digit = false;
	/*assign_stmt*/byte first_wrong_digit = '\0';
	...
	/*assign_stmt*/string number = v__scanner__filter_num_sep(s->text.str, start_pos, s->pos);
	s->pos--;
	return number;
}
...
string v__scanner__Scanner_ident_dec_number(v__scanner__Scanner* s) { 
	/*assign_stmt*/bool has_wrong_digit = false;
	/*assign_stmt*/byte first_wrong_digit = '\0';
	/*assign_stmt*/bool call_method = false;
	/*assign_stmt*/int start_pos = s->pos;
	while (s->pos < s->text.len) {
		/*assign_stmt*/byte c = string_at(s->text, s->pos);
...
v__token__Token v__scanner__Scanner_scan(v__scanner__Scanner* s) { 
	...
	if (s->inter_end) {
		...
		s->inter_end = false;
		return v__scanner__Scanner_scan_res(s, v__token__Kind_string, v__scanner__Scanner_ident_string(s));
	}
	v__scanner__Scanner_skip_whitespace(s);
	if (s->pos >= s->text.len) {
		return v__scanner__Scanner_end_of_file(s);
	...
	/*assign_stmt*/byte c = string_at(s->text, s->pos);
	/*assign_stmt*/byte nextc = '\0';
	if (s->pos + 1 < s->text.len) {
		nextc = string_at(s->text, s->pos + 1);
	}
	if (v__scanner__is_name_char(c)) {
		/*assign_stmt*/string name = v__scanner__Scanner_ident_name(s);
		/*assign_stmt*/byte next_char = (s->pos + 1 < s->text.len ? string_at(s->text, s->pos + 1) : '\0');
		if (v__token__is_key(name)) {
			return v__scanner__Scanner_scan_res(s, v__token__key_to_token(name), tos3(""));
		}
		if (s->inside_string) {
		...
		if (!s->inside_string) {
			...
			/*assign_stmt*/int prefix_zero_num = start_pos - s->pos;
	...
	if (c == '+') {
		if (nextc == '+') {
			...
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_plus_assign, tos3(""));
		}
		...
		if (nextc == '-') {
			...
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_minus_assign, tos3(""));
		}
		...
		if (nextc == '=') {
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_mult_assign, tos3(""));
		}
		...
		if (nextc == '=') {
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_xor_assign, tos3(""));
		}
		...
		if (nextc == '=') {
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_mod_assign, tos3(""));
		}
		...
		return v__scanner__Scanner_scan_res(s, v__token__Kind_chartoken, v__scanner__Scanner_ident_char(s));
	}
	else if (c == '(') {
		...
		if (s->inside_string) {
			return v__scanner__Scanner_scan_res(s, v__token__Kind_str_dollar, tos3(""));
		} else {
		...
		if (nextc == '=') {
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_and_assign, tos3(""));
		}
		if (nextc == '&') {
			s->pos++;
		...
		if (nextc == '|') {
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_logical_or, tos3(""));
		}
		if (nextc == '=') {
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_or_assign, tos3(""));
		}
		...
		if (string_eq(name, tos3("VEXE"))) {
			/*assign_stmt*/string vexe = v__pref__vexe_path();
			return v__scanner__Scanner_scan_res(s, v__token__Kind_string, v__scanner__cescaped_path(vexe));
		}
		if (string_eq(name, tos3("FILE"))) {
			return v__scanner__Scanner_scan_res(s, v__token__Kind_string, v__scanner__cescaped_path(os__real_path(s->file_path)));
		}
		if (string_eq(name, tos3("LINE"))) {
			return v__scanner__Scanner_scan_res(s, v__token__Kind_string, int_str((s->line_nr + 1)));
		}
		if (string_eq(name, tos3("COLUMN"))) {
			return v__scanner__Scanner_scan_res(s, v__token__Kind_string, int_str((v__scanner__Scanner_current_column(s))));
		}
		if (string_eq(name, tos3("VHASH"))) {
			return v__scanner__Scanner_scan_res(s, v__token__Kind_string, v__scanner__vhash());
		}
		if (!v__token__is_key(name)) {
		...
		if (nextc == '.') {
			...
			if (string_at(s->text, s->pos + 1) == '.') {
				s->pos++;
				return v__scanner__Scanner_scan_res(s, v__token__Kind_ellipsis, tos3(""));
			}
		...
		return v__scanner__Scanner_scan_res(s, v__token__Kind_hash, string_trim_space(hash));
	}
	else if (c == '>') {
		if (nextc == '=') {
			s->pos++;
			...
			if (s->pos + 2 < s->text.len && string_at(s->text, s->pos + 2) == '=') {
				s->pos += 2;
				return v__scanner__Scanner_scan_res(s, v__token__Kind_right_shift_assign, tos3(""));
			}
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_right_shift, tos3(""));
		} else {
		...
		if (nextc == '=') {
			...
			if (s->pos + 2 < s->text.len && string_at(s->text, s->pos + 2) == '=') {
				s->pos += 2;
				return v__scanner__Scanner_scan_res(s, v__token__Kind_left_shift_assign, tos3(""));
			}
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_left_shift, tos3(""));
		} else {
		...
		if (nextc == '=') {
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_decl_assign, tos3(""));
		} else {
		...
		if (nextc == '=') {
			s->pos++;
			return v__scanner__Scanner_scan_res(s, v__token__Kind_div_assign, tos3(""));
		}
		if (nextc == '/') {
			/*assign_stmt*/int start = s->pos + 1;
			v__scanner__Scanner_ignore_line(s);
			...
			if (s->comments_mode == v__scanner__CommentsMode_parse_comments) {
				s->pos--;
				return v__scanner__Scanner_scan_res(s, v__token__Kind_line_comment, comment);
			}
			return v__scanner__Scanner_scan(s);
		}
		if (nextc == '*') {
			/*assign_stmt*/int start = s->pos + 2;
			/*assign_stmt*/int nest_count = 1;
			while (nest_count > 0) {
				s->pos++;
				if (s->pos >= s->text.len) {
					s->line_nr--;
			...
			s->pos++;
			if (s->comments_mode == v__scanner__CommentsMode_parse_comments) {
				/*assign_stmt*/string comment = string_trim_space(string_substr(s->text, start, (s->pos - 1)));
				return v__scanner__Scanner_scan_res(s, v__token__Kind_mline_comment, comment);
			}
			return v__scanner__Scanner_scan(s);
		}
...
string v__scanner__Scanner_ident_string(v__scanner__Scanner* s) { 
	/*assign_stmt*/byte q = string_at(s->text, s->pos);
	/*assign_stmt*/bool is_quote = q == _const_v__scanner__single_quote || q == _const_v__scanner__double_quote;
	/*assign_stmt*/bool is_raw = is_quote && string_at(s->text, s->pos - 1) == 'r';
	...
	while (1) {
		...
		/*assign_stmt*/byte c = string_at(s->text, s->pos);
		/*assign_stmt*/byte prevc = string_at(s->text, s->pos - 1);
...
string v__scanner__Scanner_ident_char(v__scanner__Scanner* s) { 
	...
	while (1) {
		...
		/*assign_stmt*/bool double_slash = v__scanner__Scanner_expect(s, tos3("\\\\"), s->pos - 2);
	...
	len--;
	/*assign_stmt*/string c = string_substr(s->text, start + 1, s->pos);
	if (len != 1) {
		/*assign_stmt*/ustring u = string_ustring(c);
		if (u.len != 1) {
...
bool v__scanner__Scanner_expect(v__scanner__Scanner* s, string want, int start_pos) { 
	/*assign_stmt*/int end_pos = start_pos + want.len;
...
void v__scanner__Scanner_debug_tokens(v__scanner__Scanner* s) { 
	...
	s->started = false;
	s->debug = true;
	/*assign_stmt*/string fname = string_all_after(s->file_path, _const_os__path_separator);
	println(_STR("\n===DEBUG TOKENS %.*s===", fname.len, fname.str));
	while (1) {
		/*assign_stmt*/v__token__Token tok = v__scanner__Scanner_scan(s);
		/*assign_stmt*/v__token__Kind tok_kind = tok.kind;
		/*assign_stmt*/string lit = tok.lit;
...
string v__scanner__Scanner_line(v__scanner__Scanner s, int n) { 
	...
	if (n >= 0 && n < s.line_ends.len) {
		/*assign_stmt*/int nline_start = (n == 0 ? 0 : (*(int*)array_get(s.line_ends, n - 1)));
		/*assign_stmt*/int nline_end = (*(int*)array_get(s.line_ends, n));
...
map_string_int v__token__build_keys() { 
	/*assign_stmt*/map_string_int res = new_map(1, sizeof(int));
	for (int tmp1 = ((int)(v__token__Kind_keyword_beg)) + 1; tmp1 < ((int)(v__token__Kind_keyword_end)); tmp1++) { 
		int t = tmp1;
		/*assign_stmt*/string key = (*(string*)array_get(_const_v__token__token_str, t));
...
array_string v__token__build_token_str() { 
	/*assign_stmt*/array_string s = array_repeat(new_array_from_c_array(1, 1, sizeof(string), (string[1]){	
	tos3(""), 
	...
	array_set(&s, v__token__Kind_line_comment, &(string[]) { tos3("// line comment") });
	array_set(&s, v__token__Kind_mline_comment, &(string[]) { tos3("/* mline comment */") });
...
v__token__Kind v__token__key_to_token(string key) { 
	/*assign_stmt*/v__token__Kind a = ((v__token__Kind)((*(int*)map_get3(_const_v__token__keywords, key, &(int[]){ 0 }))));
	return a;
}
...
bool array_v__token__Kind_contains(array_v__token__Kind t, v__token__Kind val) { 
	// FOR IN
	for (int tmp1 = 0; tmp1 < t.len; tmp1++) {
		v__token__Kind tt = ((v__token__Kind*)t.data)[tmp1];
		if (tt == val) {
			return true;
		}
	}
...
array_v__token__Precedence v__token__build_precedences() { 
	/*assign_stmt*/array_v__token__Precedence p = new_array(0, 0, sizeof(v__token__Precedence));
...
void v__depgraph__OrderedDepMap_add(v__depgraph__OrderedDepMap* o, string name, array_string deps) { 
	/*assign_stmt*/array_string d = (*(array_string*)map_get3(o->data, name, &(array_string[]){ new_array(0, 1, sizeof(string)) }));
	// FOR IN
	for (int tmp1 = 0; tmp1 < deps.len; tmp1++) {
		string dep = ((string*)deps.data)[tmp1];
		if (!(_IN(string, dep, d))) {
...
void v__depgraph__OrderedDepMap_apply_diff(v__depgraph__OrderedDepMap* o, string name, array_string deps) { 
	/*assign_stmt*/array_string diff = new_array(0, 0, sizeof(string));
	// FOR IN
	for (int tmp1 = 0; tmp1 < (*(array_string*)map_get3(o->data, name, &(array_string[]){ new_array(0, 1, sizeof(string)) })).len; tmp1++) {
		string dep = ((string*)(*(array_string*)map_get3(o->data, name, &(array_string[]){ new_array(0, 1, sizeof(string)) })).data)[tmp1];
...
v__depgraph__DepGraph* v__depgraph__DepGraph_resolve(v__depgraph__DepGraph* graph) { 
	/*assign_stmt*/v__depgraph__OrderedDepMap node_names = (v__depgraph__OrderedDepMap){
		.keys = new_array(0, 1, sizeof(string)),
		.data = new_map(1, sizeof(array_string)),
	};
	// FOR IN
	for (int tmp1 = 0; tmp1 < graph->nodes.len; tmp1++) {
		v__depgraph__DepGraphNode node = ((v__depgraph__DepGraphNode*)graph->nodes.data)[tmp1];
		v__depgraph__OrderedDepMap_add(&node_names, node.name, node.deps);
	}
	/*assign_stmt*/v__depgraph__OrderedDepMap node_deps = node_names;
	/*assign_stmt*/v__depgraph__DepGraph* resolved = v__depgraph__new_dep_graph();
	while (v__depgraph__OrderedDepMap_size(&node_deps) != 0) {
		/*assign_stmt*/array_string ready_set = new_array(0, 0, sizeof(string));
		// FOR IN
		for (int tmp2 = 0; tmp2 < node_deps.keys.len; tmp2++) {
			string name = ((string*)node_deps.keys.data)[tmp2];
			/*assign_stmt*/array_string deps = (*(array_string*)map_get3(node_deps.data, name, &(array_string[]){ new_array(0, 1, sizeof(string)) }));
			if (deps.len == 0) {
				_PUSH(&ready_set, (name), tmp4, string);
			}
		}
		if (ready_set.len == 0) {
			/*assign_stmt*/v__depgraph__DepGraph* g = v__depgraph__new_dep_graph();
			g->acyclic = false;
			// FOR IN
			for (int tmp6 = 0; tmp6 < node_deps.keys.len; tmp6++) {
				string name = ((string*)node_deps.keys.data)[tmp6];
				v__depgraph__DepGraph_add(g, name, (*(array_string*)map_get3(node_names.data, name, &(array_string[]){ new_array(0, 1, sizeof(string)) })));
			}
			return g;
		}
		// FOR IN
		for (int tmp7 = 0; tmp7 < ready_set.len; tmp7++) {
			string name = ((string*)ready_set.data)[tmp7];
		...
		// FOR IN
		for (int tmp8 = 0; tmp8 < node_deps.keys.len; tmp8++) {
			string name = ((string*)node_deps.keys.data)[tmp8];
...
string v__depgraph__DepGraph_display_cycles(v__depgraph__DepGraph* graph) { 
	/*assign_stmt*/map_string_v__depgraph__DepGraphNode node_names = new_map(1, sizeof(v__depgraph__DepGraphNode));
	// FOR IN
	for (int tmp1 = 0; tmp1 < graph->nodes.len; tmp1++) {
		v__depgraph__DepGraphNode node = ((v__depgraph__DepGraphNode*)graph->nodes.data)[tmp1];
	...
	for (int tmp2 = 0; tmp2 < graph->nodes.len; tmp2++) {
		v__depgraph__DepGraphNode node = ((v__depgraph__DepGraphNode*)graph->nodes.data)[tmp2];
		// FOR IN
		for (int tmp3 = 0; tmp3 < node.deps.len; tmp3++) {
			...
			/*assign_stmt*/v__depgraph__DepGraphNode dn = (*(v__depgraph__DepGraphNode*)map_get3(node_names, dep, &(v__depgraph__DepGraphNode[]){ {0} }));
...
_const_os__sys_write = 4;
_const_os__sys_open = 5;
_const_os__sys_close = 6;
_const_os__sys_mkdir = 136;
_const_os__sys_creat = 8;
_const_os__sys_open_nocancel = 398;
_const_os__sys_stat64 = 338;
_const_os__path_separator = tos3("/");
_const_os__stdin_value = 0;
_const_os__stdout_value = 1;
_const_os__stderr_value = 2;
_const_v__pref__default_module_path = string_add(os__home_dir(), tos3(".vmodules"));
_const_internal__compile__v_version = tos3("0.1.26");
_const_internal__compile__v_modules_path = _const_v__pref__default_module_path;
...
_const_math__e = 2.71828182845904523536028747135266249775724709369995957496696763;
_const_math__pi = 3.14159265358979323846264338327950288419716939937510582097494459;
_const_math__phi = 1.61803398874989484820458683436563811772030917980576286213544862;
_const_math__tau = 6.28318530717958647692528676655900576839433879875021164194988918;
_const_math__sqrt2 = 1.41421356237309504880168872420969807856967187537694807317667974;
_const_math__sqrt_e = 1.64872127070012814684865078781416357165377610071014801157507931;
_const_math__sqrt_pi = 1.77245385090551602729816748334114518279754945612238712821380779;
_const_math__sqrt_tau = 2.50662827463100050241576528481104525300698674060993831662992357;
_const_math__sqrt_phi = 1.27201964951406896425242246173749149171560804184009624861664038;
_const_math__ln2 = 0.693147180559945309417232121458176568075500134360255254120680009;
_const_math__log2_e = 1.0 / _const_math__ln2;
_const_math__ln10 = 2.30258509299404568401799145468436420760110148862877297603332790;
_const_math__log10_e = 1.0 / _const_math__ln10;
_const_math__max_f32 = 3.40282346638528859811704183484516925440e+38;
_const_math__smallest_non_zero_f32 = 1.401298464324817070923729583289916131280e-45;
_const_math__max_f64 = 1.797693134862315708145274237317043567981e+308;
_const_math__smallest_non_zero_f64 = 4.940656458412465441765687928682213723651e-324;
...
_const_v__parser__colored_output = term__can_show_color_on_stderr();
_const_v__checker__max_nr_errors = 100;
...
_const_v__scanner__error_context_before = 2;
_const_v__scanner__error_context_after = 2;
