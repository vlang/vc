...
array_string os__read_lines(string path) {
  ...
  while (fgets((char *)buf + buf_index, buf_len - buf_index, fp) != 0) {
    ...
    _PUSH(&res, (/*typ = array_string   tmp_typ=string*/ tos_clone(buf)), tmp4,
          string);
...
array_ustring os__read_ulines(string path) {
  ...
  array_string tmp5 = lines;
  for (int tmp6 = 0; tmp6 < tmp5.len; tmp6++) {
    string myline = ((string *)tmp5.data)[tmp6];
...
Option_os__File os__open_append(string path) {
  ...
  os__File tmp10 = OPTION_CAST(os__File)(file);
  return opt_ok(&tmp10, sizeof(os__File));
}
...
string os__sigint_to_signal_name(int si) {
  ...
  if ((tmp13 == 30) || (tmp13 == 10) || (tmp13 == 16)) {

    return tos3("SIGUSR1");

  } else if ((tmp13 == 31) || (tmp13 == 12) || (tmp13 == 17)) {

    return tos3("SIGUSR2");

  } else if ((tmp13 == 20) || (tmp13 == 17) || (tmp13 == 18)) {

    return tos3("SIGCHLD");

  } else if ((tmp13 == 19) || (tmp13 == 18) || (tmp13 == 25)) {

    return tos3("SIGCONT");

  } else if ((tmp13 == 17) || (tmp13 == 19) || (tmp13 == 23)) {

    return tos3("SIGSTOP");

  } else if ((tmp13 == 18) || (tmp13 == 20) || (tmp13 == 24)) {

    return tos3("SIGTSTP");

  } else if ((tmp13 == 21) || (tmp13 == 21) || (tmp13 == 26)) {

    return tos3("SIGTTIN");

  } else if ((tmp13 == 22) || (tmp13 == 22) || (tmp13 == 27)) {
...
array_string os__get_lines() {
  ...
  while (1) {
    ...
    _PUSH(&inputstr, (/*typ = array_string   tmp_typ=string*/ line), tmp22,
          string);
  };
...
void os__write_file(string path, string text) {
  ...
  os__File f = *(os__File *)tmp23.data;
  ;
...
array_string os__walk_ext(string path, string ext) {
  ...
  Option_array_string tmp28 = os__ls(path);
  if (!tmp28.ok) {
  ...
  for (int i = 0; i < tmp29.len; i++) {
    string file = ((string *)tmp29.data)[i];
    ...
    if (os__is_dir(p)) {
      ...
      _PUSH(&res, (/*typ = array_string   tmp_typ=string*/ p), tmp31, string);
    };
  };
...
void os__walk(string path, void (*fnc)(string path /*FFF*/)) {
  ...
  array_string files = *(array_string *)tmp32.data;
  ;
...
void os__mkdir_all(string path) {
  ...
  array_string tmp35 = string_split(path, os__path_separator);
  for (int tmp36 = 0; tmp36 < tmp35.len; tmp36++) {
    string subdir = ((string *)tmp35.data)[tmp36];
...
string compiler__Parser_dot(compiler__Parser *p, string str_typ_,
  ...
  if (has_field) {
    ...
    Option_compiler__Var tmp100 = compiler__Table_find_field(
        &/* ? */ *p->table,
    ...
    compiler__Var field = *(compiler__Var *)tmp100.data;
    ;
  ...
  Option_compiler__Fn tmp101 = compiler__Table_find_method(
      &/* ? */ *p->table,
      &/*112 EXP:"compiler__Type*" GOT:"compiler__Type" */ typ, field_name);
  if (!tmp101.ok) {
  ...
  compiler__Fn method = *(compiler__Fn *)tmp101.data;
  ;
...
void compiler__Parser_go_statement(compiler__Parser *p) {
  ...
  if (compiler__Parser_peek(&/* ? */ *p) == compiler__compiler__TokenKind_dot) {
    ...
    Option_compiler__Fn tmp168 = compiler__Table_find_method(
        &/* ? */ *p->table,
    ...
    compiler__Fn method = *(compiler__Fn *)tmp168.data;
    ;
    ...
    compiler__Fn f = *(compiler__Fn *)tmp169.data;
    ;
...
void compiler__Parser_check_unused_imports(compiler__Parser *p) {
  ...
  map_string tmp179 = p->import_table.imports;
  array_string keys_tmp179 = map_keys(&tmp179);
  for (int l = 0; l < keys_tmp179.len; l++) {
    string alias = ((string *)keys_tmp179.data)[l];
    string mod = tos3("");
    map_get(tmp179, alias, &mod);
...
string compiler__Table_find_misspelled_fn(compiler__Table *table, string name,
  ...
  map_compiler__Fn tmp83 = table->fns;
  ...
  for (int l = 0; l < keys_tmp83.len; l++) {
    ...
    if (!(string_eq(f.mod, tos3("")) || string_eq(f.mod, tos3("main")) ||
      ...
      map_string tmp84 = p->import_table.imports;
      array_string keys_tmp84 = map_keys(&tmp84);
      for (int l = 0; l < keys_tmp84.len; l++) {
        string _ = ((string *)keys_tmp84.data)[l];
        string m = tos3("");
        map_get(tmp84, _, &m);
...
string compiler__Table_find_misspelled_imported_mod(compiler__Table *table,
  ...
  map_string tmp87 = p->import_table.imports;
  array_string keys_tmp87 = map_keys(&tmp87);
  for (int l = 0; l < keys_tmp87.len; l++) {
    string alias = ((string *)keys_tmp87.data)[l];
    string mod = tos3("");
    map_get(tmp87, alias, &mod);
...
string compiler__Table_find_misspelled_const(compiler__Table *table,
  ...
  map_string tmp88 = p->import_table.imports;
  ...
  for (int l = 0; l < keys_tmp88.len; l++) {
    ...
    _PUSH(&mods_in_scope, (/*typ = array_string   tmp_typ=string*/ mod), tmp89,
          string);
  };
